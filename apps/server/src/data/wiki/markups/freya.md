...
Freya_(2018-2020).png|2018&ndash;2020 design
</gallery>
| full_name      = 
| chinese_name   = 芙蕾雅 (fúlěiyǎ)
| alias          = 
| born           = 
| origin         = Martyr Shrine, [[Northen Vale]]
| age            = 
| birthday       = {{birthday|7|26}}<ref name="CNProfile">Official Profile from MLBB CN</ref>
| species        = Human
| gender         = Female
| title          = Valkyrie
| occupation     = 
| affiliation    = *Frozen Sea warriors (allied)
*Black Shark Pirates (hostile)
| fighting_style = 
| weapons        = Sword and shield which can turn into a [[#Ultimate|battleaxe]]
| abilities      = *Bringing fallen warriors to Valhalla
*Turns into [[#Ultimate|Valkyrie mode]]
...
| likes          = 
| dislikes       = 
| relationships  = *Skuld (elder sister, fate unknown)
*{{hi|Atlas}}, {{hi|Franco}} (companions)
*{{hi|Bane}} (enemies)
| en_va         = [[imdb:nm5261058|Aimee Smith]]{{cite}}
| id_va         = 
| ja_va         = 
| tl_va         =
| ar_va         =
...
{{quote|Valkyrie who guards the Northern Vale.}}
...
|image-2=Power of Einherjar Buff
...
|energy-cost    = 
|quote          = 
|description    = After casting a skill, Freya gains 200% [[Attack Speed]] for her next 2 [[Basic Attacks]] (this effect can stack up to 6 times). <br> Freya gains 1 stack of {{B|Sacred Orb|stack}} on each Basic Attack and can spend Sacred Orb stacks to cast {{ai|name=Spirit Combo}} consecutively.
|properties     = 
|calc           = 
|term-1         = Attack Speed
|term-2         = 
...
|mana-cost      = 
|description    = Freya jumps to the target location, dealing {{scale|base=200-300|extra-pa=80|pd}} to enemies hit and [[pulling]] them towards her.
|properties     = *'''Base Damage:''' 200 / 220 / 240 / 260 / 280 / 300
|calc           = 
|term-1         = Blink
|term-2         = Displacement
|term-3         = Movement Speed
|notes          = *This can cancel the casting animation of any of the {{ai|Spirit Combo}} to extend their range, especially to the 3rd cast.
|bugs           = 
}}
...
{{Ability
|variations-1   = Legend
|image-2        = Spirit Combo 2
|image-3        = Spirit Combo 3
|image-4        = Spirit Combo 4
|name           = Spirit Combo
|skill-effect-1 = Burst
...
|energy-cost    = 
|quote          = 
|description    = Freya [[blink|strikes]] in the target direction, gaining a {{scale|base=60-260|extra-pa=70|shield}} while dealing {{scale|base=20-230|extra-pa=90|pd}} to enemies hit and [[slowing]] them by 30% for 0.5 seconds. Freya can cast this skill again withnin 3.5 seconds at the cost of 2 stacks of {{B|Sacred Orb|stack}}. <br> On the 3rd cast, Freya [[Blink|leaps]] into the air and smashes the area below, dealing {{scale|base=26-276|extra-pa=108|pd}} to enemies within range and knocking them [[airborne]] for 0.4 seconds.
|properties     = *'''Shield:''' 60 / 100 / 140 / 180 / 220 / 260
...
|term-2         = Airborne
|term-3         = 
|notes          = ** Each of the Spirit Combo skills cannot be interrupted, not even [[death]].
|bugs           = 
}}
...
|description    = Freya gains 6 stacks of Sacred Orb and enters the {{B|Valkyrie|state}} state, gaining a {{scale|base=600-900|extra-pa=180|shield}} and 30&Ndash;70 {{B|Physical Attack}}. Meanwhile, her [[Basic Attacks]] become ranged and deal splash damage. The Valkyrie state lasts for 10 seconds.
|properties     = *'''Enhanced Basic Attack Range:''' 3.5
*'''Shield:''' 600 / 750 / 900
...
|term-2         = Shield
|term-3         = 
|notes          = *The [[lifesteal]] and [[attack effects]] cannot be triggered on enemies who received splash damage but on Freya's main target.
|bugs           = 
}}
...
Freya (Valkyrie).jpg|Valkyrie
Freya (Dark Rose).jpg|Dark Rose
Freya (Dragon Hunter).jpg|Dragon Hunter
Freya (Beach Sweetheart).jpg|Beach Sweetheart
Freya (War Angel).jpg|War Angel
Freya (Gladiator).jpg|Gladiator
File:Zilong (Christmas Carnival).jpg|Christmas Carnival
Freya (Raven Shogun).jpg|Raven Shogun
Freya (S.A.B.E.R. Manhunter).jpg|S.A.B.E.R. Manhunter
Freya (Galatic Vanquisher).jpg|Galatic Vanquisher
</gallery>

===Avatar icons===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
Hero221-icon.png|Valkyrie
Hero222-icon.png|Dark Rose
Hero223-icon.png|Dragon Hunter
Hero224-icon.png|Beach Sweetheart
Hero225-icon.png|War Angel
Hero226-icon.png|Gladiator
Hero227-icon.png|Christmas Carnival
Hero228-icon.png|Raven Shogun
Hero229-icon.png|S.A.B.E.R. Manhunter
Hero102210-icon.png|Galatic Vanquisher
</gallery>
...
[[Category:Side Laner]]
[[Category:Female]]
[[Category:Northern Vale]]
[[Category:Aurora Heart]]
