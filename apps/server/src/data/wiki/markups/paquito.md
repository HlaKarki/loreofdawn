...
| alias          = The Heavenly Fist
| born           = [[Moniyan Empire]]
| origin         = [[The Barren Lands]]
| age            = 
| species        = Human
| gender         = Male
| ethnicity      = Dorik/Dorican (Descent)<ref name="PaquitoCNProfile"/><ref>多里克人 (duōlǐkèrén) translate to Dorican in english</ref>
| nationality    = Moniyan
| title          =The Heavenly Fist 
| occupation     =Boxer 
| affiliation    = 
| fighting_style = Boxing (out-boxer)
| weapons        = Boxing gloves
| abilities      =
| battles_fought = 
| height         =
| weight         = 
| traits         = Righteous, Steadfast<ref name="PaquitoCNProfile"/><ref>Original Text: 正义、刚毅<br>正义 (zhèngyì) meaning "justice, fairness, righteous"<br>刚毅 (gāngyì) meaning "resolute, steadfast"</ref>
| likes          = 
| dislikes       = 
| relationships  = *"Domineer" (enemy, formerly master)
* [[Jolie]]
| en_va          = [[imdb:nm9656300|Eric Wibbelsmann]]<ref>[https://www.ericvo.com/featured-work "Featured Work — Eric Wibbelsmann VO"]. Retrieved 11 December 2023.</ref>
| ja_va          = [https://www.animenewsnetwork.com/encyclopedia/people.php?id=190410 Sato Yuga (佐藤 悠雅)]<ref name="In-game credit">In-game credit</ref>
| tl_va          = [[imdb:nm3516487|Direk Brian Ligsay]]<ref>[https://web.facebook.com/tothemothership/photos/a.1958007794255909/3729732440416760/?_rdc=1&_rdr "Mothership Recording Studios on Facebook"]. Retrieved 2021-01-05 via www.facebook.com. "To open up the year with a Bang.. Direk Brian takes the role of Paquito, the new gruffy and rough Heavenly fist fighter of Mobile Legends Bang-Bang!".</ref>
|birthday={{birthday|8|2}}<ref name="PaquitoCNProfile">[https://weibo.com/7711876938/PB2W2q5Ei Official profile from Weibo]
<gallery>
Profile CN Paquito.jpg
</gallery>
</ref>}}
===Lore===
...
|description    = After every 3 skill casts, Paquito enters {{b|Champ Stance|e}}, gaining an enhanced skill ignoring his current [[Cooldown|cooldowns]]. He gains 60% extra [[Movement Speed]] that decays over 2.5 seconds after casting the enhanced skill.<br>Paquito's {{ai|Basic Attacks}} only deal {{Scale|total-pa=85|pd}}.
|ls-1           = 
|ls-2           = 
|ls-3           = 
|ls-4           = 
...
|ss-2           = 
|ss-3           = 
|calc           = <math>{\rm extra\ movement\ SPD} = (-0.24 \times time) + 60%</math>
|term-1         = CD
|term-2         = 
|term-3         = 
...
{{Ability
|variations-1   = KOF
|image-2        = Heavy Left Punch - Champ Stance
|image-3        = 
|image-4        = 
|image-5        = 
|image-6        = 
...
|term-3         = 
|notes          = * {{b|Champ Stance|e}} has slightly more range than what the skill range shows.
|bugs           = 
}}
===Skill 2===
{{Ability
|variations-1   = KOF
|image-2        = Jab - Champ Stance
|image-3        = 
|image-4        = 
|image-5        = 
|image-6        = 
...
{{Ability
|variations-1   = KOF
|image-2        = Knockout Strike - Champ Stance
|image-3        = 
|image-4        = 
|image-5        = 
|image-6        = 
...
|energy-cost    = 
|quote          = 
|description    = Paquito launches an [[Blink|elbow strike]] in the target direction, dealing {{Scale|base=250-350|total-pa=50|pd}} to enemies hit and [[knocked back|knocking them back]]. He then throws a haymaker, dealing {{Scale|base=350-600|total-pa=100|pd}} to enemies hit and [[slowing]] them by 75% for 1 second, as he [[Blink|darts backward]].<br>{{b|Champ Stance:|e}} Instead of a haymaker, Paquito launches an uppercut after the elbow strike, {{Scale|base=400-750|total-pa=120|pd}} to enemies hit and [[Airborne|knocking them airborne]] for 0.5 seconds.
|ls-1           = Elbow Damage: 250 / 300 / 350
|ls-2           = Haymaker Damage: 350 / 475 / 600
|ls-3           = Hook Damage: 400 / 575 / 750
|ls-4           = 
|ss-1           = 
|ss-2           = 
|ss-3           = 
...
|term-3         = Airborne
|notes          = 
* Upon reaching the final dash distance, does damage and [[slowing]]/[[airborne]] on a rectangular shape starting from Paquito's back and a small square shape in front of him.
* While dashing, the skill has a hit box that is the size of Paquito's main body, meaning the actual {{b|pushing|cc}} size is smaller than when aiming the skill shows.
|bugs           = 
}}
...
Paquito (The Heavenly Fist).jpg|The Heavenly Fist
Paquito (Death Blow).jpg|Death Blow
Paquito (Manny Pacquiao).jpg|Manny Pacquiao
Paquito (Underground Boxer).jpg|Underground Boxer
Paquito (Fulgent Punch).jpg|Fulgent Punch
Paquito (Fist of Light).jpg|Fist of Light
Paquito (Blazing Tiger).jpg|Blazing Tiger
Paquito (Terry Bogard).jpg|Terry Bogard
Paquito (Fist of Glory).jpg|Fist of Glory
</gallery>

===Avatar icons===
<gallery captionalign="center" spacing="small" widths="100" bordercolor="transparent" hideaddbutton="true">
Hero1031-icon.png|The Heavenly Fist
Hero1032-icon.png|Death Blow
Hero1033-icon.png|Manny Pacquiao
Hero1034-icon.png|Underground Boxer
Hero1035-icon.png|Fulgent Punch
Hero1036-icon.png|Fist of Light
Hero1037-icon.png|Blazing Tiger
Hero1038-icon.png|Terry Bogard
Hero1039-icon.png|Fist of Glory
</gallery>

===Battle emotes===
<gallery captionalign="center" spacing="small" widths="100" bordercolor="transparent" hideaddbutton="true">
You're Going Down!.png|'''You're Going Down'''<br>Obtained by exchanging event items collected (Phillipines Exclusive)
Invincible Champion.png|'''Invincible Champion'''<br>Obtained by taking part in the "Pacquiao's Trial" event.
Golden Fist.png|'''Golden Fist'''<br>Battle Emote - 2022/05 Starlight Special
</gallery>

== Trivia== 
*Paquito is based on [[wikipedia:Manny Pacquiao|Manny Pacquiao]], a former professional boxer from the Philippines, who is also the current brand ambassador of ''Mobile Legends: Bang Bang''. This is also evident to Paquito's southpaw stance, similar to his real-life counterpart.
