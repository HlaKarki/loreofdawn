...
|full_name      = 
|alias          = 
|chinese_name=悟空 (wùkōng)
|born           = 
|origin         = [[Cadia Riverlands]]
|age            = 
|birthday       = {{birthday|12|2}}<ref name="SunCNProfile">[https://weibo.com/7711876938/PbcpK3QGa Official profile from Weibo]
<gallery>
Profile CN Sun.jpg
</gallery>
</ref>
...
|height         = 
|weight         = 
|traits         = Stubborn, Unrestrained<ref name="SunCNProfile" /><ref>Original Text: 桀骜不驯、自由不羁<br>桀骜不驯 (jié'àobùxùn) meaning "wild, intractable, stubborn, obstinate and unruly"<br>自由不羁 (zìyóubùjī) meaning "free, unrestrained, outstanding"
</ref>
|likes          = 
|dislikes       = 
|relationships  = *Li Li (deceased)
|en_va          = [[imdb:nm10744245|Christian Banas]]<ref>[https://x.com/ChrisBanasJr/status/1756748580885500028 Christian Banas on X: "Oh? I was just told people heard me in Mobile Legends: Bang Bang Yeah. That’s me as the revamp Sun Wukong. And, no— I was not cast cause my last name is almost “bananas” At least… I think…?"]</ref>
|ja_va          = [[wikipedia:ja:辻井健吾|Tsuji Kengo (辻井健吾)]]<ref name="In-game credits">In-game credits</ref>
|id_va          = Sumardi{{cite}}
|tl_va          =
|ar_va          = 
|pt_va          = 
...
|skill-effect-2  = Heal
|quote           = 
|description     = Enemies hit by Sun and his Doppelgangers will have their [[Physical Defense]] reduced by 4% (stacks up to 10 times). Sun recovers {{b|HP}} equal to 50% of the Doppelganger's {{B|Physical Attack}} each time a Doppelganger deals damage.
...
|cast-range      =
|level-scaling   = 
|stack-scaling   = Physical Defense Reduction: 4%/8%/12%/16%/20%/24%/28%/32%/36%/40%
|calc            = 
...
|stack-scaling   = 
|calc            = 
|notes           = *The projectiles would instead target the conjured doppleganger after Sun conceals himself.
|bugs            = 
}}
===Skill 3===
{{Ability
...
|skill-effect-2  = AOE
|quote           = 
|description     = Sun commands his Doppelgangers to strike at the target enemy with him, dealing {{scale|base=170-320|total-pa=40|pd}} to the target and enemies behind them. This counts as [[Basic Attack]] damage and can trigger [[Attack Effects]] but cannot [[Crit]].
|term-1          = Physical Damage Skill
|term-2          = <!--Movement Speed-->
|term-3          = 
|atk-effects     = 
...
|description     = Sun summons a Doppelganger that lasts 12 seconds and inherits 70%&nash;100% of his [[attributes]] and a portion [100%] of his [[Attack Effects]]. The Doppelganger takes increased damage.
|term-1          = 
|term-2          = 
|term-3          = 
|atk-effects     = 
...
Sun (Monkey King).jpg|Monkey King
Sun (Battle Buddha).jpg|Battle Buddha
Sun (Rock Star).jpg|Rock Star
Sun (Street Legend).jpg|Street Legend
Sun (Simian Curse).jpg|Simian Curse
Sun (Celestial Outlaw).jpg|Celestial Outlaw
Sun (Spring Blessings).jpg|Spring Blessings
Sun (Wicked Flames).jpg|Wicked Flames
</gallery>
===Avatar icons===
<gallery captionalign="center" spacing="small" bordercolor="transparent" widths="100" hideaddbutton="true">
Hero271-icon.png|Monkey King
Hero272-icon.png|Battle Buddha
Hero273-icon.png|Rock Star
Hero274-icon.png|Street Legend
Hero275-icon.png|Simian Curse
Hero276-icon.png|Celestial Outlaw
Hero277-icon.png|Spring Blessings
Hero278-icon.png|Wicked Flames
</gallery>
===Battle emote===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
Hehe.png|'''Hehe'''<br>Battle Emote - 07/2021 [[Starlight|StarLight]] Special
Happy New Year!2.png|'''Happy New Year!'''<br>Obtained via 2022 Lunar New Year Login event.
</gallery>

==Trivia==
*The classic inspiration for the character is [[wikipedia:Sun Wukong|Sun Wukong]] from the 16th Century Chinese novel: ''[[wikipedia:Journey to the West|Journey to the West]]''. His staff and ability to summon clones are direct references to the mythological figure.
*His name came from a Chinese word which means "grandchild, or descendant".
*Sun's older version was able to summon three clones, one from his {{ai|name=Simian God|Passive}} and two from his {{ai|name=Clone Techniques|Ultimate}}, but the reworked one can only summon two clones, one from his {{ai|name=Endless Variety|1st Skill}} and one from his {{ai|name=Clone Techniques|Ultimate}}.
*When Sun's clones are defeated, they will rotate their staffs and despawn.
*His internal name is Wukong.
*His "Rock Star" skin is a visible nod to [https://en.wikipedia.org/wiki/Elvis_Presley Elvis Presley].
