...
| gender         = Male
| title          = 
| occupation     = *Leader of Black Shark Pirates
*Captain of Behemoth pirate ship
| affiliation    = Black Shark Pirates
| fighting_style = 
| weapons        = *[[Blade of the Heptaseas]]
*[[Bane#SKill 1|Crab Claw Cannon]]
| abilities      = *[[Bane#Passive|Infuses his blade with Tidal Energy]]
*[[Bane#Skill 2|Drinks ale and spits venom afterwards]]
*[[Bane#Ultimate|Summons school of sharks]]
| battles_fought = [[Fighters on the Stormy Sea]]
| height         = 
| weight         = 
| traits         = Cruel, cunning, violent, and tyrannical
| likes          = 
| dislikes       = 
| relationships  = *Unnamed uncle (killed by Bane)
*{{hi|Atlas}}, {{hi|Franco}}, {{hi|Freya}} (enemies)
| en_va =[[imdb:nm2578595|Andy Mack]] (2021–)<ref>Mack, Andy (17 October 2020). [https://twitter.com/AndyMackVoice/status/1494140308178673669 "Andy Mack VO on Twitter"]. [https://web.archive.org/web/20220217024808/https://twitter.com/AndyMackVoice/status/1494140308178673669 Archived] 17 February 2022 at the [[wikipedia:Wayback Machine|Wayback Machine]]. Retrieved 29 December 2022 – via www.twitter.com. [...] I did Bane for ML.</ref>
| ja_va = [[imdb:nm9927957|Takeda Taichi (武田 太一)]]<ref name="In-game credit">In-game credit</ref>
}}
{{Quote|Cruel pirate leader, Franco's sworn enemy}}
...
Bane suffered a tragic death, or so was what those who witnessed the explosion and sinking of the Behemoth believed. His enormous pirate fleet disintegrated and scattered, and peace was restored to the Frozen Sea. The man who had fired the cannon was none other than Bane's nemesis, Franco. Franco had never trusted Bane, and was suspicious of his sudden peaceful overtures. Hence, he ordered his men to pretend to take the bait and search the seas, while he led a small contingent of sailors to infiltrate and seize one of Bane's ships during the night. When Bane was at his most complacent, Franco gave the order to fire upon his flagship, dealing Bane a fatal blow.

Bane's age of piracy was over, and would gradually be forgotten, while Franco would become the new ruler of the Northern Vale coastline. But in the depths of the ocean, the shattered Captain Bane suddenly opened his eyes amidst an ancient and abandoned ruin, awakened by a bright light. The strange object before him radiated a mesmerizing power. As if possessed, his broken body regained consciousness. He was brought back to life and he could now have his [long-lost] revenge, because of the Aurora Heart that Bane had spent so much effort searching for. Having been in despair at his complete defeat, Bane smiled grimly as he approached the Aurora Heart. Upon touching it, a tremendous power surged through him, repairing his shattered body, completely. Even though, Bane resurrected, he looked like a zombie, since his body was torn apart in the explosion and many parts were missing.

What Bane could not imagine was that a giant octopus had just then picked him out as its prey, reaching out to him as he laid hands on the Aurora Heart. As he fought the octopus, Bane was forced to release his grip on the Aurora Heart, letting it fly from his hands and sink into the sea. However, it's residual energy enveloped Bane and the octopus, and started fusing them into one, transforming him into an anthropomorphic octopus.
...
"Your captain has returned."<ref>[https://play.mobilelegends.com/lore/albumitem/9/1/en "Mobilelegends: Bang Bang"]. Retrieved 2022-04-12.</ref>
...
|skill-effect-2     = 
|quote              = 
|description        = Bane infuses his weapon with a stack of {{b|Tidal Energy|stack}} each time he uses a skill (up to 2 stacks). Each of his subsequent Basic Attacks consumes a stack to deal {{b|Physical Damage}} equal to {{scale|total-pa=100}} plus {{scale|base=3.5|level=0.3}} of the target's {{b|Max HP}} to nearby enemies.<br>''(Percent damage dealt based on Max HP Damage Cap against Creeps: {{scale|base=200|level=20}}. (see [[Patch Notes 1.7.82]] Balance Adjustment))''
|cast-range=3
|level-scaling=Damage dealt based on enemy's Max HP: 3.8% / 4.1% / 4.4% / 4.7% / 5.0% / 5.3% / 5.6% / 5.9% / 6.2% / 6.5% / 6.8% / 7.1% / 7.4% / 7.7% / 8.0%
...
|term-2             = 
|term-3             = 
|notes              = *Bane's enhanced basic attacks deals splash damage around him.
*Stack(s) lasts for 8 seconds. Its timer resets when it is until consumed by Bane's next enhanced Basic Attack.
*Only the {{scale|total-pa=100}} portion of his enhanced basic attack can [[critically strike]].
}}
...
|term-2             = 
|term-3             = 
|notes              = *{{ai|Crab Claw Cannon}}'s cooldown reduction is linear to Bane's {{b|Total Physical Attack}} and not stepwise at every 100 points of {{b|Total Physical Attack}} that Bane possesses.
}}
...
|quote              = 
|description        = Bane chugs his ale, recovering {{scale|base=200|total-mp=150}} plus {{scale|base=5-10|total-mp=1.5}}% of his {{B|lost HP}} and gaining 50% extra [[Movement Speed]] that decays over 2.5 seconds.<br>{{B|Use Again:|e}} Bane spits venom in the target direction, dealing {{scale|base=250-450|total-mp=180|md}}  (scales up to 150% with charging time) to enemies in a fan-shaped area.<br>Every 100 {{B|Magic Power}} Bane possesses additionally reduces this skill's cooldown by 7%.
|spellvamp-ratio-50%
|level-scaling=HP Regen: 5% / 6% / 7% / 8% / 9% / 10%
...
|notes              = 
*{{ai|Ale}}'s cooldown reduction is linear to Bane's {{b|Total Magic Power}} and not stepwise at every 100 points of {{b|Total Magic Power}} that Bane possesses.
...
|quote              = 
|description        = Bane summons a school of sharks to charge in a target direction, dealing {{scale|base=600-1000|total-pa=100|total-mp=170|md}}, knocking them [[airborne]] for 0.8 seconds, and [[slowing]] them by 65% (decays over 3 seconds).<br>This skill deals 40% of damage to [[turrets]].
|spellvamp-ratio-50%
...
|term-3             = <!--Attack Speed-->
|notes              = *Deadly Catch also applies [[knockback]] effect.
...
Bane (Frozen King).jpg|Frozen King
Bane (Castle Master).jpg|Castle Master
Bane (Deep Sea Monster).jpg|Deep Sea Monster
Bane (Warlord).jpg|Warlord
Bane (Underworld Outlaw).jpg|Underworld Outlaw
Bane (Soul Defiler).jpg|Soul Defiler
</gallery>
=== Avatar icons ===
<gallery spacing="small" captionalign="center" bordercolor="transparent" widths="100" hideaddbutton="true">
Hero111-icon.png|Frozen King
Hero112-icon.png|Castle Master
Hero113-icon.png|Deep Sea Monster
Hero114-icon.png|Warlord
Hero115-icon.png|Underworld Outlaw
Hero116-icon.png|Soul Defiler
</gallery><!--
=== Battle emotes ===
<gallery spacing="small" captionalign="center" bordercolor="transparent" widths="100" hideaddbutton="true">
</gallery>
...
== Trivia ==
* His 2016&ndash;2021 voice and quotes are from the character [https://magicrush.fandom.com/wiki/Pandarus Pandarus] from Magic Rush: Heroes. Bane and Pandarus have nothing in common nor any similarity in design or playstyle.
*When Bane's rework was first leaked, he had the face of an anglerfish.
*His character design, as well as his background, are somewhat based on [[wp:Davy_Jones_(character)|Davy Jones]] of the [[wp:Pirates_of_the_Caribbean_(film_series)|Pirates of the Caribbean film series]].
*His season 11 skin "Warlord" was changed to "Dictator," but it was secretly changed again because the then-newly-released {{hi|Valir}}'s starlight skin's name is also "Dictator."
