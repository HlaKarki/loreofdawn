...
When the Elven text "[[Azrya Woodlands|Azrya]]" reached the Academy of Magic, a student from the Moniyan Empire read records within of a faction called the Gloo--records which conformed directly with the experiences of that Moniyan soldier he'd read before.

The curious student sought the dean of the [[Magic Academy|Ulturia School]], [[Eudora]], who having glanced over the soldier's writings confirmed that they indeed described a Gloo encounter.
...
|skill-effect-2  = BUFF
|quote           = 
|description = Enemies gain a stack of {{link|Sticky}} each time they're hit by Gloo's skills, [[slow|decreasing]] their [[Movement Speed]] by 4% for 6 seconds. Stacks up to 5. <br> Each stack of {{link|Sticky}} on an enemy reduces their damage dealt to Gloo by 4%.
...
|duration        =
|cast-range      =
|level-scaling   = Base Damage: {{sl|80 to 80 6}}
Extra Base Damage: {{sl|300 to 450 6}}
HP Regen: 2.5% / 3% / 3.5% / 4% / 4.5% / 5%
|stack-scaling   = 
|calc            =  
|notes           = 
|bugs            = 
...
|skill-effect-2  = AOE
|quote           = 
|description     = Gloo splits into Goos, dealing {{scale|base=100-200|total-mp=80|md}} to enemies in a fan-shaped area and [[immobilizing]] them for 0.5 seconds. While split, Gloo gains 10% [[Movement Speed]] and deals {{scale|base=80|total-mp=15|md}} every 0.25 seconds to enemies it touches, lasting 4 seconds. If this skill hits a Goo, Gloo will [[charge]] over to merge with it, dragging enemies in its path in the same direction for a distance.
|term-1          = 
|term-2          = 
|term-3          = 
|atk-effects     = 
...
|duration        =
|cast-range      =
|level-scaling   = Base Damage: {{sl|100 to 200 6}}
|stack-scaling   = 
|calc            =  
|notes           = 
|bugs            = 
...
|duration        =
|cast-range      =
|level-scaling   = *Attached Regen: 25% / 27.5% / 30%
*Base Attack Damage: {{sl|30 to 90 3}}
|stack-scaling   = 
|calc            =  
|notes           = *Gloo lingers on the host even when the host becomes untargetable.
*Gloo can freely use any [[battle spells]] and [[equipment]]s while Mobility ones are disabled.
**{{ai|Flicker}}, {{ai|Arrival}}, {{ai|Recall}} are disabled.
**{{ii|Wind of Nature}} is not disabled but {{ii|Winter Crown}} is disabled.
|bugs            = 
}}
...
Gloo (Swamp Spirits).jpg|Swamp Spirits
Gloo (Verdant Enchanter).png|Verdant Enchanter
Gloo (Jellyman).jpg|Jellyman
</gallery>
=== Avatar icons ===
<gallery captionalign="center" spacing="small" widths="100" bordercolor="transparent" hideaddbutton="true">
Hero1041-icon.png|Swamp Spirits
Hero1042-icon.png|Verdant Enchanter
Hero1043-icon.png|Jellyman
</gallery><!--
=== Battle emotes ===
<gallery captionalign="center" spacing="small" widths="100" bordercolor="transparent" hideaddbutton="true">
</gallery>-->
