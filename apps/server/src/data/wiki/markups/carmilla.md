...
| full_name      = Carmilla Ansaac
| alias          = Shadow of Twilight
| chinese_name   =璃 (lí)
| born           = [[Castle Aberleen]], [[Moniyan Empire]]
| origin         =
| birthday       = {{birthday|3|15}}<ref name="CarmillaCNProfile">[https://weibo.com/7711876938/PdbeOnSJj Official profile from Weibo]
<gallery>
Profile CN Carmilla.jpg
</gallery>
</ref>
...
| fighting_style =
| weapons        =
| abilities      =*Summons [[#Skill 1|crimson flowers]]
*[[#Skill 2|Bloodbath]]
*[[#ltimate|Curse of Blood]] 
| religion       = 
| battles_fought = 
| height         = 
| weight         = 
| traits         = Sweet, Deeply in Love<ref name="CarmillaCNProfile" /><ref>Original Text: 温柔、深情<br>温柔 (wēnróu) meaning "loving, gentle, sweet"<br>深情 (shēnqíng) meaning "deep feeling, deep love, loving, affectionate, tender"</ref>
| likes          = 
| dislikes       = 
| relationships  = *{{hi|Cecilion}} (lover)
*Earl Ansaac (father)
*Baron Tawil (fiancé)
*{{Hi|Alice}} (enemy)
|en_va=
|ja_va= [[imdb:nm11620202|Takada Sakie (高田 紗希衣)]]<ref name="In-game credit">In-game credit</ref>
|id_va= Lis Kurniasih{{cite}}
|tl_va=
|ar_va=
|pt_va=
|ru_va=
...
{{Quote|Girl who became a Blood Demon for love}}
...
|term-3         = 
|notes          = *Only Carmilla's basic attacks and skills can trigger Vampire Pact.
...
|energy-cost    = 
|quote          = 
|description    = Carmilla summons two Crimson Flowers that circle around her for 5 seconds dealing {{Scale|base=100-200|total-mp=50|md}} each time they hit an enemy and [[slowing]] them by 10% for 0.8 seconds (the slow effect stacks up to 50%). The circling speed of the Crimson Flowers also increases with each hit.<sup>[''speed unknown'']</sup><br>Carmilla recovers {{Scale|base=75-150|total-mp=35|hp}} each time a Crimson Flower deals damage (only recovers 30% of that amount when hitting Minions).
|spellvamp-ratio=50%
|level-scaling           = Base Damage: 100 / 120 / 140 / 160 / 180 / 200
HP Regen: 75 / 90 / 105 / 120 / 135 / 150
|stack-scaling  = Slow Effect:10%/20%/30%/40%/50% 
|calc           = 
...
|notes          = *[[Cooldown]] only starts when the skill was casted or expired.
...
|skill-effect-2 = Slow
|description    = {{Hi|Cecilion}} summons Carmilla to become a Vermil [''[[wikipedia:sic|sic]]''] Shadow as she wraps herself around him, granting him a {{Scale|base=500|level=20|shield}}.<br>{{Link|Use Again:|e}} Carmilla leaves Cecilion and [[charges]] at the target location, gaining an equal shield while dealing {{Scale|base=500|level=20|md}} to enemies hit and [[slowing]] them by 30% for 1 second. The [[cooldowns]] of her {{ai|Crimson Flower}} and {{ai|Bloodbath}} will also reset.
|term-1          = Shield
|term-2          = Magic Damage Skill
...
*Cecilion will be unable to use {{ai|Moonlit Waltz}} if an allied Carmilla bought a {{ii|Broken Heart}} in the Shop.
|bugs           =
}}
...
Carmilla (Shadow of Twilight).jpg|Shadow of Twilight
Carmilla (Wisteria Countess).jpg|Wisteria Countess
Carmilla (Magician Girl).jpg|Magician Girl
Carmilla (Phantom Countess).jpg|Phantom Countess
Carmilla (Astral Arcana).jpg|Astral Arcana
</gallery>
===Avatar icons===
<gallery spacing="small" captionalign="center" bordercolor="transparent" widths="100" hideaddbutton="true">
Hero921-icon.png|Shadow of Twilight
Hero922-icon.png|Wisteria Countess
Hero923-icon.png|Magician Girl
Hero924-icon.png|Phantom Countess
Hero925-icon.png|Astral Arcana
</gallery>
===Battle emotes===
<gallery spacing="small" captionalign="center" bordercolor="transparent" widths="100" hideaddbutton="true">
Love ya too!.png|'''Love ya too!'''<br>Obtained from the 2021 Valentine's Day Collect & Exchange Event.
</gallery>

==Videos==
<gallery captionalign="center" spacing="small">
Hero Spotlight - Carmilla, Shadow of Twilight
Road to Mythic - Shadow of Twilight - Carmilla - Mobile Legends- Bang Bang!
</gallery>

== Trivia ==

* She might be based on ''[https://en.wikipedia.org/wiki/Carmilla Carmilla],'' an 1872 gothic novella written by [https://en.wikipedia.org/wiki/Sheridan_Le_Fanu Sheridan Le Fanu] and also one of the earliest works of vampire fiction.
...
* Her epic skin "Astral Arcana" is her only skin that has no counterpart with {{hi|Cecilion}}.
