...
| full_name      = 
| chinese_name  = 阿鲁卡 (ālǔkǎ)
| alias          =*Demon Hunter
*Striker of Lightborn Chevaliers
*Arbiter of Light (formerly)
| born           = 
| birthday       = {{birthday|6|20}}<ref name="CNProfile">Official Profile from MLBB CN</ref>
...
*{{hi|Miya}} (crush)
*{{hi|Silvanna}}, {{hi|Xavier}} (companions)
*{{hi|Tigreal}}, {{hi|Harith}}, {{hi|Fanny}}, {{hi|Granger}} (Lightborn co-members)
*{{Hi|Claude}}, {{hi|Clint}} (allies)<ref>''[[Legends of Dawn: The Sacred Stone]]''</ref>
*{{hi|Alice}}, {{hi|Dyrroth}}, {{hi|Thamuz}}, {{hi|Balmond}} (enemies)
| en_va =
...
{{quote|Demon hunter who detest the darkness}}
...
{{Ability
|variations-1   = Legend
|variations-2   = Star Wars
|name           = Pursuit 
|skill-effect-1 = Buff
|skill-effect-2 = 
|description    = After each skill cast, Alucard's next Basic Attack allows him to [[dash]] to the target's location and deal {{Scale|total-pa=140|pd}}.
|properties=*'''[[Enhanced Basic Attack]] Range''': 4
|calc           = 
|term-1         = Physical Basic Attack
|term-2         = 
|term-3         = 
|notes          =The range of Pursuit can be increased by {{ii|Malefic Gun}} and its passive Malefic Energy. 
|bugs           = 
}}
...
|energy-cost    = 
|quote          = 
|description    = Alucard [[Blink|rolls]] to the target location and slams his blade on the ground, dealing {{Scale|base=270-370|extra-pa=110|pd}} to enemies hit and [[slowing]] them by 40% for 2 seconds.
|properties     = *'''Base Damage:''' 270 / 290 / 310 / 330 / 350 / 370
|calc           = 
|term-1         = Blink 
...
|energy-cost    =
|quote          = 
|description    = Alucard launches a whirling slash, dealing {{Scale|base=345-570|extra-pa=120|pd}} to nearby enemies.
|properties=*'''Base Damage:''' 345 / 390 / 435 / 480 / 525 / 570
|calc           = 
...
*''' Reduce Hybrid Defense (Enemies):''' 10 / 15 / 20
*'''Base Damage:''' 400 / 550 / 700
|calc           =<math>{\rm total\ CD\ reduction} = (skill\ CD\ - CD\ reduction\ attribute%) - 50%
</math> 
|term-2         = Hybrid Defense
|term-1         = Physical Damage Skill
|term-3         =Hybrid Lifesteal 
|notes          = *Fission Wave goes into cooldown on the first cast.
...
Alucard (Demon Hunter).jpg|Demon Hunter
Alucard (Lone Hero).jpg|Lone Hero
Alucard (Fiery Inferno).jpg|Fiery Inferno
Alucard (Child of the Fall).jpg|Child of the Fall
Alucard (Viscount).jpg|Viscount
Miya (Sweet Fantasy).jpg|Romantic Fantasy
Alucard (Obsidian Blade).jpg|Obsidian Blade
Alucard (Empire Agent).jpg|Empire Agent
Alucard (Lightborn - Striker).jpg|Lightborn - Striker
Alucard (Obi-Wan Kenobi).jpg|Obi-Wan Kenobi
Alucard (Demon's Bane).jpg|Demon's Bane
</gallery>
=== Avatar icons ===
<gallery spacing="small" captionalign="center" bordercolor="transparent" widths="100" hideaddbutton="true">
Hero071-icon.png|Demon Hunter
Hero072-icon.png|Lone Hero
Hero073-icon.png|Fiery Inferno
Hero074-icon.png|Child of the Fall
Hero075-icon.png|Viscount
Hero076-icon.png|Romantic Fantasy
Hero077-icon.png|Obsidian Blade
Hero078-icon.png|Empire Agent
Hero079-icon.png|Lightborn - Striker
Hero100710-icon.png|Obi-Wan Kenobi
Hero100711-icon.png|Demon's Bane
</gallery>
=== Battle emotes ===
{{Emote|Alucard}}

== Trivia ==
*Alucard spells backward as Dracula.
*Alucard is a name popularized by the [[Wp:Castlevania|''Castlevania'' video game franchise]] with the [[Wp:Alucard_(Castlevania)|character with the same name]].
*When ''MLBB'' was released as ''[[Mobile Legends: 5v5 MOBA]]'' in mid-2016, Alucard was named '''Dante''', whose name is based on the [[Wp:Dante_(Devil_May_Cry)|video game character with the same name]], and appearance from [[Wp:Nero_(Devil_May_Cry)|Nero]] of the [[wp:Devil_May_Cry|''Devil May Cry'' video game franchise]].
*His Legend Skin "Obsidian Blade" skill icons is the same as his old skill icon before the revamp. 
*His skin "Child of the Fall" is based on [[finalfantasy:Sephiroth|Sephiroth]] but his sword is based on Buster Sword from [[finalfantasy:Final_Fantasy_Wiki|Final Fantasy]]. 
*His ''Lightborn'' skin has armor and a greatsword similar to [https://typemoon.fandom.com/wiki/Artoria_Pendragon_(Saber) '''Saber from Fate/Stay Night'''.] 
*In earlier MLBB artwork, Alucard wielded dual swords instead of a single greatsword. This was later changed to make his weapon style more distinct from other sword-wielding heroes.
*His demonic hand can be seen in MLA and his old model and portraits.
*In earlier versions of Alucard, his lifesteal would amplify beyond 100%, making him nearly unkillable in fights.
