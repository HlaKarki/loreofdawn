...
| age            = 7<ref name="NanaCNProfile"/>
| birthday       = {{birthday|5|23}}<ref name="NanaCNProfile">[https://weibo.com/7711876938/OEZkLgwIE Official profile from Weibo]
<gallery>
Profile CN Nana.jpg
</gallery>
</ref>
...
| abilities      = *[[#Passive|Blessing bestowed by Molina, making Nana morph into an invincible cat]]
*Summoning Molina
| religion       = 
| battles_fought = 
| height         = 
...
*{{hi|Irithel}} (companions)
*{{hi|Harith}} (friends)
| en_va = Aria Nice{{cite}}
| ja_va = Shishido Chie (宍戸 智恵)<ref name="In-game credit">In-game credit</ref>
| id_va = Inen Rahmasuci Bismarck{{cite}}
| tl_va =
| ar_va = Bouthina Hani{{cite}}
| pt_va = Leticia Celini{{cite}}
| ru_va = Martirosova Eliza{{cite}}
| tk_va = Ceren Menekşedağ{{cite}}
| es_va = Jessica Angeles{{cite}}
| zh_va = Yan Yeqiao (闫夜桥){{cite}}
}}<!--
{{Infobox character
| name= Molina
| full_name      = 
| alias          = 
| born           = 
| origin         = Moonlit Forest, [[Azrya Woodlands]]
| species        = Leopard cat
| gender         = Female
| status         = Deceased<ref group="note">The fate of Molina is still uncertain despite her story as it was immediately contradicted by her in-game abilities that is able to summon Molina.</ref>
| title          = 
| occupation     = 
| affiliation    = 
| fighting_style = 
| weapons        = 
| abilities      = *[[nana#Passive|Blesses Nana to morph into an invincible cat]]
*Can be summoned by Nana
| religion       = 
| battles_fought = 
| height         = 
| weight         = 
...
| likes          = 
| dislikes       = 
| relationships  = *Nana (companion)
}}-->
{{Quote|Little Leonin with no worries}}
...
=== Lore ===
After the Endless War, the [[Land of Dawn]] was covered scars, but the [[Moonlit Forest]] of [[Azrya Woodlands|Azrya]] was still bathed in the light of the [[Gavana|Moon Goddess]]. I addition to the elves, there were various other strange creatures living in this dense forest with a most unrestrained bearing. There were very few disputes.
...
Molina understood Nana’s guilt and how she must be feeling. She told Nana: In the southern part of Azrya – the [[Shadow Swamp]] near the [[The Barren Lands|Land of Despair]], there is a kind of mystical fruit that grows in dangerous places that can help the user to control their own energy.
...
Nana discovered for the first time that the weak and small Tanuki was also persistent. She was happy inside, but on the surface[,] she accepted Molina’s company with reluctance.
...
|description    = Upon taking fatal damage, Nana removes all [[debuffs]] on her and [[transforms]], becoming [[untargetable]] and [[invincible]], and gains 70% [[Movement Speed]] for 2 seconds. She also recovers 10% {{B|Max HP}} over the duration.<br>Nana can only transform once every 150 seconds and cannot cast skills in the transformed form.
|term21          = Transformed
|term-2          = Damage Immunity
|notes          = *A visual indicator is shown around Nana when Molina's Gift is ready. (see [[Patch Notes 1.6.58]])
*If {{hi|Nana}} has {{ii|Immortality}} available, {{ai|Monlina's Gift}} will trigger first, end does not cancel {{hi|Yin}}'s {{ai|My Turn}}.
}}
===Skill 1===
{{Ability
...
|skill-effect-2 =
|image-legend   = 
|description    =Nana hurls her Magical Boomerang in the target direction, dealing damage to enemies hit on its way out and back. The boomerang deals {{scale|base=320-440|total-mp=100|md}} to the first enemy For every additional enemy hit, the damage is reduced by 20%  (max reduction of 60%).
|properties = *'''[[Spell Vamp Ratio]]:''' 50%
*Base Damage: 320 / 344 / 368 / 392 / 416 / 440
|ls-2           = 
|ss-1           = '''Damage Reduction Stacks:''' 0% / 20% / 40% / 60% / 60% / 60% / ...
...
{{Ability
|name           = Molina Smooch
|cooldown       = 14.5 / 14.0 / 13.5 / 13.0 / 12.5 / 12.0
...
|mana-cost      = 135 / 150 / 165
|skill-effect-1 = Burst
|skill-effect-2 = CC
|image-legend   = 
|description    =Nana summons Molina to strike the target area 3 times, each time dealing  {{scale|base=440-660|total-mp=160|md}} to enemies within the area and [[slowing]] them by 50% for 1 second. <br> Enemies hit consecutively will be [[stunned]] for 1 second.
|properties           =*'''[[Spell Vamp Ratio]]:''' 50%
...
== Gallery ==
=== Splash art ===
<gallery captionalign="center" spacing="small" hidaddbutton="true">
Nana (Sweet Leonin).jpg|Sweet Leonin
Nana (Clockwork Maid).jpg|Clockwork Maid
Nana (Graveyard Party).png|Graveyard Party
Nana (Slumber Party).jpg|Slumber Party
Nana (Wind Fairy).png|Wind Fairy
Nana (Mecha Baby).jpg|Mecha Baby
Nana (Summer Fun).jpg|Summer Fun
Nana (Aqua Pura).jpg|Aqua Pura
Nana (Cyclone Clash).jpg|Cyclone Clash
Nana (Mistbender Nana).jpg||Mistbender Nana
</gallery>
=== Avatar icons ===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
Hero051-icon.png|Sweet Leonin
Hero052-icon.png|Clockwork Maid
Hero053-icon.png|Graveyard Party
Hero054-icon.png|Slumber Party
Hero055-icon.png|Wind Fairy
Hero056-icon.png|Mecha Baby
Hero057-icon.png|Sundress
Hero058-icon.png|Aqua Pura
Hero059-icon.png|Cyclone Clash
Hero100510-icon.png|Mistbender Nana
</gallery>
=== Battle emotes ===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
Double Kawaii!.png|'''Double Kawaii!'''<br>Obtain from Fun Bingo Event
Cool Summer.png|'''Cool Summer'''<br>Obtained from Emote Bundle.
The Mod Protects You!.png|'''The Mod Protects You!'''<br>Awarded to senior moderators of MLBB.
Nana's Wink.png|'''Nana's Wink'''<br>Battle Emote - 2022/07 StarLight Special
Battle Emote - La-la-la.png|'''La-la-la'''<br>Obtained via the Mistbenders gallery.
</gallery>
