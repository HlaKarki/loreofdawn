...
| fighting_style = 
| weapons        = *[[#Skill 1|Iron hook]]
*[[#Skill 2|Hammer]]
| abilities      = 
| religion       =
| nationality    = 
| battles_fought = [[Fighters on the Stormy Sea|Battle of the Frozen Sea]]
| height         = 
| weight         = 
| traits         = 
| likes          = 
| dislikes       = 
| relationships  = *{{hi|Freya}} (companions)
*{{hi|Bane}} (enemies)
| en_va=
...
{{Quote|Brave permafrost warrior, Bane's sworn enemy}}
...
|skill-effect-1 = Buff
|description    = If no damage is taken within 5 seconds, Franco gains 10% [[Movement Speed]], recovers 1% {{B|Max HP}} per second, and begins accumulating {{B|Wasteland Force|e}} (up to 10 stacks).<br>Franco will consume all Wasteland Force stacks on his next skill cast to increase the skill's damage by up to 150%.
|properties=*'''Damage Increase Per Stack:''' 5% / 10% / 15% / 20% / 25% / 30% / 35% / 40% / 45% / 50%
|term-1         = Movement Speed
|term-2         = Max HP
|notes=*If the stack has been consumed while the passive is active, Franco has to receive damage or the stack won't start accumulating again.
}}
...
|variations-1   = Legend
|name           = Iron Hook
|cooldown       = 15.0 / 14.2 / 13.4 / 12.6 / 11.8 / 11.0
|mana-cost      = 135 / 140 / 145 / 150 / 155 / 160
|skill-effect-1 = CC
|skill-effect-2 = Damage
|skill-type-1   = Physical Skill
|description    = Franco launches an iron hook in the target direction. The hook will snag the first enemy unit hit, dealing {{scale|base=400-650|total-pa=100|pd}} [[displacement|dragging]] them to Franco.
|properties  = *'''Base Damage:''' 400 / 450 / 500 / 550 / 600 / 650
|term-1         = Physical Damage Skill
|term-2=Displacement
|notes=*The hook will pull to {{hi|Franco}}'s current position, which can be extended or repositioned by {{ai|Flicker}}.
...
**Some abilities providing CC Immune may fail to remove the pulling effect. e.g. {{ai|Soul Sever}}, {{ai|An Eye for An Eye}}.
*Fully affect [[invisible]] and [[conceal]]ed enemies.}}
===Skill 2===
{{Ability
|variations-1   = Legend
|name           = Fury Shock
...
|skill-effect-1 = Slow
|description    = Franco lashes out, dealing {{AVC1|Physical Damage}} equal to 300&ndash;450 plus 4% of his {{B|Max HP}} to nearby enemies and [[slowing]] them by 70% for 1.5 seconds.
|properties           = *'''Base Damage:''' 300 / 330 / 360 / 390 / 420 / 450
|term-1         = Physical Damage Skill
|term-2         = Max HP
...
|notes=*Ability ends prematurely when being crowd controlled.}}

==Gallery==
===Splash art===
<gallery captionalign="center" spacing="small" hideaddbutton="true">
Franco (Frozen Warrior).jpg|Frozen Warrior
Franco (Apocalypse).jpg|Apocalypse
Franco (Locomotive).jpg|Locomotive
Franco (Wheatfield Nightmare).png|Wheatfield Nightmare
Franco (Valhalla Ruler).jpg|Valhalla Ruler
Franco (Blazing Axe).jpg|Blazing Axe
Franco (Bone Crusher).jpg|Bone Crusher
Franco (King of Hell).jpg|King of Hell
File:Quantum Vanguard.jpg|Quantum Vanguard
</gallery>
===Avatar icons===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
Hero101-icon.png|Frozen Warrior
Hero102-icon.png|Masterchef
Hero103-icon.png|Apocalypse
Hero104-icon.png|Locomotive
Hero105-icon.png|Wheatfield Nightmare
Hero106-icon.png|Valhalla Ruler
Hero107-icon.png|Blazing Axe
Hero108-icon.png|Bone Crusher
Hero109-icon.png|King of Hell
Hero101010-icon.png|Quantum Vanguard
</gallery>
=== Battle emotes ===
<gallery captionalign="center" spacing="small" widths="100" bordercolor="transparent" hideaddbutton="true">
Ha! Got one!.png|'''Ha! Got one!'''<br>Obtained via Emote Bundle.
</gallery>

== Trivia ==
*Franco is based on a real-life, historical [[Wikipedia:Vikings|viking warrior]].
