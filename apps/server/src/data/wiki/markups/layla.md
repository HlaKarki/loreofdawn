...
Layla 10 years ago.jpg|10 years ago
</gallery>
| full_name      = Layla Grant
| alias          = *Energy Gunner
*Little star (by [[Nolan]])
*Little bunny (by [[Ixia]])
*Shining Star of Eruditio
|birthday        = {{birthday|11|29}}<ref name="Erustory">https://play.mobilelegends.com/events/erustory/<br>The site is no longer available, but there was additional information about the updated Eruditio characters. At the moment, most of the information from this site is only preserved as screenshots in [https://www.reddit.com/r/MobileLegendsGame/comments/16xs4a2/heroes_birthday/ this post on reddit], but information about some of the other characters (presumably Nolan at least) has still been lost.
</ref><ref>
<gallery>
Layla's info card.webp
</gallery>
</ref><ref name="LaylaCNProfile">[https://weibo.com/7711876938/ODXlUEVNm Official profile from Weibo]
<gallery>
Profile CN Layla.jpg
</gallery>
</ref>
|chinese_name=蕾拉 （Lěi lā）| born           = [[Eruditio]]
| origin         = [[City of Scholars]], Eruditio
| age            = 16<ref name="LaylaCNProfile"/><ref name="LaylaLethalNexusMapProfile">[https://youtu.be/30DYLZIcCyc?si=i94e3Ibn-RMvIkyv&t=183 EXPLORE THE MAP OF ERUDITIO! GET TRIAL CARDS | READ HEROES BIO | ALPHA IS NOW A BAD GUY! | MLBB MAP] ''(Timecode: '''3:03''')''
<gallery>
Layla Lethal Nexus Map Profile.png
</gallery>
</ref>
| species        = Human
| gender         = Female
...
** Scholar's Union
** Eruditio Rangers (member)
*[[Laboratory 1718]] (hostile)
| fighting_style = 
| weapons        = *[[#Passive|Malefic Gun]]
*[[#Skill 1|Malefic Energy Bomb]], [[#Skill 2|energy ball]] and [[#Ultimate|energy blast]]
| abilities      = [[#Ultimate|Increased sight range]]
| battles_fought = 
| height         = 
| weight         = 
| traits         = 
| likes          = 
| dislikes       = 
| relationships  =*{{hi|Nolan}} (father)
*Lillian Osborne (mother, deceased)
*Thomas (grandfather)
*{{hi|Ixia}} (confidante, best friend)
*{{hi|Diggie}}, [[Dr. Rooney]], {{hi|Johnson}}, {{hi|Bruno}}, {{hi|Lolita}}, {{hi|Beatrix}}, {{hi|Kimmy}} (companions)
*{{hi|Novaria}} (teacher)
*{{Hi|Lukas}} (ally)
*{{hi|X.Borg}} (enemy)
| en_va          = [[imdb:nm8777940|Sarah Miller-Crews]]<ref>[https://www.sarahmillercrews.com/resume Resume Sarah Miller-Crews]</ref>
| ja_va          = [[wikipedia:Nene Hieda|Nene Hieda (稗田 寧々)]]<ref name="In-game credit">In-game credit</ref>
| id_va          = Dewi Arifiani{{cite}}
| tl_va          =
| ar_va          =
| pt_va          =
| ru_va          =
...
He would swaddle the baby in the cloak of darkness in order to hide her, naming her after night—Layla.

Over time, she grew up and was such a delight to Thomas' barren life. She loved both the sky and the earth, and her little life was always bursting with joyful energy. Because of this, Thomas' face once marked by pain began to smile again.
He picked up the equipment from his youth when he was still a young Ranger, and together with Layla, he leaped from the ground and flew across the skyline of Eruditio, becoming the biggest headache for the young Eruditio Rangers. What were these poor lads supposed to do, chase down and arrest the old man whose face is printed on the Ranger's rulebook? She was everything to Thomas—dawn, high noon, and dusk. But deep down, she still wanted to know her parents.
...
Thomas handed Layla the gun he had locked away in the cabinet—a prototype gun left by Lillian. For 15 years, he could not bear to see any trace of Lillian, but he forgot that the girl in front of him was the deepest trace Lillian had left him with.

"If you want to protect Eruditio, then you'll need to do it with the strongest firepower. This is a gun... that your mother and father made. So--hold it tight and protect yourself with it!"

With the malefic gun in Layla's hands, no evil stands a chance in front of her. As if the stars would always guide her, whenever Layla is holding her gun, she feels that Lillian is just beside her. Even that [[Nolan|nameless man]], too, is there for her.
...
===Passive===
{{Ability
|variations-1       = The Aspirants
|image              = Malefic Gun - Layla
|name               = Malefic Gun
|skill-effect-1     = Buff
|skill-effect-2     = 
|quote              = Target locked. Fire!
|description        = Layla deals increased damage to enemies farther away from her (starting at 100% and increasing to 130% at 6 units away). This does not include Turrets.
|calc               = <math>{\rm total\ DMG} = initial\ DMG \times \bigl[ 100% + (5% \times distance\ projectile\ traveled)\bigr]</math>
|term-1             = Physical Basic Attack
|term-2             = 
|term-3             = 
|notes              = *Damage increase only includes damage from basic attacks and skills.
}}
=== Skill 1 ===
{{Ability
|variations-1       = The Aspirants
...
Total Basic Attack and Void Projectile Range (with [[Malefic Gun]] equipped): 6.785/7.245/7.705/8.165
|calc               = <math>{\rm total\ range} = 4.3 + (0.6 \times Destruction\ Rush\ lv.) + \bigl[1.6 - (0.2 \times Destruction\ Rush\ lv.)\bigr],\ where\ 0 \leq Destruction\ Rush\ lv. \leq 3</math>
|term-1             = Physical Damage Skill
|term-2             = Crit Damage
|term-3             = 
|notes              = *Upon hitting an enemy with this skill, Layla gains 1.6 - (0.2 &times; {{Ai|Destruction Rush}} level) Basic Attack Range (1.6 / 1.4 / 1.2 / 1).
}}
...
|quote              = 
|description        = Layla fires an orb of Malefic Energy that explodes on hit, dealing {{scale|base=170-320|total-pa=65|pd}} to targets in the area and applying {{AVC1|Magic Mark}} on them for 3 seconds. When Layla hits an enemy with a Magic Mark, she deals {{scale|base=100-200|total-pa=35|pd}} to nearby enemies and [[stuns]] them for 0.25 seconds.
|properties=*'''Base Damage:''' 170 / 200 / 230 / 260 / 290 / 320
...
|skill-effect-1     = Burst
|skill-effect-2     = Buff
|cooldown           = 37.0 / 32.0 / 27.0
|mana-cost          = 130 / 150 / 170
|quote              = 
|description        = Layla fires a blast of Malefic Energy in the target direction, dealing {{scale|base=500-800|total-pa=150|pd}} to enemies in a line.<br>{{AVC1|Passive|e}}: The [[range]] of Layla's {{ai|Void Projectile}} and Basic Attacks is increased by 0.6&ndash;1.8 units. Her sight range is also slightly increased each time this skill is upgraded.
|properties=*'''Range Increase:''' 0.6 / 1.2 / 1.8
**Basic Attack Range Per Destruction Rush Level: 4.9 / 5.5 / 6.1
*'''Base Damage:''' 500 / 650 / 800
|ls-3               = 
|term-1             = Physical Damage Skill
|term-2             = 
|term-3             = 
|notes              = *This skill's actual range is slightly wider than the skill range indicates.<sup>[''verification needed'']</sup>
}}

==Gallery==
===Splash art ===
<gallery spacing="small" captionalign="center" hideaddbutton="true">
Layla (Energy Gunner).jpg|Energy Gunner
Layla (Green Flash).jpg|Green Flash
Layla (Bunny Babe).jpg|Bunny Babe
Layla (Cannon and Roses).jpg|Cannon and Roses
Layla (Blue Spectre).jpg|Blue Spectre
Layla (Classic Malefic Gunner).jpg|Classic Malefic Gunner
Layla (S.A.B.E.R. Breacher).jpg|S.A.B.E.R. Breacher
Layla (Blazing Gun).jpg|Blazing Gun
Layla (Miss Hikari).jpg|Miss Hikari
Layla (Twilight Waltz).jpg|Twilight Waltz
Layla (Paranormal Operative).jpg|Paranormal Operative
</gallery>
;Painted skins
<gallery captionalign="center" spacing="small">
Layla (Midnight Waltz).jpg|Sunset Waltz
</gallery>
===Avatar icons===
<gallery widths="100" spacing="small" captionalign="center" bordercolor="transparent" hideaddbutton="true">
Hero181-icon.png|Energy Gunner
Hero182-icon.png|Green Flash
Hero183-icon.png|Bunny Babe
Hero184-icon.png|Cannon and Roses
Hero185-icon.png|Blue Spectre
Hero186-icon.png|Classic Malefic Gunner
Hero187-icon.png|S.A.B.E.R. Breacher
Hero188-icon.png|Blazing Gun
Hero189-icon.png|Miss Hikari
Hero101810-icon.png|Twilight Waltz
Hero101811-icon.png|Paranormal Operative
</gallery>
;Painted avatar icons
<gallery widths="100" spacing="small" captionalign="center" bordercolor="transparent" hideaddbutton="true">
Hero101810-color01-icon.png|Midnight Waltz
Hero101810-color02-icon.png|Sunset Waltz
</gallery>
===Battle emotes===
<gallery widths="100" spacing="small" captionalign="center" bordercolor="transparent" hideaddbutton="true">
LOL.png|'''LOL'''<br>Obtain via Emote Bundle.
Heartbreaking.png|'''Heartbreaking'''<br>Obtain via Emote Bundle.
Carry Me to the End.png|'''Carry Me to the End'''<br>Obtain via Emote Bundle.
Come & Hit Me!.png|'''Come & Hit Me!'''<br>Obtain via Emote Bundle.
MCL Champion!.png|'''MCL Champion!'''<br>Obtain via MCL Champion
Ready... Fire!.png|'''Ready... Fire!'''<br>Obtained from the Lethal Nexus Event.
Good job!.png|'''Good job!'''<br>Obtained via the Aspirants Unite Special Bonus event.
Battle Emote - Ahaha.png|'''Ahaha'''<br>Obtained via the Malaysia & Indonesia 2024 event.
</gallery>

===Sprites===
<gallery>
Layla Outlaw sprite.png|Layla sprite as appeared on [[Outlaw (story)|Outlaw]]
Layla child Outlaw sprite.png|Young Layla sprite as appeared on Outlaw
</gallery>

==Videos==
<gallery spacing="small" hideaddbutton="true" captionalign="center">
File:Hero Revamp - September Project NEXT Express -1 - Mobile Legends- Bang Bang
File:Project NEXT Express -1 - Mobile Legends- Bang Bang
File:Project NEXT Hero Revamp & UI Adjustments Project NEXT Express 4 Mobile Legends Bang Bang
File:【蕾拉来啦】「麻辣宝贝电台」ED-《Layla dance- bang bang》
</gallery>
...
* Layla was one of the heroes revamped in [[Project NEXT 2020|Project NEXT]]’s first batch in September 2020, along with {{hi|Miya}}, {{hi|Eudora}}, {{hi|Zilong}} and {{hi|Saber}}. The goal was to balance the power gap between older and newer heroes, as the latter had better mechanics and animations.
