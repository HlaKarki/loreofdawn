...
| birthday       = {{birthday|12|22}}<ref name="HayabusaCNProfile">[https://weibo.com/7711876938/P3r5WsKvF Official profile from Weibo]
<gallery>
Profile CN Hayabusa.jpg
</gallery>
</ref>
| born           = 
| origin         = [[Scarlet Shadow]], [[Cadia Riverlands]]
| age            = 20<ref name="HayabusaCNProfile"/>
| species        = Human
| gender         = Male
| title          = 
...
*[[Kurēn]]<ref>Since Hanzo's story reveals that Kurēn is the next head of the Shadow Sect, and Hayabusa is described as "the youngest son of the head of the Shadow Sect," this confirms that Kurēn is Hayabusa's brother.</ref> (olders brother, deceased)
*{{hi|Hanabi}} (childhood sweetheart)
*{{hi|Kagura}} (close as siblings)
*{{hi|Hanzo}} (enemies)
| en_va         = [[imdb:nm2859177|Gaku Space]] (2021&ndash;)<ref name="Charlet Takahashi Chung on Twitter (2021-09-23)">Charlet Takahashi Chung (2021-09-23). [https://twitter.com/charletchung/status/1440730624042487813 "Charlet Takahashi Chung on Twitter"]. Retrieved 2021-10-31 – via www.twitter.com. "Kagura here ☂️☂️☂️ @MobileLegendsOL Love being in this with my brutha Gaku Space who plays #Hayabusa 🥷Peep him in the pic w/her! I’ve played Japanese characters for tv/film & animation but this is my 1st Japanese speaking vidgame character and I’m pretty stoked about it 🏯🇯🇵🌸"</ref>
| id_va         = Kamal Nasuti{{cite}}
| ja_va         = Fukagawa Kasumasa (深川 和征)<ref name="In-game credit">In-game credit</ref>
| tl_va         =
| ar_va         =
| pt_va         =
| ru_va         =
...
{{quote|Leader of the Scarlet Shadow's Shadow sect, upon the Cadia Riverlands.}}
...
|variations-2    = Naruto
|image           = Ninjutsu Trace of Shadow
|image-2         = 
|image-3         = 
|image-4         = 
|image-5         = 
...
|energy-cost     = 
|quote           = 
|description     = Hayabusa's attacks apply a stack of {{B|Shadow Mark|mark}} on hit (up to 4 stacks). Each stack lasts 6 seconds and increases Hayabusa's damage to the enemy by 5%.
|term-1          = 
|term-2          = 
|term-3          = 
|calc            = 
|properties      = *'''Damage Increase Per Shadow Mark Stack:''' 5%% / 10% / 15% / 20%
|notes           = *Hayabusa's basic attacks and non-ultimate skills can only apply Shadow Marks.
|bugs            = 
}}
=== Skill 1 ===
{{Ability
|variations-1    = The Exorcists
|variations-2    = Naruto
|image           = Ninjutsu Phantom Shuriken
|image-2         = 
|image-3         = 
|image-4         = 
|image-5         = 
...
|energy-cost     = 30
|quote           = 
|description     = Hayabusa throws three returning shurikens in the target direction, each dealing {{scale|base=150-250|extra-pa=70|pd}} to enemies hit and [[slowing]] them by 35% for 2 seconds. Enemies hit by multiple shurikens take only 30% of the damage after the first hit. Hayabusa restores 10 {{B|energy}} for each non-Minion enemy hit.<br>{{B|Passive:|e}} Hayabusa permanently gains 3%&ndash;18% [[Spell Vamp]].
|term-1          = Physical Damage Skill
|term-2          = Spell Vamp
|term-3          = Movement Speed
|calc            = 
|properties      = *'''[[Spell Vamp]]:''' 3% / 6% / 9% / 12% / 15% / 18%
*'''Base Damage:''' 150 / 170 / 190 / 210 / 230 / 250
|notes           = *This skill can only stack up to 2 [[Mark|Shadow Marks]].
*The weapons used in this skill describing as "returning [[Wp:Shuriken|shurikens]]" is incorrect because the weapon is, in fact, a [[Wp:Kunai|kunai]].
|bugs            = 
}}
=== Skill 2 ===
{{Ability
|variations-1    = The Exorcists
|variations-2    = Naruto
|image           = Ninjutsu Quad Shadow
|image-2         = Ninjutsu Quad Shadow 2
|image-3         = 
|image-4         = 
|image-5         = 
|image-6         = 
...
|term-3          = 
|calc            = 
|properties      = *'''Base Damage:''' 130 / 140 / 150 / 160 / 170 / 180
*'''Extra Damage:''' 130 / 140 / 150 / 160 / 170 / 180
|notes           =*The shadow that attached to the target can be removed with any CC Removal sources.
*Despite the very fast animation, Khufra's {{ai|Bouncing Ball}} can block the dash towards each shadow. 
|bugs            = 
}}
=== Ultimate ===
{{Ability
...
|cooldown        = 50.0
|energy-cost     = 
|quote           = I, will be Akakage.
|description     = Hayabusa blends into the shadows and launches 6 single-target attacks on enemies in the area, each dealing {{scale|base=140|extra-pa=75|pd}}.<br>The attacks prioritize enemies with {{B|Shadow Mark|mark}} and each will consume a mark to deal {{scale|base=45-85|extra-pa=20}} extra {{B|Physical Damage}}. Does not apply Shadow Mark.
|term-1          = Physical Damage Skill
|term-2          = Extra Physical Attack
|term-3          = 
|calc            = 
|properties      = *'''Hits:''' 6 / 9 / 12
*'''Extra Damage:''' 45 / 65 / 85
|notes           =*When the target becomes untargetable or moves a certain distance away from Hayabusa and no other valid targets are nearby, Hayabusa loses untargetability prematurely and wastes the remaining attacks.
...
Hayabusa (Crimson Shadow).jpg|Crimson Shadow
Hayabusa (Spacetime Shadow).jpg|Spacetime Shadow
Hayabusa (Future Enforcer).jpg|Future Enforcer
Hayabusa (Sushi Master).jpg|Sushi Master
Hayabusa (Experiment 21).jpg|Experiment 21
Hayabusa (Shadow of Obscurity).jpg|Shadow of Obscurity
Hayabusa (Biological Weapon).jpg|Biological Weapon
Hayabusa (Shura).jpg|Shura
Hayabusa (Techie Ninja).jpg|Techie Ninja
Hayabusa (Exorcist Hayabusa).jpg|Exorcist Hayabusa
Hayabusa (Kakashi Hatake).jpg|Kakashi Hatake
</gallery>
=== Avatar icons ===
<gallery spacing="small" captionalign="center" bordercolor="transparent" widths="100" hideaddbutton="true">
Hero211-icon.png|Crimson Shadow
Hero212-icon.png|Spacetime Shadow
Hero213-icon.png|Future Enforcer
Hero214-icon.png|Sushi Master
Hero215-icon.png|Experiment 21
Hero216-icon.png|Shadow of Obscurity
Hero217-icon.png|Biological Weapon
Hero218-icon.png|Shura
Hero219-icon.png|Techie Ninja
Hero102110-icon.png|Exorcist Hayabusa
Hero102111-icon.png|Kakashi Hatake
</gallery>
=== Battle emotes ===
{{Emote|Hayabusa}}
...
*Hayabusa’s Quad Shadow skill is similar to [https://wiki.leagueoflegends.fandom/en-us/Zed Zed] from [https://wiki.leagueoflegends.com/en-us/League_of_Legends League of Legends] "Living Shadow", which is placing a clone that he can teleport to and attack from different angles.
