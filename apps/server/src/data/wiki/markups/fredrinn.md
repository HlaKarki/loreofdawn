...
| likes          = 
| dislikes       = 
| relationships  = *[[Duke Vance]] (father)
*{{hi|Lesley}} (step sister)
*{{hi|Harley}} (younger brother)
*[[Fray]] (close friend)
*{{hi|Claude}} (other)
|en_va=[[imdb:nm1678284|Dustin Rubin]]<ref>Dustin Rubin (2022-08-13). [https://twitter.com/DustinRubinVO/status/1558141920697729024 "dustin rubin <nowiki>|</nowiki> voice actor on Twitter"]. Retrieved 2022-08-13 – via www.twitter.com. "Excited to announce I voice Fredrinn, playable today! 🕹 #MobileLegendsBangBang #MLBBNewHero #voiceactor"</ref>
|id_va=
|ja_va=[[imdb:nm7488033|Amano Hirosato (天野 宏郷)]]<ref name="In-game credit">In-game credit</ref>
|tl_va=
|ar_va=
|pt_va=
|ru_va=
...
{{Quote|A master treasure appraiser in Los Pecados who accumulates wealth to search for his best friend.}}
...
|image-2        = Crystalline Armor BUFF
|image-3        = Combo Point
|image-4        = 
|image-5        = 
|image-6        = 
...
|energy-cost    = 
|quote          = 
|description    = Fredrinn gains 1 {{ai|Combo Point}} that lasts 5 seconds each time his skill hits a non-minion enemy, up to 4 Combo Points. His Ultimate costs different numbers of {{ai|Combo Points}} at different skill levels.
Fredrinn stores 100% of the damage he receives as {{b|Crystal Energy|E}}, which decays after 5 seconds at a rate of 10% {{b|Max HP}} per second.
Fredrinn can convert the stored {{b|Crystal Energy|E}} into HP by 20% of his damage dealt (10% for damage dealt to minions). Gaining a {{ai|Combo Point}} resets the decaying timer.
|ls-1           = 
|ls-2           = 
|ls-3           = 
|ls-4           = 
...
|skill-type-2   = 
|skill-type-3   = 
|cooldown       = 8.5 / 8.3 / 8.1 / 7.9 / 7.7 / 7.5
|mana-cost      = 
|energy-cost    = 
|quote          = 
...
|term-2         = 
|term-3         = 
|notes          = *Enhanced basic attack from {{ai|Brave Assault|e}} and this skill cannot be stacked. The enhanced basic attack effect from this this skill will be replaced by Brave Assault's.
|bugs           =
}}
=== Skill 2 ===
{{Ability
...
|energy-cost    = 
|quote          = 
|description    = Fredrinn [[dashes]] in the target direction, dealing {{scale|base=200|extra-pa=80|pd}} to the first non-minion enemy hit. His next [[Basic Attack]] knocks the target airborne for 0.3 seconds.<sup>[''skill duration needed'']</sup>
...
|term-2         = 
|term-3         = 
|notes          = *Enhanced basic attack from {{ai|Piercing Strike}} and this skill cannot be stacked. The enhanced basic attack effect from this this skill will be replaced by Piercing Strike's.
...
|energy-cost    = 
|quote          = 
|description    = Fredrinn deals {{scale|base=300|extra-pa=100|pd}} to nearby enemies and [[taunts]] them for 1 second. Hitting a non-minion enemy grants Fredrinn 15-35 [[Physical Defense|Physical]] and [[Magic Defense]] for 3 seconds and reduces the cooldowns of {{ai|Piercing Strike}} and {{ai|Brave Assault}} by 75%.<br>This skill costs 1 {{ai|Combo Point}}.
|ls-1           = Base Damage: 300 / 400 / 500
|ls-2           = Defense Boost: 15 / 25 / 35
|ls-3           = 
|ls-4           = 
|ss-1           = 
|ss-2           = 
...
|term-2         = 
|term-3         = 
|notes          = *This skill is learned together with {{ai|Appraiser's Wrath}}.
**Between Fredrinn's latter two skills, Valentina can only siphon and copy this skill with {{ai|I Am You}}.
|bugs           =
}}
...
|energy-cost    = 
|quote          = 
|description    = Fredrinn slams his sword in the target direction, dealing 600&ndash;1000 plus 35% of his {{b|Crystal Energy|e}} as {{b|Physical Damage}} to enemies in fan-shaped area after a short delay.<sup>[''duration needed'']</sup> Enemies in the center of the area take 175% [critical] damage.<br>This skill costs 3 {{ai|Combo Points}}.
|ls-1           = Base Damage: 600 / 800 / 1000
|ls-2           = 
|ls-3           = 
|ls-4           = 
|ss-1           = 
...
|term-2         = 
|term-3         = 
|notes          = *This skill is learned together with {{ai|Energy Eruption}}.
*According to Advance Server Patch Notes 1.7.26 and 1.7.29, and Original Server [[Patch Notes 1.7.32]], this skill is named as an "Ultimate".
*175% increased critical damage from this skill does not benefit from [[Critical Damage]] attribute.
*This skill cannot be interrupted. This doesn't mean that Fredrinn gains CC immunity. It means the hit will still be executed even if Fredrinn gets crowd controlled.
|bugs           =
}}
...
Fredrinn (Rogue Appraiser).jpg|Rogue Appraiser
Fredrinn (Regal Renegade).jpg|Regal Renegade
Fredrinn (Jewel Connoisseur).jpg|Jewel Connoisseur
Fredrinn (Neobeast Fredrinn).jpg|Neobeast Fredrinn
Fredrinn (Sparkle Fredrinn).png|SPARKLE Fredrinn
</gallery>
=== Avatar icons ===
<gallery captionalign="center" spacing="small" bordercolor="transparent" widths="100" hideaddbutton="true">
Hero1171-icon.png|Rogue Appraiser
Hero1172-icon.png|Regal Renegade
Hero1173-icon.png|Jewel Connoisseur
Hero1174-icon.png|Neobeast Fredrinn
Hero1175-icon.png|SPARKLE Fredrinn
</gallery>
=== Battle emotes ===
{{Emote|Fredrinn}}
=== Videos ===
<gallery hideaddbutton="true" captionalign="center">
The One Left Behind - Fredrinn Animated Trailer - Mobile Legends- Bang Bang
Intricate Characters - Design Concepts - Mobile Legends- Bang Bang
