...
| full_name      = 
| alias          = Hoverjet Outrider<br>Jetpack Rebel<ref name="Erustory"/><ref name="InfocardKimmy"/>
| born           = [[Moniyan Empire]]
[[Castle Grandrock]]<ref name="Erustory"/><ref name="InfocardKimmy"/>
| origin         = 
| species        = Human
| gender         = Female
| title          = 
| occupation     = *Imperial Expeditionary Army member
*Western border guard of Moniyan Empire
...
* {{hi|Lolita}}, {{hi|Layla}}, {{hi|Bruno}}, {{hi|Johnson}}, {{hi|Diggie}}, {{hi|Ixia}}, [[Dr. Rooney]] (companions/friends)<ref name="Erustory"/><ref name="InfocardKimmy"/>
* {{Hi|Nolan}} (ally}<ref name="Erustory"/><ref name="InfocardKimmy"/>
* {{hi|Beatrix}} (close friend)
* {{Hi|X.Borg}} (enemy)<ref name="Erustory"/><ref name="InfocardKimmy"/>
|en_va=Rebecca Wang| ja_va           = Imamura Miho (広川碧)<ref name="In-game credit">In-game credit</ref>
|birthday={{birthday|4|12}}<ref name="Erustory">https://play.mobilelegends.com/events/erustory/<br>The site is no longer available, but there was additional information about the updated Eruditio characters. At the moment, most of the information from this site is only preserved as screenshots in [https://www.reddit.com/r/MobileLegendsGame/comments/16xs4a2/heroes_birthday/ this post on reddit], but information about some of the other characters (presumably Nolan at least) has still been lost.
</ref><ref name="InfocardKimmy">
<gallery>
Kimmy's info card.webp
</gallery>
</ref>|status=}}
{{quote|A cool girl who loves technology and invention}}
...
=== Aim for the Sky ===
If you were to ask Kimmy about her most vivid childhood memory, she would tell you without hesitation - it was the weight of the medals adorning her father's military uniform. Born into a military family, the young girl secretly vowed to become an even greater soldier than her father.

But when she enthusiastically shared her dream with him, his usual gentle demeanor turned stern as he rejected her aspirations. Putting his calloused hand

over her little head, he said, "I want my daughter to have a peaceful, carefree life."

Though her wings were confined within the cage her father built, Kimmy never abandoned her dreams of soaring. She read military books in secret, looked through her family's military records, and even after being sent to Eruditio for schooling, she never stopped dreaming.
...
"Why not just go for it? Enlist first and tell him later!" Kimmy's heart raced at

Beatrix's suggestion. As their fists bumped together, their rebellious alliance was officially sealed.

Kimmy packed up and left Eruditio to join the Moniyan Empire's Western Border Guard. The closer she got to the military outpost, the more desolate the surroundings became, but her heart had

never felt more fulfilled. She stretched her hand upward, as though she could grasp the sky itself.
[[File:Kimmy lore 1.jpg|center|655x655px]]
Kimmy's early days in the Border Guard were anything but easy. Her time spent in Eruditio and her young age led many of the hardened soldiers to dismiss her as a privileged girl who was just looking for some cheap thrills. She paid their gossip no mind, instead throwing herself into her training, using her pent-up ambition as fuel for her fire, and the results showed; she came first in the Imperial Joint Tactical Exercise and demonstrated extraordinary talent in both marksmanship and close- quarters combat. Her achievements finally silenced the rumors and naysayers. Many began to see Kimmy in a new light, and some were even inspired to train harder.
...
[[File:Kimmy lore 2.jpg|center|655x655px]]
Before the thrill of victory could fade, the full scope of the enemy's operations was revealed: they had kidnapped military

researchers to force them to create new weapons. Worse still, they had already used stolen weapons to ambush the front- line troops, causing heavy casualties. With no time to call for backup, Kimmy disguised herself with the enemy's attire and infiltrated their stronghold, quickly locating the holding cells. 
...
New missions awaited on the horizon. Kimmy looked to the sky, knowing that her wings now carried her father's

expectations. She was bound for even greater heights.{{clr}}

== Abilities ==
=== Passive ===
{{Ability
|variations-1       = Star Wars
...
|term-2             = 
|term-3             = 
|notes              =*If no Starlium is gained within 7 seconds, the Starlium begins to deplete.
*Due to this passive {{hi|Kimmy}} cannot use Manual Targeting. 
}}
=== Skill 1 ===
{{Ability
|variations-1       = Star Wars
|name               = Anti-Grav Thruster
...
|skill-type-3       = 
|spellvamp-ratio    = 50%
|cooldown           = 14.0 / 13.0 / 12.0 / 11.0 / 10.0 / 9.0
|energy-cost        = 
|quote              = 
|description        = Kimmy uses her jetpack to take flight, removing and becoming immune to Slow Effects. She can pass through terrain and gains 90% Movement Speed for 1 second. During the flight, she fires 4 Chemical Bolts at nearby enemies, each dealing {{scale|base=20|total-pa=25%|total-mp=30%|md}} and [[slowing]] them by 50% for 0.5 seconds.
|level-scaling      = Base Damage: {{sl|20 to 45 6}}
|ls-4               = 
|ss-1               = 
|ss-2               = 
|ss-3               = 
...
|term-2             = Spell Vamp
|term-3             = 
|notes              =*Chemical Bolts ignore invisible, concealed and unsighted enemies. 
}}
...
|term-2             = 
|term-3             = 
|notes              =*Cooldown begins as soon as the ability is cast.
*{{hi|Kimmy}} can hold the ability for 3 seconds. 
* The HP based damage on the second part of this ability will not trigger {{ii|Wishing Lantern}}'s passive
}}

== Gallery==
=== Splash art ===
<gallery captionalign="center" spacing="small" hideaddbutton="true">
Kimmy (Hoverjet Outrider).jpg|Hoverjet Outrider
Kimmy (Steam Researcher).jpg|Steam Researcher
Kimmy (Bio Frontier).jpg|Bio Frontier
Kimmy (Astrocat).jpg|Astrocat
Kimmy (Charge Leader).jpg|Charge Leader
Kimmy (Frost Wing).jpg|Frost Wing
Kimmy (First Order Jet Trooper).jpg|First Order Jet Trooper
Kimmy (Rising Nova).jpg|Rising Nova
Kimmy (High Seas Cadet).jpg|High Seas Cadet

</gallery>

=== Avatar icons ===
<gallery captionalign="center" spacing="small" bordercolor="transparent" widths="100" hideaddbutton="true">
Hero711-icon.png|Hoverjet Outrider
Hero712-icon.png|Steam Researcher
Hero713-icon.png|Bio Frontier
Hero714-icon.png|Astrocat
Hero715-icon.png|Charge Leader
Hero716-icon.png|Frost Wing
Hero717-icon.png|First Order Jet Trooper
Hero718-icon.png|Rising Nova
Hero719-icon.png|High Seas Cadet
</gallery>
