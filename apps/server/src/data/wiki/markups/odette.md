...
| alias          = Swan Princess
| birthday       = {{birthday|8|31}}<ref name="OdetteCNProfile">[https://weibo.com/7711876938/P2fpWDLK7 Official profile from Weibo]
<gallery>
Profile CN Odette.jpg
</gallery>
</ref>
| born           = Swan Castle, [[Moniyan Empire]]
| origin         = 
| age            = 18<ref name="OdetteCNProfile"/>
| species        = Human
| gender         = Female
| title          = Princess of House Alvin
| occupation     = 
| affiliation    = *Moniyan Empire
*House Alvin
| fighting_style = 
| weapons        = *Scepter
*Sword (not used in combat)
| abilities      = *Healing
*Dealing damage using sound waves and unknown energy
| religion       = 
| nationality    = Moniyan
| battles_fought = 
| height         = 
...
| ru_va          = 
| tk_va          = 
| es_va          = [[w:c:doblaje:Jessica Ángeles|Jessica Ángeles]]{{cite}}
| zh_va          = 
}}
{{Quote|Innocent princess that grew up in the Swan Castle and genius mage that excels in sword and scepter.}}
...
[[File:Odette Lore.png|center|512px]]
...
|mana-cost          = 
|quote              = 
|description        = After each skill cast, Odette's next {{ai|Basic Attack}} or skill will cast a sound wave that rebounds between her and enemies, each bounce dealing {{Scale|base=140|level=4|total-mp=50|md}}.
|ls-1               = Base Damage: 144 / 148 / 152 / 156 / 160 / 164 / 168 / 172 / 176 / 180 / 184 / 188 / 192 / 196 / 200
|ls-2               = 
|ls-3               = 
|ls-4               = 
|ss-1               = 
...
|term-2             = 
|term-3             = 
|notes              = *{{ai|Lakeshore Ambience}} only benefits 50% of [[Magic Lifesteal]].
...
*This skill is a {{AVC1|magic skill|md}} and only benefits from [[skill effects]].
...
**Still bounce to and from {{hi|Odette}}.
}}
=== Skill 1 ===
{{Ability
...
|quote              = 
|description        = Odette concentrates energy to summon a swan to attack enemies, dealing {{Scale|base=300-550|total-mp=150|md}} and {{b|slowing}} them by 30%. Lasts 2 seconds.
|ls-1               = Base Damage: 300 / 350 / 400 / 450 / 500 / 550
|ls-2               = 
|ls-3               = 
|ls-4               = 
|ss-1               = 
...
|term-3             = 
|notes              = *{{ai|Avian Authority}} only benefits 50% of [[Magic Lifesteal]].
}}
=== Skill 2 ===
{{Ability
|name               = Blue Nova
...
|quote              = 
|description        = Odette releases a set of magic energy balls forward, dealing {{Scale|base=250-400|total-mp=50|md}} to the enemy hit and {{b|immobilizing|cc}} them for 1.5 seconds. Another energy ball will then spawn and attack a nearby enemy (prioritizes enemy heroes), dealing {{Scale|base=250-400|total-mp=50|md}} and {{b|immobilizing|cc}} them for 1.5 seconds.
|ls-1               = Base Damage: 250 / 280 / 310 / 340 / 370 / 400
|ls-2               = Diffusion Damage: 250 / 280 / 310 / 340 / 370 / 400
|ls-3               = 
|ls-4               = 
|ss-1               = 
|ss-2               = 
...
|term-2             = 
|term-3             = 
|notes              = *{{ai|Blue Nova}} only benefits 50% of [[Magic Lifesteal]].
}}
=== Ultimate ===
{{Ability
|name               = Swan Song
...
|quote              = 
|description        = Odette leaps in a designated direction, gains a {{Scale|base=1400-1800|total-mp=150|shield}}, and begins gathering energy, dealing {{Scale|base=240-320|total-mp=90|md}} to enemies within the area every 0.5 seconds for 5 seconds.<br>Odette {{b|slows}} nearby enemies by 90% (decays over 2 seconds) upon casting this skill. The rebounding speed and count of {{ai|Lakeshore Ambience}}'s sound wave in the area are also enhanced when the skill is active.<br>This skill requires constant channeling and will be interrupted if Odette is controlled or performs other actions.
|ls-1               = Base Shield: 1400 / 1600 / 1800
|ls-2               = Base Damage: 240 / 280 / 320
|ls-3               = 
|ls-4               = 
|ss-1               = 
|ss-2               = 
|ss-3               = 
|calc               = <math>{\rm extra\ movement\ SPD} = (-0.45 \times time) + 90%</math>
|term-1             = Magic Skill
|term-2             = Shield
|term-3             = Movement Speed
|notes              = *The effect has a radius of 5.5 unit.
*{{ai|Swan Song}} only benefits 25% of [[Spell Vamp]].
...
*[[Battle Spells]], Items and {{ai|Recall}} can be used during the duration.
*{{hi|Yin}}'s {{ai|My Turn}} cancels this ability upon entering and exitting.
}}

== Gallery ==
=== Splash arts ===
<gallery captionalign="center" spacing="small">
Odette (Swan Princess).jpg|Swan Princess
Odette (Black Swan).jpg|Black Swan
Odette (Christmas Carnival).jpg|Christmas Carnival
Odette (Mermaid Princess).jpg|Mermaid Princess
Odette (Butterfly Goddess).jpg|Butterfly Goddess
Odette (Virgo).jpg|Virgo
Odette (Auspicious Charm).jpg|Auspicious Charm
Odette (Sage of the Currents).jpg|Sage of the Currents
Odette (Wisdom of the Stars).jpg|Wisdom of the Stars
</gallery>

; Painted skins
<gallery captionalign="center" spacing="small">
Odette (Butterfly Faerie).jpg|Butterfly Faerie
Odette (Wisdom of Hearts).jpg|Wisdom of Hearts
Odette (Wisdom of Devotion).jpg|Wisdom of Devotion
</gallery>

===Avatar icons===
<gallery spacing="small" captionalign="center" bordercolor="transparent" widths="100">
Hero461-icon.png|Swan Princess
Hero462-icon.png|Black Swan
Hero463-icon.png|Christmas Carnival
Hero464-icon.png|Mermaid Princess
Hero465-icon.png|Butterfly Goddess
Hero466-icon.png|Virgo
Hero467-icon.png|Auspicious Charm
Hero468-icon.png|Sage of the Currents
Hero469-icon.png|Wisdom of Stars
</gallery>
; Painted skins
<gallery captionalign="center" spacing="small" widths="100" bordercolor="transparent" hideaddbutton="true">
Hero465-color01-icon.png|Butterfly Faerie
Hero469-color01-icon.png|Wisdom of Hearts
Hero469-color02-icon.png|Wisdom of Devotion
</gallery>
...
*It is hinted in one of her quotes that the sword is a gift. The sword gifted by Lancelot.
*Lancelot is referenced in two of her quotes: "Don't ask me why a mage is carrying a sword!" "This sword is a gift."
*Odette is inspired by a character with the same name in [https://en.wikipedia.org/wiki/Swan_Lake Swan Lake]. 
