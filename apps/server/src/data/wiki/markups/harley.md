...
*{{hi|Lesley}} (foster older sister)
*{{hi|Fredrinn}} (older brother)
*{{Hi|Eudora}}, {{hi|Gord}} (teachers)
*{{Hi|Lylia}} (classmate)
|en_va=Jake Diaz{{cite}}
|id_va=Nugraha Sukma Ramadhan{{cite}}
|ja_va=[[wikipedia:ja:松本 さち|Sachi Matsumoto (森嵜 美穂)]]<ref name="In-game credit">In-game credit</ref>
|tl_va=
|ar_va=Abdelaziz Mohamed{{cite}}
|pt_va=Fábio Campos{{cite}}
|ru_va=Bystrov Nicolai{{cite}}
|tk_va=Ali Seyitoğlu{{cite}}
|es_va=Lupita{{cite}}
|zh_va=Shiyu Qiao (乔诗语){{cite}}
|name=Harley}}
{{Quote|The young mage whose powers awakened once thrust into danger and who now arrives at the [[Magic Academy]] to study}}
...
"Lesley, aren't we going home?" Harley was surprised by Lesley's action.

"Do you like that home?" Lesley did not answer his question.
...
"The plan has changed. Our next plan will revolve around Harley..."<ref name="NewLore">[https://play.mobilelegends.com/lore/hero/Harley Mobile Legends: Bang Bang]</ref>
...
|skill-type-1   = 
|image-legend   = 
|description    = Harley's mastery of magic allows his {{ai|Basic Attack}} to deal 60 {{AVC1|(+50%Total Physical Attack)}}{{AVC1|(+60%Total Magic Power)}} {{AVC1|Magic Damage}}. His attacks reduce the enemy's Magic Defense by 2 for 3 seconds on hit (up to 10 stacks).
|term-1         = Magic Basic Attack
|term-2         = 
|term-3         = 
|notes          = *Reduces enemys's [[Magic defense]] by 20 at max stacks.
}}
...
|skill-type-1  = 
|image-legend   = 
|description    = Harley throws 3-5 waves of cards in the target direction, each dealing 130-210 {{AVC1|(+25%Total Magic Power)}} {{AVC1|Magic Damage}} to the first enemy hit and granting him 10% extra Attack Speed for 3 seconds on hit (up to 5-10 stacks). Enemies hit more than 3 times will take less damage from subsequent hits.
|ls-1           = Cards: 3 / 3 / 4 / 4 / 5 / 5
|ls-2           = Base Damage: 130 / 150 / 160 / 180 / 190 / 210
|ls-3           = Attack Speeds Stacks: 5 / 6 / 7 / 8 / 9 / 10
|term-1         = Magic Damage Skill
|term-2         = ATK Speed
|notes          = *Increases Attack Speed by 50%-100% at max stacks.
}}
...
<br><br>{{AVC1|Use Again:|enhanced}} Use again within 4 seconds to return where the hat is and lose the speed boost.
|ls-1           = 
|ls-2           = 
|term-1         = Blink
...
Harley (Mage Genius).jpg|Mage Genius
Harley (Naughty Joker).jpg|Naughty Joker
Harley (Royal Magister).jpg|Royal Magister
Harley (Referee).jpg|Referee
Harley (Great Inventor).jpg|Great Inventor
Harley (V.E.N.O.M. Octopus).jpg|V.E.N.O.M. Octopus
Harley (Dream Caster).jpg|Dream Caster
Harley (Pulsar Prodigy).jpg|Pulsar Prodigy
Harley (Star Magician).jpg|Star Magician
</gallery>

=== Avatar icons ===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
Hero421-icon.png|Mage Genius
Hero422-icon.png|Naughty Joker
Hero423-icon.png|Royal Magister
Hero424-icon.png|Referee
Hero425-icon.png|Great Inventor
Hero426-icon.png|V.E.N.O.M. Octopus
Hero427-icon.png|Dream Caster
Hero428-icon.png|Pulsar Prodigy
Hero429-icon.png|Star Magician
</gallery>

=== Battle emotes ===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
Battle Emote - Merry Christmas! (Harley).png|'''Merry Christmas!'''<br>Obtain via Emote Bundle
Battle Emote - Let me show you something!.png|'''Let me show you something!'''<br>April Fool Collect & Exchange Event
Battle Emote - Wizard Magic.png|'''Wizard Magic'''<br>Obtained via the event shop in the September 2022 new patch.
</gallery>
...
* His name might be inspired by [https://harleyquinn.fandom.com/wiki/Harley_Quinn Harlequin], a classic jester/trickster character in European theater and Western comics.
* His hat, cape, and cards resemble famous stage magicians like [https://en.wikipedia.org/wiki/Harry_Houdini Harry Houdini].
* Harley's skin "Naughty Joker" resembles medieval court jesters who entertained kings with tricks and performances It is also reminiscent of the [https://batman.fandom.com/wiki/Joker Joker] from Batman series.
...
* His aesthetic and abilities resemble other playing card-based characters in gaming and media, such as [https://leagueoflegends.fandom.com/wiki/Twisted_Fate/LoL Twisted Fate] from [https://leagueoflegends.fandom.com/wiki/League_of_Legends League of Legends] or [https://batman.fandom.com/wiki/Joker Joker']s trickster theme.
