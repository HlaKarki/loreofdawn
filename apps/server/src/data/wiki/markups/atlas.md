...
| title          = 
| occupation     = 
| affiliation    = *Frozen Sea
* [[Black Flag]] pirate group (hostile)
| fighting_style = 
| weapons        = Mecha Sentry
| abilities      = Generates [[Atlas#Passive|Frigid Breath]]
| battles_fought = 
| height         = 
| weight         = 
| traits         = 
| likes          = 
| dislikes       = 
| relationships  = *{{hi|Freya}}, {{hi|Franco}} (allies)
*{{hi|Bane}} (enemy)
|en_va=
|id_va=
...
|tk_va=
|es_va=
|zh_va=|Birthday={{birthday|4|25}}<ref name="CNProfile">Official Profile from MLBB CN</ref>}}
{{Quote|Abysmal Sea creature who broke free from the seal}}
...
|cooldown     = 7.0 / 6.5 / 6.0 / 5.5 / 5.0 / 4.5
|mana-cost    = 60 / 66 / 72 / 78 / 84 / 90
|description  = Atlas smashes the ground and causes 3 explosions. Each explosion deals {{Scale|base=230-430|total-mp=60|md}} to enemies.<br>{{b|Ejected State|e}}: If Atlas has ejected from his Mecha Sentry, both himself and his Mecha will cast {{ai|Annihilate}}.
|ls-1           = Base Damage: 230 / 270 / 310 / 350 / 390 / 430
|ls-2           = 
|ls-3           = 
|ls-4           = 
|ss-1           = 
...
|description   = Atlas enters {{b|Ejected State|e}}, gaining 40% {{b|Movement Speed}} and {{b|immunity to slow effects|slow immunity}}. In this state, the Mecha Sentry will follow the pilot at an increasing speed (can only be controlled by {{b|Suppression|cc}}). Once they meet, Atlas will return to the Mecha, dealing {{Scale|base=320-420|total-mp=80|md}} to enemies nearby and {{b|stunning|cc}} them for 1 second.<br>{{b|Ejected State|e}}: Atlas and his Mecha share the {{b|same HP bar|HP}} and reduce {{B|50% of the damage taken|damage reduction}} in this state.
|ls-1           = Base Damage: 320 / 340 / 360 / 380 / 400 / 420
|ls-2           = 
|ls-3           = 
|ls-4           = 
|ss-1           = 
...
|description  = Atlas hurls chains around and starts to channel (can only be interrupted by {{b|suppressing|cc}}), dealing {{Scale|base=225-475|total-mp=75|md}} to enemy heroes hit and {{b|slowing}} them by 40% for 3 seconds.<br>Use this skill again while channeling: Atlas will {{b|drag the targets toward him and plunk them down|cc}} on the designated location, dealing {{Scale|base=360-760|total-mp=180|md}}.<br>Use this skill in {{b|Ejected State|e}}: The Mecha Sentry will return to Atlas immediately, but the {{B|stun effect}} will be replaced by 40% {{b|slow effect}}.
|ls-1           = [Base] Connection Damage: 225 / 350 / 475
|ls-2           = [Base] Smash Damage: 360 / 560 / 760
|ls-3           = 
|ls-4           = 
|ss-1           = 
|ss-2           = 
...
|term-3         = 
|notes          =*Atlas only chains heroes that are in range before he starts channeling. Heroes that walks into range while he is already channeling will not be chained.
*Holding the skill starts the channeling and releasing it triggers the second phase. This means that you cannot cancel this skill and you can't check its range. 
|bugs           = 
}}
...
Ocean Gladiator wall.jpg|Ocean Gladiator
Reactor Core wall.jpg|Reactor Core
Fuel Turbine wall.jpg|Fuel Turbine
Atlas (Space Mech).png|Space Mech
Atlas (Rune Sentinel).jpg|Rune Sentinel
Atlas (Mecha Infernus).jpg|Mecha Infernus
</gallery>
===Avatar icons===
<gallery spacing="small" captionalign="center" bordercolor="transparent" widths="100" hideaddbutton="true">
Hero931-icon.png|Ocean Gladiator
Hero932-icon.png|Reactor Core
Hero933-icon.png|Fuel Turbine
Hero934-icon.png|Space Mech
Hero935-icon.png|Rune Sentinel
Hero936-icon.png|Mecha Infernus
</gallery>
...
Astral Warrior, Move Out!.png|'''Astral Warrior, Move Out!'''
</gallery>
=== Videos ===
<gallery>
Hero Spotlight Atlas Ocean Gladiator Mobile Legends Bang Bang
</gallery>

== Trivia ==
* The name '''Atlas''' is as a boy's name of Greek origin, and the meaning of it is "to carry". Atlas was a [[wikipedia:Atlas (mythology)|mythical titan]] who bore the weight of the world on his shoulders, so the name bears connotations of great strength.
...
[[Category:Northern Vale inhabitants]]
