...
*Wings of Holiness
*Archangel
| birthday       = {{birthday|2|25}}<ref name="RafaelaCNProfile">[https://weibo.com/7711876938/P5qS3pCvI Official profile from Weibo]
<gallery>
Profile CN Rafaela.jpg
</gallery>
</ref>
| chinese_name   = 拉菲尔 (lāfēiěr)
| born           = 
...
| fighting_style = 
| weapons        = Staff
| abilities      = *Power of Holy Light through [[#Skill 2|healing]] allies and inflicting damage to enemies.
*[[#Passive|Penalizes target after death]]
| battles_fought = 
| height         = 
| weight         = 
| traits         = 
| likes          = 
| dislikes       = 
| relationships  =*Unnamed mother (deceased)
*{{hi|Argus}} (older twin brother)
...
| id_va = Kuswayanti Woro Dewi{{cite}}
| tl_va =
| ar_va =
| pt_va =
| ru_va =
...
{{quote|An angel loved and respected by the people of this world}}
...
|skill-effect-2 = Slow
|cooldown       = 4.0
|mana-cost      = 70 / 85 / 100 / 115 / 130 / 145
|energy-cost    = 
|quote          = 
|description    = Rafaela strikes the three nearest enemies With Light of Retribution, dealing them {{scale|base=225-500|total-mp=120|md}}, briefly [[revealing]] their positions, and [[slowing]] them by 40% for 1.5s. Enemies hit by Light of Retribution again within 5 seconds will take 20% extra damage (this effect stacks up to 3 times).
|properties     = *'''Base Damage:''' 225 / 280 / 335 / 390 / 445 / 500
*'''Damage Increase Per Stack''' 20% / 40% / 60%
|calc           = <math>{\rm total\ skill\ DMG} = \bigl[ 170 + (55 \times skill\ lv.) + 25%\ total\ magic\ power \bigr] + (20% \times no.\ of\ stacks),\ where\ 0 \leq no.\ of\ stacks \leq 3</math>
|term-1         = Magic Damage Skill
|term-2         = Movement Speed
,|term-3         = 
|notes          = *This skill's attacks prioritize enemy heroes the most.
*The skill's stack applies a mark that is only visible to enemy heroes but is invisible from Rafaela's enemies' perspective.
**It counts as a [[debuff]] and can be removed by skills such as [[Purify]].
|bugs           = 
}}
...
|skill-type-2   =
|skill-type-3   = 
|cooldown       = 10.5 / 10.1 / 9.7 / 9.3 / 8.9 / 8.5
...
|ss-2           = 
|ss-3           = 
|calc           = <math>{\rm extra\ movement\ SPD} = 30% + (0.05% \times magic\ power),\ where\ magic\ power \leq 1000</math>
...
|skill-effect-1 = CC
|skill-effect-2 = AOE
|cooldown       = 42.0 / 38.0 / 34.0
|mana-cost      = 150 / 175 / 200
|energy-cost    = 
|quote          = 
|description    = Rafaela unleashes the true power of {{B|Holy Light|e}} in the target direction, dealing {{Scale|base=460-660|total-mp=120|md}} to enemies in a line and [[stunning]] them for 1.5 seconds.
|properties     =*'''[[Spell Vamp Ratio]]:''' 50%
*'''Base Damage:''' 460 / 560 / 660
|ls-2           = 
|ls-3           = 
|ls-4           = 
|ls-5           = 
...
Rafaela (Wings of Holiness).jpg|Wings of Holiness
Rafaela (Fertility Goddess).jpg|Fertility Goddess
Rafaela (Flower Fairy).jpg|Flower Fairy
Rafaela (Biomedic).jpg|Biomedic
Rafaela (S.A.B.E.R. Savior).jpg|S.A.B.E.R Savior
Rafaela (Star Chaser).jpg|Star Chaser
Rafaela (Angelic Sonata).jpg|Angelic Sonata
Rafaela (Seraphic Selfie).jpg|Seraphic Selfie
Rafaela (Bloom of Abundance).jpg|Bloom of Abundance
</gallery>
=== Avatar icons ===
<gallery spacing="small" captionalign="center" hideaddbutton="true" widths="100" bordercolor="transparent">
Hero141-icon.png|Wings of Holiness
Hero142-icon.png|Fertility Goddess
Hero143-icon.png|Flower Fairy
Hero144-icon.png|Biomedic
Hero145-icon.png|S.A.B.E.R Savior
Hero146-icon.png|Star Chaser
Hero147-icon.png|Angelic Sonata
Hero148-icon.png|Seraphic Selfie
Hero149-icon.png|Bloom of Abundance
</gallery>
=== Battle emotes ===
<gallery spacing="small" captionalign="center" hideaddbutton="true" widths="100" bordercolor="transparent">
Battle Emote - Looks Decide Everything!.png|'''Looks Decide Everything!'''<br>Obtained via Rafaela's Live Stream event
Battle Emote - Wish You An Abundant Year!.png|'''Wish You An Abundant Year!'''<br>Available via the 2025 Spring Festival Lanterns of Spring event
</gallery>

== Trivia ==
* Rafaela is the game's first healer and pure [[Support (Role)|support]] in the game.
* Rafaela's skin "Fertility Goddess" could be based on [https://www.britannica.com/topic/Isis-Egyptian-goddess Isis], the goddess of healing and magic, was crucial to ancient Egyptian religious beliefs.
