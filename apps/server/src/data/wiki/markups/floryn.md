...
| birthday       = {{birthday|2|24}}<ref name="CNProfile">Official Profile from MLBB CN</ref>
| origin         = 
| age            = 
...
| likes          = 
| dislikes       = 
| relationships  = *[[Floryn#Passive|Dew]] (companion)
*{{hi|Belerick}} (creator/father)
*{{hi|Sora}} (companion)
| en_va          = 
| ja_va          = Goto Ayasa (後藤 彩佐)<ref name="In-game credit">In-game credit</ref>
| id_va          = Melati Pertiwi Putri{{cite}}
}}
=== Lore ===
...
[[File:Floryn story.png|center|512px]]
...
{{Ability
|variations-1   = Sanrio
|image-2        = Lantern of Hope
|image-3        = Flower of Hope
|name           = Dew
|skill-effect-1 = Buff
|skill-effect-2 = 
|cooldown       = 
...
|term-2         = 
|term-3         = 
|notes          =*Does not affect target ally's networth.
...
|skill-effect-2 = Heal
|cooldown       = 9.0 / 8.7 / 8.4 / 8.1 / 7.8 / 7.5
|mana-cost      = 90 / 100 / 110 / 120 / 130 / 140
|energy-cost    = 
|quote          = 
|description    = Floryn tosses an Energy Seed at a target enemy, dealing {{Scale|base=180-330|total-mp=100|md}}. Healing Fruits will then spawn and bounce to nearby allied heroes, restoring [{{Scale|base=175-225|total-mp=90|hp}}].
...
|term-2         = 
|term-3         = 
|notes          = *Healing Fruits range has the same range as the cast range of this skill.
...
|energy-cost    = 
|quote          = 
|description    = Floryn casts a blob of energy ahead and explodes upon hitting an enemy, dealing {{Scale|base=175-350|total-mp=90|md}} to nearby enemies [[stunning]] them for 0.7 seconds (and revealing their positions briefly).<sup>[''duration needed'']</sup>
|properties     = *'''[[Spell Vamp Ratio]]:''' 50%
...
|energy-cost    = 
|quote          = 
|description    = Floryn resonates with Dew's power, restoring {{Scale|base=250-450|total-mp=100|hp}} to all allied heroes 2 times no matter where they are on the battlefield. This effect removes any [[Life Drain|Healing Reduction or Shield Reduction]] effects on allied heroes, and makes them immune to the effects for 2 seconds.
|properties= *'''Base Healing:''' 250 / 350 / 450
|calc           = 
|notes          =*Cannot affect ally inside {{hi|Yin}}'s {{ai|My Turn}} nor allies outside if {{hi|Floryn}} is inside.
...
Floryn (The Budding Hope).jpg|The Budding Hope
Floryn (Springtide).jpg|Springtide
Floryn (Fluffy Dream).jpg|Fluffy Dream
Floryn (Paw Power).jpg|Paw Power
Floryn (Yatai Waitress).jpg|Yatai Waitress
Floryn (Melody of Light).jpg|Melody of Light
</gallery>
===Avatar icons===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
Hero1121-icon.png|The Budding Hope
Hero1122-icon.png|Springtide
Hero1123-icon.png|Fluffy Dream
Hero1124-icon.png|Paw Power
Hero1125-icon.png|Yatai Waitress
Hero1126-icon.png|Melody of Light
</gallery>
<!--
=== Battle emotes ===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
...
==Videos==
<gallery captionalign="center" spacing="small" hideaddbutton="true">
New Hero - Floryn Animated Trailer - Mobile Legends- Bang Bang
Hero Spotlight - Floryn - The Budding Hope - Mobile Legends- Bang Bang
</gallery>
==Trivia==
*Floryn was the 8th and is one of the heroes who was given to players for free on release. The other heroes who were given for free are: {{hi|Faramis}}, {{hi|Belerick}}, {{hi|Silvanna}}, {{hi|Luo Yi}}, {{hi|Benedetta}}, {{hi|Mathilda}}, {{hi|Phoveus}}, and {{hi|Edith}}.
...
[[Category:Agelta Drylands inhabitants]]