...
| full_name      = 
| alias          = Dark Angel
| chinese_name   = 路西法 (lùxīfǎ "Lucifer"<ref>路西法 (lùxīfǎ) is a chinese translation of "Lucifer"</ref>)
| born           = 
| origin         = 
| age            = 
| birthday       = {{birthday|10|31}}<ref name="CNProfile">Official Profile from MLBB CN</ref>
...
| abilities      = *[[#Passive|Charging his blade with Malice Energy]]
*[[#Skill 2|Curses enemies]]
*[[#Ultimate|Death immunity]]
| battles_fought = 
| height         = 
| weight         = 
| traits         = 
| likes          = 
| dislikes       = 
| relationships  = *Unnamed father and mother (deceased)
*{{hi|Rafaela}} (younger twin sister)
*Lord of Light (Enemy)
*Cyd (Captor)
*{{Hi|Zhask}} (enemy - old lore)
|en_va=Con Eyre (2017–2021)<ref name="coneyre">[https://www.coneyre.com/#/mobile-legends/:~:text=Throughout%20the%20Mobile%20Legends%20universe%20I%20voice%20a%20number%20of%20characters%20including%20Balmond%2C%20Saber%2C%20Alpha%2C%20Gord%2C%20Jawhead%2C%20Gusion%2C%20Belerick%2C%20%20Leomord%2C%20Thamuz%2C%20Argus%20and%20Terizla.%20I%20also%20do%20a%20number%20of%20short%20origin%20stories%20on%20certain%20characters. Con Eyre Voice Over Actor]<br>''„Throughout the Mobile Legends universe I voice a number of characters including Balmond, Saber, Alpha, Gord, Jawhead, Gusion, Belerick, Leomord, Thamuz, Argus and Terizla. I also do a number of short origin stories on certain characters.“''</ref>
[[imdb:nm1109053|Marc Elmer]] (2021–)<ref name="marcelmer">[https://www.linkedin.com/in/marc-elmer-ace-b299228/details/experience/#:~:text=2021%20%C2%B7%201%20Monat-,Voiced%20characters%20for%20two%20different%20Moonton%20Games%22%20%22Mobile%20Legends%3A%20Adventure%22%20(Argus%2C%20Hanzo%2C%20and%20Hayabusa)%20and%20%22Mobile%20Legends%3A%20Bang%20Bang%22%20(Argus%20and%20Lancelot%20Swordmaster),-Voiced%20characters%20for Marc Elmer]<br>''„Voiced characters for two different Moonton Games: "Mobile Legends: Adventure" (Argus, Hanzo, and Hayabusa) and "Mobile Legends: Bang Bang" (Argus and Lancelot Swordmaster).“''</ref>
|ja_va=Hoshi Yuuki (星祐樹)<ref name="In-game credit">In-game credit</ref>
...
{{quote|The angel who fell from light into darkness.}}
...
The angel had abandoned all he once had. And so holiness severed its bond with him forever.
...
|energy-cost    = 
|quote          = 
|description    = When Argus' blade reaches 100 {{B|Malice Energy|rage}}<sup>[''amount unknown'']</sup>. He will launch a Demonic Slash with his next Basic Attack, dealing {{scale|base=180|total-pa=80|pd}} and recovering {{scale|base=150|total-pa=10|hp}}. This attack ignores 40% of the target's [[Physical Defense]] 

<br>Argus' Demonic Blade gains 5 Malice Energy per second, and each of his Basic Attacks grants 10 Malice Energy. ([[critical]] strikes grant an additional 10 energy)
|ls-1           = 
|ls-2           = 
|ls-3           = 
|ls-4           = 
...
|term-2         = 
|term-3         = 
|notes          = *{{ai|Warmonger}} costs 100 [[Rage|Malice Energy]] (rage).
...
|energy-cost    = 
|quote          = 
|description    = After a short delay, Argus thrusts his Demonic Blade in the target direction, dealing {{scale|base=120-240|total-pa=100|pd}} to enemies hit (deals {{B|200% damage|pd}} to [[minions]]) and [[slowing]] them by 80% for 0.8 seconds, the delay time will decrease as Argus' Attack Speed increases. Enemy heroes hit are {{b|Cursed|debuff}} for 4 seconds, during which they will leave a Cursed Trail behind. Argus gains 20% [[Movement Speed| Movement Speed]] while on a Cursed Trail.<br><br>Metoric Sword counts as [[Basic Attack]] damage and can trigger Attack Effects. Hitting heroes restores 100 Malice Energy (excess is preserved).
|ls-1           = Base Damage: 120 / 144 / 168 / 192 / 216 / 240
|ls-2           = 
|ls-3           = 
|ls-4           = 
|ls-5           = 
...
|mana-cost      = 
|energy-cost    = 
|quote          = Battlefield is my playground and I think nothing of life and death.
|description    = Argus draws his Meteoric Sword and removes all [[debuffs]] (excluding [[Suppression]]) on himself, dealing {{scale|base=150-300|total-pa=50|pd}}  and becoming the Fallen Angel for 4 seconds (hitting heroes enhances Warmonger).<br>Fallen Angel: Gain 40% Movement Speed that decays over 1 second; When the transformation ends, he converts all his damage dealt in the Fallen Angel state into HP. If he takes fatal damage, the duration of the Movement Speed boost will be reset, and he will gain [[Death Immunity]] for 4 seconds.<br>Enhanced Warmonger: grants 50-60 [[Malice Energy]] (50-40) (extra Malice Energy with critical hits). <br>If Death Immunity isn't triggered during his transformation, the cooldown will be reduced by 50% when the skill ends.
|ls-1           = 
|ls-2           = 
|ls-3           = 
|ls-4           = 
...
|ss-3           = 
|calc           = 
|term-1         =Physical Damage 
|term-2         = 
|term-3         = 
|notes          = *[[Heal|Health regeneration based on damage dealt]] is not affected by Argus' [[Healing Effect]] and [[Healing Received]].
...
Argus (Dark Angel).jpg|Dark Angel
Argus (Light of Dawn).jpg|Light of Dawn
Argus (Dark Draconic).jpg|Dark Draconic
Argus (Catastrophe).jpg|Catastrophe
Argus (Blade of Rakshasha).jpg|Blade of Rakshasha
Argus (Darth Vader).jpg|Darth Vader
Argus (Winged Nightmare).jpg|Winged Nightmare
</gallery>
=== Avatar icons ===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
Hero451-icon.png|Dark Angel
Hero452-icon.png|Light of Dawn
Hero453-icon.png|Dark Draconic
Hero454-icon.png|Catastrophe
Hero455-icon.png|Blade of Rakshaha
Hero456-icon.png|Darth Vader
Hero457-icon.png|Winged Nightmare
</gallery>
=== Battle emotes ===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
You don't know the power of the darkside..png|'''You don't know the power of the darkside.'''<br>Obtained by exchanging from the "MLBB x Star Wars" event.
</gallery>
