...
| fighting_style = 
| weapons        = *[[X.Borg#Passive|Firaga Armor]]
*[[X.Borg#Skill 1|Flamethrower]]
*[[X.Borg#Skill 2|Fire Stakes]]
| abilities      = [[X.Borg#Ultimate|Self-destruction]]
...
| likes          = 
| dislikes       = 
| relationships  = *[[Octavius]] (accomplice)<ref name="XBorgLethalNexusMap"/>
*{{hi|Beatrix}}, [[Dr. Rooney]], {{hi|Layla}}, {{hi|Johnson}}, {{hi|Bruno}}, {{hi|Chou}}, {{hi|Diggie}}, {{hi|Ixia}}, {{hi|Kimmy}}, {{hi|Nolan}} (enemies)<ref name="XBorgLethalNexusMap"/>
| en_va          = 
| ja_va          = Shiki Yoshida (吉田 史記)<ref name="In-game credit">In-game credit</ref>
| id_va          = Irfan Setiawan{{cite}}
| tl_va          = 
| ar_va          = 
| pt_va          = 
| ru_va          = 
...
<!--{{Quote|The maniacal cyborg who takes revenge on Eruditio}}
After losing his loved ones in the accident caused by Erudtio, X.Borg decided to take revenge. In order to achieve his goal, he collected discarded technology and remade his body twice, eventually transforming himself into a cyborg that's capable of throwing flames and making blasts.-->

=== Lore ===
[[File:X.Borg lore.png|center|512px]]
...
{{quote|A mad arsonist who has a deep hatred for Eruditio, has been lurking around waiting for an opportunity to take revenge. After obtaining confidential information about the "Iron Guardians", he quietly set out to [[Laboratory 1718]] and plotted a big conspiracy with [[Octavius]].<ref name="XBorgLethalNexusMap">[https://youtu.be/30DYLZIcCyc?si=oVQyfdsL4a1U-k9t&t=93 EXPLORE THE MAP OF ERUDITIO! GET TRIAL CARDS | READ HEROES BIO | ALPHA IS NOW A BAD GUY! | MLBB MAP] ''(Timecode: '''1:33''')''
<gallery>
XBorg Lethal Nexus Map Profile.png
XBorg Lethal Nexus Map Background Story.png
</gallery>
</ref><ref group="note">Age information on his Lethal Nexus info card is out of date. This in-game event, which included ages and other character information, was held before the Eruditio region update in 2023. In these pictures, [[X.Borg]]'s age is listed as 26, but his canon age is currently 18, according to his official Weibo profile. For these reasons, all information from this event may be inaccurate for the current version.</ref>}}
...
|term-1 = Max HP 
|term-2 = Blink 
|term-3 = Damage Immunity
|description = X.Borg's [HP inherits {{scale|extra-hp=20}}, and his {{b|Firaga Armor|e}} inherits {{scale|extra-hp=120}}] and absorbs all incoming damage when it's active. When the Armor is destroyed, X.Borg will disengage from it and [[blink and charge|roll]] in the direction of the Joystick (he is immune to damage [and control effects] in this process). The Armor's energy will gradually regenerate [for 3 energy per second] while X.Borg is in the Armorless State. At full energy, X.Borg re-equips the Armor and restore it to 30% of his <nowiki>[</nowiki>[[HP|Armor HP]]<nowiki>]</nowiki>.<br>X.Borg's skills deal [[True Damage]] in Overheated state.
|notes = *The HP Armor's "energy" is technically not an [[energy]] attribute since X.Borg's doesn't benefit from the purple buff and the energy is omitted on his stats.
*X.Borg's [[Basic Attack]] becomes ranged, {{Ai|Fire Missiles (Armorless State)|Fire Missiles}} and {{Ai|Fire Stake (Armorless State)|Fire Stake}} are adjusted, and X.Borg becomes unable to cast {{Ai|Last Insanity}} during his Armorless State.
...
|variations-1=Transformers
|name = Fire Missiles
|image-2 = Fire Missiles - Armorless State
|cooldown = 4.0
|skill-effect-1 = AOE
|term-1 = Physical Damage Skill 
|term-2 = True Damage
|description = X.Borg sprays fire, dealing {{scale|base=25-100|total-pa=60|total-mp=40|pd}} 7 times over 2 seconds to enemies in range (75%&ndash;100% damage to [[Minions]]).<br>{{AVC1|Armorless state:|e}} The attack area becomes narrower but longer, while the damage is reduced to 60%.
|properties = *'''Base Damage:''' 25 / 40 / 55 / 70 / 85 / 100
*'''Damage to [[Minions]]:'''  75% / 80% / 85% / 90% / 95% / 100%
|notes = *Fire Missiles is not visible during [[stealth]].<ref>[https://www.youtube.com/watch?v=NFE8xwIUxj0 "CAN THE ENEMY SEE THE SKILL EFFECTS IN A BUSH? - BUSH INVISIBILITY GUIDE - MLBB"]. ''Elgin''. 18-08-2020. Retrieved 06-03-2022 – via www.outube.com. Event happens on [https://youtu.be/NFE8xwIUxj0?t=70 1:10].</ref>
*This skill can only be interrupted by high- and ultimate-level [[control effects]].
*{{hi|Yin}}'s {{ai|My Turn}} cancels this ability upon entering and leaving.
}}
...
|variations-1=Transformers
|name = Fire Stake
|image-2 = Fire Stake - Armorless State
|cooldown = 12 / 11.4 / 10.8 / 10.2 / 9.6 / 9
|skill-effect-1 = CC
|term-1 = Physical Skill
|term-2 = Displacement
|description = X.Borg shoots 5 Fire Stakes at the edge of the fan-shaped indicator and retrieves them after 1.7 seconds, each dealing {{scale|base=50-100|total-pa=20|pd}} and [[pulling]] the enemies in the path toward him. Firaga Supplies in the path will also be retrieved if touched by Fire Stakes.<br>{{B|Armorless|e}} State: X.Borg adjusts Fire Stake Launcher to increase its range and shorten the distance between Fire Stakes.
|properties = *'''Base Damage:''' 50 / 60 / 70 / 80 / 90 / 100
|notes=*Retrieving Fire Stakes apply a [[micro stun]] to enemies. ([[Patch Notes 1.7.58]])
}}
...
*{{hi|Yin}}'s {{ai|My Turn}} does not cancel this ability.
}}

== Gallery ==
=== Splash art ===
<gallery spacing="small" captionalign="center" hideaddbutton="true">
File:X.Borg (Firaga Armor).jpg|Firaga Armor
File:X.Borg (Blue Storm).jpg|Blue Storm
File:X.Borg (Moto Drifter).jpg|Moto Drifter
File:X.Borg (Graffiti Fashion).jpg|Graffiti Fashion
File:X.Borg (Tesla Maniac).jpg|Tesla Maniac
File:X.Borg (Bumblebee).jpg|Bumblebee
File:X.Borg (Pecados Rioter).jpg|Pecados Rioter
File:X.Borg (Invoker's Flame).jpg|Invoker's Flame
</gallery>
=== Avatar icons ===
<gallery spacing="small" captionalign="center" widths="100" bordercolor="transparent" hideaddbutton="true">
Hero831-icon.png|Firaga Armor
Hero832-icon.png|Blue Storm
Hero833-icon.png|Moto Drifter
Hero834-icon.png|Graffiti Fashion
Hero835-icon.png|Tesla Maniac
Hero836-icon.png|Bumblebee
Hero837-icon.png|Pecados Rioter
</gallery>
=== Battle emotes ===
<gallery spacing="small" captionalign="center" widths="100" bordercolor="transparent" hideaddbutton="true">
Heartthrob.png|'''Heartthrob'''<br>Battle Emote - 2020/06 Starlight Special
Bumblebee reporting for duty!.png|'''Bumblebee reporting for duty!'''<br>Obtained after collecting the MLBB X Transformers series skins.
</gallery>

==Videos==
<gallery spacing="small" captionalign="center">
New Hero Firaga Armor X.Borg Mobile Legends Bang Bang!-0
Flames! Burn it all! - MLBB ✕ MLA Trailer - Mobile Legends- Bang Bang!
