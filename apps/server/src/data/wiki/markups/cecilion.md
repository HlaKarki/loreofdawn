...
|chinese_name=琉 (liú)
|born=[[The Abyss]]
|birthday={{birthday|7|14}}<ref name="CecilionCNProfile">[https://weibo.com/7711876938/Pd2t0x3QZ Official profile from Weibo]
<gallery>
Profile CN Cecilion.jpg
</gallery>
</ref>
|gender=Male
|species=Blood Demon
...
|traits= Graceful, Deeply in love<ref name="CecilionCNProfile" /><ref>Original Text: 优雅、深情<br>优雅 (yōuyǎ) meaning "graceful, elegant, refined"<br>深情 (shēnqíng) meaning "deep feeling, deep love, loving, affectionate, tender"</ref>
|abilities=*Bat summoning
*[[#Skill 2|Summons giant claw]]
*[[#Skill 1|Summons giant bat]]
|weapons=Scepter
|relationships=*{{hi|name=Carmilla}} (lover)
*{{hi|name=Gusion}} (savior)
*{{hi|name=Alice}} (enemy)
|en_va=
|id_va=
...
{{Quote|Carmilla's Blood Demon lover}}
...
|term-1         = Max Mana
|term-2         = Mana Regen
|description    = Cecilion increases his {{b|Max Mana}} by 10 and restores the same amount of {{b|Mana}} his skill hits an enemy target. {{b|Cooldown}}: 1 second.<br>Cecilion has higher {{b|Max Mana}} and {{b|Mana Regen}}, and his skill damage scales with his {{b|Max Mana}}.
|ss-1           = Extra Mana: {10, 20, 30, &#8230; , 999990}
|calc           = <math>{\rm extra\ mana} = 10 \times no.\ of\ stacks</math>
|notes          = *Cecilion can gain up to 99999 {{ai|Overflowing}} stacks, for which he can gain up to 999990 {{b|Extra Mana}} at full stacks.<ref>[https://youtu.be/znsprwWw1PY "HOW LONG IT TAKES TO REACH 99,999 STACKS WITH CECILION 😲 MLBB"]. ''Elgin''. 2020-02-14. Retrieved 2022-03-02 – via www.youtube.com.</ref>
|term1          = Max Mana
|term2          = Mana Regen
}}
...
{{Ability
|variations-1   = HUNTER×HUNTER
|image-2        = Bat Impact 2
|image-3        = Bat Impact 3
|image-4        = Bat Impact 4
|image-5        = Bat Impact 5
|name           = Bat Impact
|skill-effect-1 = AoE
...
|cooldown       = 1.5
|mana-cost      = 75
|description    = Cecilion orders a giant bat to dive in a designated direction, dealing {{Scale|base=100-250|total-mp=80|total-mana=5|md}} to enemies on the path. The giant bat will stay at its destination and launch another attack, dealing {{Scale|base=200-500|total-mp=160|total-mana=10|md}} to enemies and triggering {{ai|Overflowing}} extra 1 time.<br><br>In 6 seconds, every time Cecilion casts this skill, the {{b|mana}} cost will be increased by 1.8 time(s) (capped at 4 times). While casting this skill, he also gains 30% {{b|Movement Speed}} for 1 second.
|ls-1          = Base Damage: 100 / 130 / 160 / 190 / 220 / 250
|ls-2          = Destination Damage: 200 / 260 / 320 / 380 / 440 / 500
|ss-1          = Mana Cost: 75 / 135 / 245 / 445 / 800
|term-1        = Max Mana
|term-2        = Magic Skill
|term-3         = Movement Speed
|notes         = *This skill can trigger {{ai|Overflowing}} for a maximum of 3 times in a single cast.
}}
...
|description    = Cecilion summons a pair of claws in a designated location. After a short delay, the claws will move toward each other and {{b|pull|cc}} enemies along the way to the center, dealing {{Scale|base=200-300|total-mp=45|total-mana=1.2|md}} and {{b|immobilizing|cc}} them for 1 second.
...
|skill-effect-2 = Speed Up
|skill-type-1   = Magic Skill
|cooldown       = 44.0 / 41.0 / 38.0
|mana-cost      = 150 / 200 / 250
|description    = Cecilion unleashes Blood Demon power [for 6 seconds], increasing his {{b|Movement Speed}} by 60% (decaying rapidly over 1.5 seconds) and gaining {{b|immunity to slow effects|slow immunity}}. Meanwhile, he shoots 40 bolts of blood energy at the enemies nearby, each dealing {{Scale|base=35-45|total-mp=8|total-mana=0.3|md}} and {{b|slowing}} them by 3% (up to 30%) for 1 second.<br>Hitting an enemy {{b|heals|heal}} him for 10 and 1% of his {{b|lost HP|health}}.
|term-1          = Movement Speed
|term-2          = Magic Skill
|term-3          = Regen Effect
|ls-1           = Base Damage: 35 / 40 / 45
|ls-2           = HP Regen: 10 / 12.5 / 15
|ss-1           = Slowing Effect: {3%, 6%, 9%, 12%, 15%, 18%, 21%, 24%, 27%, 30%}
...
|skill-type-1   = Magic Skill
|cooldown       = 20.0
|description    = When {{hi|Carmilla}} is nearby, Cecilion can call her into a {{ai|Vermeil Shadow|Vermil Shadow}} possessed by him [for 5 seconds], providing {{Scale|base=220-500|shield}} (scales with Carmilla's level).<br>Carmilla can select a target place and land on there, gaining equal shield, dealing {{Scale|base=220-500|md}} (scales with her level) within the area of effect, and {{AVC1|slowing}} them down by 30% for 1 second.
|term-1          = Shield
|term-2          = Magic Skill
|term-3          = Movement Speed
|ls-1           = Base Shield,<br>Magic Damage: 220 / 240 / 260 / 280 / 300 / 320 / 340 / 360 / 380 / 400 / 420 / 440 / 460 / 480 / 500
|calc           = <math>{\rm shield} = 200 + (20 \times Carmilla\text{'}s\ level)</math><br><math>{\rm magic\ damage} = 200 + (20 \times Carmilla\text{'}s\ level)</math>
|notes=*Cecilion will be unable to use {{ai|Moonlit Waltz}} if an allied {{hi|Carmilla}} bought a {{ii|Broken Heart}} in the [[Shop]].
...
Embrace of Night wall.jpg|Embrace of Night
Wisteria Count, & Wisteria Countess wall.jpg|Wisteria Count
Magician Girl, & The Illusionist wall.jpg|The Illusionist
Phantom Countess & Phantom Count wall.jpg|Phantom Count
Stargazer wall.jpg|Stargazer
Cecilion (Crimson Wings).jpg|Crimson Wings
Cecilion (Hisoka).jpg|Hisoka
</gallery>
===Avatar icons===
<gallery spacing="small" captionalign="center" bordercolor="transparent" widths="100" hideaddbutton="true">
Hero911-icon.png|Embrace of Night
Hero912-icon.png|Wisteria Count
Hero913-icon.png|The Illusionist
Hero914-icon.png|Phantom Count
Hero915-icon.png|Stargazer
Hero916-icon.png|Crimson Wings
Hero917-icon.png|Hisoka
</gallery>
===Battle emotes===
<gallery spacing="small" captionalign="center" bordercolor="transparent" widths="100" hideaddbutton="true">
Love ya!.png|'''Love ya!'''<br>Obtaned from the 2021 Valentine's Day Collect & Exchange Event.
Got a Problem?.png|'''Got a Problem?'''<br>Battle Emote - 2022/2 Starlight Special
Battle Emote - No-No.png|'''No-No'''<br>Obtain via the MLBB & HUNTER×HUNTER collab event.
</gallery>
