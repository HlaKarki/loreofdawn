...
| birthday       = {{birthday|11|21}}<ref name="CNProfile">Official Profile from MLBB CN</ref>
| origin         = 
| age            = 
| species        = Orc
| gender         = Male
...
| affiliation    = *Orc Legion
*[[The Abyss]]
| fighting_style = 
| weapons        = Battleaxe
| abilities      = [[Balmond#Passive|Bloodthirst]]
...
*{{hi|Alice}} (mutually exploit)
*{{hi|Thamuz}} (rival)
*{{hi|Alucard}}, {{hi|Harith}}, {{hi|Estes}}, {{hi|Miya}} (enemies)
*{{hi|Dyrroth}} (conqueror/defeater)
...
Patrick Seitz{{cite}} (2021&ndash;)
|id_va          = Edy Rachmat{{cite}}
|ja_va          = [[imdb:nm9846051|Sanpei Yuuki (三瓶 雄樹)]]<ref name="In-game credit">In-game credit</ref>
|tl_va          =
|ar_va          = Khaled El Shershaby{{cite}}
|pt_va          = Fransisco Junior{{cite}}
|ru_va          = Dakhnenko Maksim{{cite}}
|tk_va          = Kadir Özübek{{cite}}
|es_va          = Carlos Segundo{{cite}}
|zh_va          = Sheng Feng (图特哈蒙){{cite}}
}}
{{quote|Leader of the Orc Legion}}
...
|description = Balmond gains 15% [[Movement Speed]] that decays over time and spins his axe for 3 seconds, dealing {{scale|base=25-100|total-pa=25|pd}} to nearby enemies up to 14 times. Each subsequent hit on the same enemy will deal 7.5% increased damage (up to 60%).<br>The [[Physical Attack]] bonus portion of the damage can [[Crit]].
|level-scaling=Base Damage: 25 / 40 / 55 / 70 / 85 / 100
Max Damage: 350 / 560 / 770 / 980 / 1190 / 1400
|stack-scaling=Damage Increase per Subsequent Hit: 7.5% / 15% / 22.5% / 30% / 37.5% / 45% / 52.5% / 60.0%
|notes=*Cyclone Sweep can only be cancelled by using his other skills. (added [[Patch Notes 1.7.82]])
...
Balmond (Bloody Beast).jpg|Bloody Beast
Balmond (Power Source).jpg|Power Source
Balmond (Ghoul's Fury).jpg|Ghoul's Fury
Balmond (Savage Hunter).jpg|Savage Hunter
Balmond (God of Mountains).jpg|God of Mountains
Balmond (Savage Pointguard).jpg|Savage Pointguard
Balmond (Bioroid).jpg|Bioroid
Balmond (Infernal Warlord).jpg|Infernal Warlord
Balmond (Razor Edge).jpg|Razor Edge
</gallery>

=== Avatar icons ===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
Hero021-icon.png|Bloody Beast
Hero022-icon.png|Power Source
Hero023-icon.png|Ghoul's Fury
Hero024-icon.png|Savage Hunter
Hero025-icon.png|God of Mountains
Hero026-icon.png|Savage Pointguard
Hero027-icon.png|Bioroid
Hero028-icon.png|Infernal Warlord
Hero029-icon.png|Razor Edge
</gallery>

=== Battle emotes ===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
Balmond Bioroid Here.png|'''Bioroid Here'''<br>Battle Emote - 04/2022 [[StarLight]] Special
Balmond This is bad.png|'''This is bad'''<br>Esports Emote. Can be purchased in the Shop.
</gallery>

== Trivia ==
[[File:Bloodthirst.png|thumb|"Bloodthirst" skill icon.]]
*The old Balmond design can still be seen in his "Bloodthirst" skill icon.
*The previous iteration of Balmond was probably inspired by the character [https://dota.fandom.com/wiki/Axe Axe] from ''Dota: Allstars'', which itself is based on [https://wowpedia.fandom.com/wiki/Grommash_Hellscream Grommash Hellscream].
*In his old lore, he went from being {{hi|Alice}}'s slave to being a mutually exploited ally in the new lore.
