...
*Spacetime Swordmaster (formerly)
|born           = Duan Meng or Duanmeng<br>Unnamed village, [[Cadia Riverlands]]
|origin         = [[Laboratory 1718]], [[Baker Island]] (as Saber)
|age            = 24<ref name=AgeDiscord>According to a Dev-To-Players on the Official Discord Server regarding Saber's age and other details about his story<br>[https://discord.com/channels/342452785658331137/602741774716370959/1399408301988642941 Link to the Discord message]
<gallery>
Sabers Expanded Lore in official discord.png
</gallery></ref>
|species        = Cyborg
|birthday       = {{birthday|12|31}}<ref name="CNProfile">Official Profile from MLBB CN</ref>
|gender         = Male
|title          = 
|occupation     = *Assassin
|affiliation    = *[[Laboratory 1718]] (hostile)
*Tianyin Swordmaster Sect (formerly)
|fighting_style = Kendo
|weapons        = *Space and time swords , The blades of the Cosmic Rift
|abilities      = 
|religion       = 
|battles_fought = 
|height         = 
...
|likes          = 
|dislikes       = 
|relationships  = *Longma (master)
*Zhixu (rival)
*{{hi|Alpha}}, [[Octavius]] (enemies)
*{{Hi|Angela}} (ally)
*{{hi|Zilong}} (former sectmate)
|en_va          = Con Eyre (2017&ndash;2020)<ref name="coneyre">[https://www.coneyre.com/#/mobile-legends/:~:text=Throughout%20the%20Mobile%20Legends%20universe%20I%20voice%20a%20number%20of%20characters%20including%20Balmond%2C%20Saber%2C%20Alpha%2C%20Gord%2C%20Jawhead%2C%20Gusion%2C%20Belerick%2C%20%20Leomord%2C%20Thamuz%2C%20Argus%20and%20Terizla.%20I%20also%20do%20a%20number%20of%20short%20origin%20stories%20on%20certain%20characters. Con Eyre Voice Over Actor]<br>''„Throughout the Mobile Legends universe I voice a number of characters including Balmond, Saber, Alpha, Gord, Jawhead, Gusion, Belerick, Leomord, Thamuz, Argus and Terizla. I also do a number of short origin stories on certain characters.“''</ref>
Evan Louie{{cite}} (2020&ndash;)
|id_va          = Kamal Nasuti{{cite}}
|ja_va          = [[wikipedia:Kenji Roa|Roa Kenji (ロア健治)]]<ref name="In-game credit">In-game credit</ref>
|tl_va          =
|ar_va          = Moataz El Shazli{{cite}}
|pt_va          = Fábio Campos{{cite}}
|ru_va          = Hoshabaev Alexander{{cite}}
|tk_va          = Yavuz Gürkan{{cite}}
|es_va          = Miguel Angel Leal{{cite}}
|zh_va          = Bloomberg (彭博){{cite}}
}}
{{Quote|A swordsman in pursuit of invincibility, used by Laboratory 1718}}
Once called Duan Meng and obsessed with kendo, Saber came to [[Laboratory 1718]] to transform himself in order to pursue perfection, but his memory was erased and he was turned into a killing machine. The torture of his memories drove him to finally destroy the laboratory and set off searching for the past.
===Lore===
...
|image-legend   = Enemy's Bane
|description    = Saber's attacks reduce enemies' [[Physical Defense]] by 3&ndash;8 for 5 seconds on hit. This effect stacks up to 5 times.
|level-scaling=[[Physical Defense Reduction]]: 3 / 3 / 3 / 4 / 4 / 4 / 5 / 5 / 5 / 6 / 6 / 7 / 7 / 7 / 8
|stack-scaling=Physical Defense Reduction (level 1): 3 / 6 / 9 / 12 / 15
Physical Defense Reduction (level 8): 5 / 10 / 15 / 20 / 25
Physical Defense Reduction (level 15): 8 / 16 / 24 / 32 / 40
|term-1         = Physical Defense
|notes          = *"Attacks" that reduces physical defense only refer to Saber's basic attack and skill damage.
*Defense reduction can only be applied to non-minion enemies.
*The defense reduction is immediately applied to the first attack dealt.
*Unlike most level-based scaling, Saber's passive value does not depend on a formula. It will simply increase by 1 when a certain level is reached.
}}
...
|notes          = *When attacking a turret, Saber will still shoot a sword toward it and reduce Charge's cooldown, but will not deal damage to it.
*Saber can cast Orbiting Swords during dashes and in motion using joystick. ([[Patch Notes 1.6.84]]). In order to cast Orbiting Swords during {{ai|Triple Sweep}}, input must be quickly made during the initial dash. Saber will be rendered unable to cast Orbiting Swords after knocking up an enemy.
*The shooting swords' extra damage will prioritize targets in this order: Visible main target → Visible enemy heroes → Invisible main target. Some situations such as using {{ai|Triple Sweep}} on a target inside bush while Saber himself is outside of the bush (therefore making the main target [[concealed]]) and an enemy appears on the screen, will cause the shooting swords to home in on latter enemy instead. This interaction will even prioritize targeting visible minions over invisible main target.
}}
...
|name           = Charge
|cooldown       = 7.0
|mana-cost      = 70 / 65 / 60 / 55 / 50 / 45
|skill-effect-1 = Blink
|skill-effect-2 = AOE
|image-legend   = Charge
|description    = Saber [[dashes]] in the target direction, dealing {{scale|base=75-150|extra-pa=50|pd}} to enemies along the way while enhancing his next [[Basic Attack]]. Saber can dash to the target, and his enhanced Basic Attack deals {{scale|base=75-150|total-pa=120|pd}} and [[slows]] the target by 60% for 1 second.
|properties=Base Damage: 75 / 90 / 105 / 120 / 135 / 150
Enhanced Damage: 75 / 90 / 105 / 120 / 135 / 150
|term-1         = Blink
|term-2         = Physical Damage Skill
|term-3         = Physical Basic Attack
|notes=*Despite its name, "Charge" is technically a blink skill, therefore it can go through obstacles.
*The enhanced basic attack has a range of 2.5.
*There is a bug where, if the enhanced basic attack is triggered but somehow fails to land, the enhanced basic attack will still be consumed.
}}
===Ultimate===
{{Ability
|variations-1   = Legend
...
|term-3          = Blink
|notes=
*If Saber is killed during Triple Sweep's duration, the enemy will stay [[airborne]], but no further damage will be dealt.
*Saber's and the enemy target's camera height increases within the skill's duration.
*If Triple Sweep fails to land due to certain circumstances (such as [[invincibility]] or enemy's death), Saber will abruptly stop executing the skill and the skill will start on cooldown.
*After Saber knocks up an enemy, Triple Sweep can only be interrupted by [[suppressed]]. However, the initial dash Saber makes is considered a [[blink]], therefore rendering it vulnerable to be cancelled by [[knockback]] and [[airborne]] if Saber was hit before he could reach the enemy. Due to this, Triple Sweep is also unusable when affected by [[root]] and [[immobilize]].
**As the blink is considered a separate phase, activating [[Winter Crown]] during it will halt Saber in place and cancel the knock-up part entirely.
*Saber can cast [[Retribution]] during the duration of this skill.
}}

==Gallery==
===Artwork===
<gallery captionalign="center" spacing="small" hideaddbutton="true">
Saber (Wandering Sword).jpg|Wandering Sword
Saber (Golden Flash).jpg|Golden Flash
Saber (Force Warrior).jpg|Force Warrior
Saber (Codename - Storm).jpg|Codename - Storm
Saber (Fullmetal Ronin).png|Fullmetal ronin
Saber (S.A.B.E.R. Regulator).jpg|S.A.B.E.R. Regulator
Saber (Onimaru).jpg|Onimaru
Saber (Silver Edge).jpg|Silver Edge
Saber (Iron Hound).jpg|Iron Hound
</gallery>
;Painted skins
<gallery captionalign="center" spacing="small">
Saber (Steel of Hound).jpg|Steel of Hound
</gallery>
===Avatar icons===
<gallery captionalign="center" spacing="small" widths="100" bordercolor="transparent" hideaddbutton="true">
Hero031-icon.png|Wandering Sword
Hero032-icon.png|Golden Flash
Hero033-icon.png|Force Warrior
Hero034-icon.png|Codename - Storm
Hero035-icon.png|Fullmetal ronin
Hero036-icon.png|S.A.B.E.R. Regulator
Hero037-icon.png|Onimaru
Hero038-icon.png|Silver Edge
Hero039-icon.png|Iron Hound
</gallery>
;Painted skins
<gallery captionalign="center" spacing="small" widths="100" bordercolor="transparent" hideaddbutton="true">
Hero60391-icon.png|Steel of Hound
</gallery>

==Videos==
<gallery captionalign="center" spacing="small">
Project NEXT Hero Revamp Project NEXT Express 1 Mobile Legends Bang Bang|Revamped {{hi|Saber}} Hero Spotlight on [[Project NEXT|Project NEXT Express]]
</gallery>

==Trivia==
*In the early release of the game, there was a quote about Saber's favorite sports being baseball.
*His "Force Warrior" skin is the first [[Starlight Member|Starlight Membership]] Skin. Also his "Iron Hound" skin is the first Skin of Revamped Starlight Membership.
*He equips with two swords along with {{hi|Fanny}}, {{hi|Lapu-Lapu}}, {{hi|Karina}}, and {{hi|Martis}}.
*On early version, he has a helmet with the letter H which represents Professor '''H'''enry.
*His "Codename Storm" skin is the first Legend Skin.
*He is the first Assassin in the game.
*In the old lore, Saber and Alpha were like brothers who escaped from the lab with Beta, who was killed.
