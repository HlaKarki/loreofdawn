...
Little lance.jpg|11 years old
</gallery>
| full_name      = Lancelot of House Baroque
| chinese_name   = 兰斯洛特 (lánsīluòtè)
| alias          = *Blade of Roses
*Romantic knight of [[Castle Gorge]]
| birthday       = {{birthday|3|7}}<ref name="LancelotCNProfile">[https://weibo.com/7711876938/P1WLuzhYi Official profile from Weibo]
<gallery>
Profile CN Lancelot.jpg
</gallery>
</ref>
| born           = Castle Gorge, [[Moniyan Empire]]
| origin         = 
| age            = 22<ref name="LancelotCNProfile"/>
| species        = Human
| gender         = Male
...
| fighting_style = 
| weapons        = Sword
| abilities      = *Magic-infused swordsmanship
| religion       = 
| nationality    = Moniyan
| battles_fought = 
| height         = 
...
{{quote|Prodigal son and genius swordsman of House Baroque.}}
...
=== Lore ===
[[File:Lancelot lore.png|center|512px]]
...
|energy-cost     = 
|quote           = 
|description     = Each time Lancelot <nowiki>[</nowiki>[[Blink and charge|blinks or]]<nowiki>]</nowiki> charges, his damage is increased by 7.5% for 4 seconds, up to 30%.
|term-1          = Blink
|term-2          = 
|term-3          = 
|ls-1            = 
...
|ls-4            = 
|ls-5            = 
|ss-1            = Damage Increase: {7.5%, 15%, 22.5%, 30%}
|ss-2            = 
|ss-3            = 
|calc            = 
|notes           = *Additional damage dealt includes all types of damage from any sources.
*Aside from Lancelot's own abilities, he also gains 1 stack of {{ai|Soul Cutter}} caused by the [[Cyclone Eye]]'s dash, {{ai|Flicker}}, and {{hi|Mathilda}}'s {{ai|Guiding Wind}}.
|bugs            = 
}}
=== Skill 1 ===
{{Ability
...
|energy-cost     = 
|quote           = 
|description     = Lancelot [[Blink|charges in a designated direction]], dealing {{scale|base=100-250|total-pa=50|pd}} to enemies along the way and applying a {{AVC1|Sword Mark|mark}} to the first unmarked enemy hit. The Sword Mark lasts 5 seconds.<br>If Lancelot successfully applies a {{AVC1|Sword Mark|mark}} to an enemy, the cooldown of this will reset.
|term-1          = Blink
...
|ss-3            = 
|calc            = 
|notes           =*{{ai|Puncture}} first applies {{b|Sword Mark}}, then the damage. Meaning if an unmarked enemy dies from {{ai|Puncture}}, the cooldown is reset. 
|bugs            = 
}}
=== Skill 2 ===
{{Ability
...
|skill-type-2    = 
|skill-type-3    = 
|cooldown        = 10 / 9.4 / 8.8 / 8.2 / 7.6 / 7.0
|recharging-time = 
|mana-cost       = 120 / 112 / 104 / 96 / 88 / 80
|energy-cost     = 
|quote           = 
|description     = Lancelot strikes in the target direction 3 times, each time dealing {{scale|base=225-400|extra-pa=100|pd}} to enemies hit (damage reduced [to {{B|30%|pd}}] when multiple enemies are hit). He's [[untargetable]] and [[invincible]] during this process.<sup>[''how long?'']</sup> Enemies in the center of the area will take all 3 hits and are [[slowed]] by 20% for 0.5 seconds. The slow effect can stack.<br>This skill only benefits from 50% of Lancelot's [[Spell Vamp]].
...
|ls-4            = 
|ls-5            = 
|ss-1            = Decay Ratio: {100%, 70%, 70%}
|ss-2            = Slow Effect: {20%, 40%, 60%}
|ss-3            = 
|calc            = 
|notes           = 
|bugs            = *Damage decay have, in certain cases, been left out on [[damage calculation]]. 
}}
=== Ultimate ===
{{Ability
|variations-1    = Kishin Densetsu
...
|skill-type-2    = Blink
|skill-type-3    = 
|cooldown        = 27.0 / 24.0 / 21.0
|recharging-time = 
|mana-cost       = 100 / 125 / 150
|energy-cost     = 
|quote           = I become one with the sword.
|description     = After a short period<sup>[''how long?'']</sup> of charging, Lancelot [[Blink|performs an executioner's strike in the target direction]], dealing {{scale|base=350|total-pa=170|pd}}. He is [[invincible]] throughout the process.<sup>[''how long?'']</sup>
|ls-1            = 
|ls-2            = 
|ls-3            = 
|ls-4            = 
...
Lancelot (Blade of Roses).jpg|Blade of Roses
Lancelot (Masked Knight).jpg|Masked Knight
Lancelot (Christmas Carnival).jpg|Christmas Carnival
Lancelot (Royal Matador).jpg|Royal Matador
Lancelot (Dark Earl).jpg|Dark Earl
Lancelot (Pisces).jpg|Pisces
Lancelot (Floral Knight).jpg|Floral Knight
Lancelot (Swordmaster).jpg|Swordmaster
Lancelot (Bren Esports).jpg|Bren Esports
Lancelot (Empyrean Flame).jpg|Empyrean Flame
Lancelot (Marques of Blades).jpg|Marques of Blades
Lancelot (Guardian of the Shrine).jpg|Guardian of the Shrine
</gallery>

=== Avatar icons ===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
Hero471-icon.png|Blade of Roses
Hero472-icon.png|Masked Knight
Hero473-icon.png|Christmas Carnival
Hero474-icon.png|Royal Matador
Hero475-icon.png|Dark Earl
Hero476-icon.png|Pisces
Hero477-icon.png|Floral Knight
Hero478-icon.png|Swordmaster
Hero479-icon.png|Bren Esports
Hero104710-icon.png|Empyrean Flame
Hero104711-icon.png|Marques of Blades
Hero104712-icon.png|Guardian of the Shrine
</gallery>

===Battle emote===
<gallery bordercolor="transparent" captionalign="center" spacing="small" widths="100" hideaddbutton="true">
Golden Flash (Battle Emote).png|'''Golden Flash'''<br>Obtain via Legend of the Sword Event
M2 Champion Battle Emote.png|'''M2 Champion Battle Emote'''<br>Limited-time reward from M2 Champion Exclusive Bundle
Battle Emote - Flawless.png|'''Flawless'''<br>Obtained via the [[Kishin Densetsu]] events.
</gallery>
