...
- English VA: Marc Elmer (2020)
- Japanese VA: Fukuda Yuimi (福田 結巳)
...
Each time Lancelot blinks or charges, his damage is increased by 7.5% for 4 seconds, up to 30% (7.5%, 15%, 22.5%, 30%).

- Additional damage dealt includes all types of damage from any sources.
- Aside from Lancelot's own abilities, he also gains 1 stack caused by certain dashes and effects.

## Puncture

Lancelot charges in a designated direction, dealing damage to enemies along the way and applying a Sword Mark to the first unmarked enemy hit. The Sword Mark lasts 5 seconds. If Lancelot successfully applies a Sword Mark to an enemy, the cooldown of this skill will reset.

- Skill type: Physical Skill, Blink, AoE.
- Cooldown (per level): 14.0 / 13.6 / 13.2 / 12.8 / 12.4 / 12.0 seconds.
- Mana cost (per level): 50 / 48 / 46 / 44 / 42 / 40.
- Base Damage (per level): 100 / 130 / 160 / 190 / 220 / 250.

Notes:
- first applies, then the damage. Meaning if an unmarked enemy dies from Puncture, the cooldown is reset.

## Thorned Rose

Lancelot strikes in the target direction 3 times, each time dealing physical damage to enemies hit (damage reduced when multiple enemies are hit). He's untargetable and invincible during this process (how long?). Enemies in the center of the area will take all 3 hits and are slowed by 20% for 0.5 seconds. The slow effect can stack. This skill only benefits from 50% of Lancelot's Spell Vamp.

- Skill type: Physical Skill, AoE, Slow.
- Cooldown (per level): 10 / 9.4 / 8.8 / 8.2 / 7.6 / 7.0 seconds.
- Mana cost (per level): 120 / 112 / 104 / 96 / 88 / 80.
- Base Damage (per level): 225-400 plus extra physical attack scaling.

Notes:
- Decay Ratio: (100%, 70%, 70%).
- Slow Effect values: (20%, 40%, 60%).
- Damage decay has, in certain cases, been left out in damage calculation.

## Phantom Execution

After a short period of charging (how long?), Lancelot performs an executioner's strike in the target direction, dealing physical damage. He is invincible throughout the process (how long?).

- Skill type: Physical Skill, Blink, Burst.
- Cooldown (per level): 27.0 / 24.0 / 21.0 seconds.
- Mana cost (per level): 100 / 125 / 150.
