...
- Affiliation: Moniyan Empire; House Baroque
- Weapons: Sword
- Abilities: Magic-infused swordsmanship
- Nationality: Moniyan
- Relationships: Duke Baroque II (father); Unnamed mother; (younger sister); (lover)
- Voice Actors: English: Marc Elmer (2020); Japanese: Fukuda Yuimi (福田 結巳); TL: Irfan Setiawan
...
Even though he'd lost the financial support from his father, Lancelot made a living out of his excellent swordsmanship by attending contests across the country. He never lost a battle on the arena and would be uttering his family motto:

> "Thorns remain should petals fall"

while signing his initials onto his opponent's body with his sword.
...
After driving away the drunken hooligans, Lancelot stumbled out of the tavern knowing that his injury might be fatal, and he refused to collapse in a tavern so gracelessly. Covered in blood, he dragged himself towards a tree and fell on the ground. Before he lost his consciousness, he saw a pair of glowing swan wings—maybe it was the angels coming to welcome his soul into heaven?

Lancelot woke up to find he was lying on a bed with bandages wrapped around his chest, an elegant young maiden smiling wearily at him. The swan wings he saw before he fainted were actually the swan crown on the girl's head. Lancelot thought that he'd never seen a face so beautiful and innocent, but he could barely speak before falling into a sound sleep again.
...
The agitated Lancelot had to ask the maid that came to deliver food to him about what happened to Odette. The girl replied with a cheerful smile:

> "Someone proposed to our princess. She'd been busy with it…"
...
- Damage Increase per threshold: 7.5%, 15%, 22.5%, 30%.

Notes:

- Additional damage dealt includes all types of damage from any sources.
- Aside from Lancelot's own abilities, he also gains 1 stack of caused by the Cyclone Eye's dash, and other sources referenced in game.

## Puncture

- Skill type: Physical Skill; Blink; AoE.
- Cooldown: 14.0 / 13.6 / 13.2 / 12.8 / 12.4 / 12.0 seconds (per level).
- Mana Cost: 50 / 48 / 46 / 44 / 42 / 40 (per level).

Description:

Lancelot charges in a designated direction, dealing physical damage based on level and attack to enemies along the way and applying a Sword Mark to the first unmarked enemy hit. The Sword Mark lasts 5 seconds. If Lancelot successfully applies a Sword Mark to an enemy, the cooldown of this skill will reset.

- Base Damage by level: 100 / 130 / 160 / 190 / 220 / 250.

Notes:

- The mark is applied before the damage. Meaning if an unmarked enemy dies from the applied damage, the cooldown is reset.

## Thorned Rose

- Skill type: Physical Skill; AoE; Slow.
- Cooldown: 10 / 9.4 / 8.8 / 8.2 / 7.6 / 7.0 seconds (per level).
- Mana Cost: 120 / 112 / 104 / 96 / 88 / 80 (per level).
- Base Damage: 225-400 (scales with level and stats).

Description:

Lancelot strikes in the target direction 3 times, each time dealing physical damage to enemies hit (damage reduced when multiple enemies are hit). He is untargetable and invincible during this process (duration unknown). Enemies in the center of the area will take all 3 hits and are slowed by 20% for 0.5 seconds. The slow effect can stack. This skill only benefits from 50% of Lancelot's Spell Vamp.

- Decay Ratio per hit: 100%, 70%, 70%.
- Slow Effect examples: 20%, 40%, 60% (per available scaling).

Bugs:

- Damage decay has, in certain cases, been left out in damage calculation.

## Phantom Execution

- Skill type: Physical Skill; Blink; Burst.
- Cooldown: 27.0 / 24.0 / 21.0 seconds (per level).
- Mana Cost: 100 / 125 / 150 (per level).
- Base Damage: 350 plus additional physical attack scaling (example total physical attack scaling: 170).
...
After a short period (duration unknown) of charging, Lancelot performs an executioner's strike in the target direction, dealing physical damage based on level and attack. He is invincible throughout the process (duration unknown).
