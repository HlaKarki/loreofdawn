...
- Voice Actors: en: Marc Elmer (2020); ja: Fukuda Yuimi (福田 結巳); tl: Irfan Setiawan
...
The agitated Lancelot had to ask the maid that came to deliver food to him about what happened to Odette.

The girl replied with a cheerful smile:

> "Someone proposed to our princess."

> "She'd been busy with it..."
...
- Damage Increase (per stack): 7.5%, 15%, 22.5%, 30%.

- Additional damage dealt includes all types of damage from any sources.

- Aside from Lancelot's own abilities, he also gains 1 stack of caused by the Cyclone Eye's dash,, and 's.
...
- Base Damage: 100 / 130 / 160 / 190 / 220 / 250 (physical)

Description:
Lancelot charges in a designated direction, dealing scaling physical damage to enemies along the way and applying a Sword Mark to the first unmarked enemy hit. The Sword Mark lasts 5 seconds. If Lancelot successfully applies a Sword Mark to an enemy, the cooldown of this skill will reset.

Notes:
- When executed, the Sword Mark is first applied, then the damage is dealt. Meaning if an unmarked enemy dies from the mark application, the cooldown is reset.
- Damage scales with level and physical attack.

## Thorned Rose

- Skill Type: Physical Skill; AoE; Slow
- Cooldown: 10 / 9.4 / 8.8 / 8.2 / 7.6 / 7.0 seconds
- Mana Cost: 120 / 112 / 104 / 96 / 88 / 80
- Base Damage: 225 - 400 (scaling) with Extra Physical Attack: 100
- Damage decay: 100% / 70% / 70% (decay ratio)
- Slow Effect (center hits): 20% for 0.5s (values: 20%, 40%, 60% per level)

Description:
Lancelot strikes in the target direction 3 times, each time dealing scaling physical damage to enemies hit (damage reduced when multiple enemies are hit; exact reduction not specified). He's untargetable and invincible during this process (unspecified duration). Enemies in the center of the area will take all 3 hits and are slowed by 20% for 0.5 seconds. The slow effect can stack. This skill only benefits from 50% of Lancelot's Spell Vamp.

Notes:
- Damage decay has, in certain cases, been left out on damage calculation.

## Phantom Execution

- Skill Type: Physical Skill; Blink; Burst
- Cooldown: 27.0 / 24.0 / 21.0 seconds
- Mana Cost: 100 / 125 / 150
- Base Damage: 350 (plus Total Physical Attack scaling ~170)

> "I become one with the sword."

Description:
After a short period (unspecified), Lancelot performs an executioner's strike in the target direction, dealing scaling physical damage. He is invincible and untargetable throughout the process (unspecified duration).
...
- Related heroes / notable mentions: Odette; Gatotkaca; Kadita; Leomord; Guinevere.
