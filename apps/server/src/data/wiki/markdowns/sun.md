...
Perhaps this creature could reveal the answers to the questions which had eluded him.
...
- Sun recovers equal to 50% of the damage dealt by a Doppelganger each time a Doppelganger deals damage.

- Physical Defense Reduction scaling by stacks: 4%/8%/12%/16%/20%/24%/28%/32%/36%/40%.

- Note: Sun can only receive HP through his doppelgangers' basic attacks.
...
- Attributes Inherited by Doppelganger per level: 40%/43%/46%/49%/52%/55%.
...
- Note: The projectiles will instead target the conjured doppelganger after Sun conceals himself.
...
- This counts as Basic Attack damage and can trigger Attack Effects but cannot Crit.

- Base damage per level: 170/200/230/260/290/320.

- Mana cost per level: 40/45/50/55/60/65.

- Scaling: total physical attack contribution around 40 (value provided as total physical attack scaling).

## Clone Techniques

- Sun summons a Doppelganger that lasts 12 seconds and inherits 70% to 100% of his attributes and a portion of his Attack Effects.

- The Doppelganger takes increased damage.

- Attributes Inherited per level: 70%/85%/100%.

- Cooldown per level: 36.0/32.0/28.0.
