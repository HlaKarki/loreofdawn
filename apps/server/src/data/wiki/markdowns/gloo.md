...
## Stats
- Magic Defense: 15 (Lv.1) → 71 (Lv.15)
- Physical Defense: 18 (Lv.1) → 107 (Lv.15)
...
- Sticky (linked ability)
- Sticky (linked ability)

Stick, Stick
- Effects: Slow, BUFF
- Description: Enemies gain a stack each time they're hit by Gloo's skills, decreasing their Movement Speed by 4% for 6 seconds. Stacks up to 5. Each stack on an enemy reduces their damage dealt to Gloo by 4%.
- Terms: Damage Reduction, Movement Speed

### Skill 1

Scales / costs and other modifiers:
- Base MP: 80 (total MP 80)
- Damage scale: 300–450 (extra HP scaling 12)
- Other references: Max HP
- Level scaling entries present (80 to 80 6; 300 to 450 6)

Slam, Slam
- Effects: AOE, CC
- Description: Gloo reaches out and slams the ground, dealing [value missing] to the enemy. At the final, a [missing term] is left behind that explodes after 3 seconds to deal [value missing] to nearby enemies and immobilize them for 1 second. If Gloo touches the [missing term], it will explode immediately, reset the skill's cooldown, and heal Gloo for 2.5%–5% of [missing stat] if the explosion hits an enemy (doubled if hits an enemy hero).
- Spellvamp ratio: 50%
- Cooldown: 10.0 / 9.2 / 8.4 / 7.6 / 6.8 / 6.0
- Mana cost: 25 / 30 / 35 / 40 / 45 / 50
- Level scaling notes: HP Regen: 2.5% / 3% / 3.5% / 4% / 4.5% / 5%

### Skill 2

Scales / costs and other modifiers:
- Base MP: 100–200 (total MP 80)
- Alternate scale: base 80 (total MP 15)
- Level scaling entry: 100 to 200 6

Spread, Spread
- Effects: CC, AOE
- Description: Gloo splits into Goos, dealing [value missing] to enemies in a fan-shaped area and immobilizing them for 0.5 seconds. While split, Gloo gains 10% Movement Speed and deals [value missing] every 0.25 seconds to enemies it touches, lasting 4 seconds. If this skill hits a Goo, Gloo will charge over to merge with it, dragging enemies in its path in the same direction for a distance.
- Spellvamp ratio: 50%
...
Scales / costs and other modifiers:
- References: Max HP, Basic Attacks
- Base MP scaling: 30–90 (total MP 50, extra HP 6)
- Level scaling entry: 30 to 90 3
- Additional tags: Flicker, Arrival, Recall, Wind of Nature, Winter Crown

Grab, Grab
- Effects: Attach, Heal
> "One is all. (All is one.)"
- Description: Unlocked when any enemy hero has full Sticky stacks. Gloo attaches itself to the target enemy hero for up to 9 seconds, recovering 25%–30% of its [missing stat]. For the duration, its [missing term] are converted to deal [missing value], and it transfers 80% of the damage it receives (excluding damage from turrets) to its host. If the target dies while attached, this skill's cooldown is reduced to 5 seconds.
- Spellvamp ratio: 50%
- Cooldown: 50.0
- Mana cost: 150
- Level scaling notes: Attached Regen: 25% / 27.5% / 30%
...
- Several specific mobility interactions are listed as disabled/enabled in original data (placeholders present).

## Trivia
- The name Gloo is a pun of the word "Glue", referencing his ability to stick to an enemy hero.
- Gloo is the second hero who can attach to another hero and use skills upon attaching, the first being [name missing].
