...
- Origin: Eruditio, Agelta Drylands (Eruditio; Agelta Drylands)
- Species: Human
- Gender: Male
- Occupation:
  - Eruditio scholar
...
- Affiliation:
  - Eruditio
  - The Abyss (enemies) (The Abyss)
- Weapons: Time Machine
- Abilities: Time traveling; Teleportation; Summons Reverse-Clone (See: Ultimate)
- Traits: Steady, Intelligent
- Relationships: (companions / enemies — unspecified)
- Voice actor (ID): Agathon Hafi
- Japanese voice actor: Ryosuke Asano (浅野 良介)
...
"The Land of Dawn was born from the void, and to the void it shall return." (Land of Dawn)

Over the past few centuries, the seal that holds back the Lord of the Abyss had been waning in power, while the cracks in the Abyss grew constantly. (Abyss) The Lantis Mountains could no longer withstand the crippling corruption of the Abyss, and humanity was forced further and further north in order to survive. (Lantis Mountains)

With this, the Lord of the Abyss fully awakened and his demon forces reached the walls of Moniyan’s cities. (Moniyan) Humanity began to understand that their apocalypse was nigh. But then, a ray of pure light appeared, and provided Moniyan its protection.
...
The powers of light and darkness sprang into action, and the Endless War descended upon the lands once more. (Endless War)
...
As he grew up in Eruditio, Natan proved himself naturally gifted. (Eruditio) Whether in science or magic, he achieved attainments unimaginable by any normal man.
...
The Abyss had by this point accrued even more Twilight Orbs. (Twilight Orbs) If every last one fell into the hands of the Lord of the Abyss, it would spell the return of pure chaos to the world, as all light faded into darkness. Natan and the others were running out of time. They took command of all those in both Eruditio and Magic Academy, striving with all their might to find a way to turn things around and avoid a certain descent into chaos. (Ursula Academy of Magic)
...
Everyone knew all too well that this was to be humanity’s last stand. More than this, they all knew very well how it would likely end. Though failure hung heavy over their heads, that unrelenting spark of hope continued to burn on in their hearts. Such hope in the face of defeat is what makes mankind, and they placed it entirely upon Natan.

Natan took in the bleak scene before him, and started up the machine with resolution in his eyes. There had been no time to test it, but their theories suggested it could support a single person and transport them through time and space. This was only a theory, however, meaning there’d be no way to guarantee his safety.
...
- Mechanic summary:
  - Natan gains a stack of Entanglement each time he or his Reverse-Clone hits an enemy with a skill (up to 6 stacks).
  - Each stack lasts 2.5 seconds and grants extra Attack Speed and Movement Speed.
  - Natan's projectiles return to him after reaching maximum range, dealing extra damage on the way back (inherits 65% of Natan's attack effects). Hitting an enemy refreshes Entanglement's duration.
- Extra ATK SPD formula (per Entanglement stack):
  - extra ATK SPD = [(0.0053571 × hero lv.) + 0.069643] × no. of Entanglement stacks
- Listed values:
  - Extra Attack Speed per stack (example progression): 7.5% → up to 15% … (detailed progression included in original data)
  - Extra Movement Speed: {7.5%, 15%, 22.5%, 30%, 37.5%, 45%}
- Notes:
  - Natan only benefits 80% of his Physical and Magic Lifesteal.
  - Damage is decreased by (unspecified) for -Unique Passive Devour when equipped.
  - Projectiles inherit 65% of attack effects (see description).

### Skill 1 — Superposition
> "There is no 'collapse'."

- Type: Magic Skill (Burst)
- Base Damage: 225 / 260 / 295 / 330 / 365 / 400
- Scaling: total-pa 100; total-mp 130
- Cooldown: 8.0 / 7.6 / 7.2 / 6.8 / 6.4 / 6.0
- Mana cost: 50 / 55 / 60 / 65 / 70 / 75
- Description: Natan shoots a dense mass of energy, dealing damage to enemies along its path.
- Notes:
...
- Extra Damage (base): 30 / 35 / 40 / 45 / 50 / 55
- Secondary base listed: 30-55 (scale: total-pa 10; total-mp 13)
- Cooldown: 12.0 / 11.6 / 11.2 / 10.8 / 10.4 / 10.0
- Mana cost: 60 / 65 / 70 / 75 / 80 / 85
- Description: Natan launches a Gravitational Attractor which carries enemies on contact along the path and deals damage. The attractor explodes upon reaching the end, knocking back nearby enemies, (stunning/CC) for 0.1 second, and dealing extra damage to them.
- Notes:
  - Only benefits 50% of Natan's Physical and Magic Lifesteal.
  - Backswing removed.
  - Bug: Explosion of attractor cannot trigger and/or (unspecified) despite the stun effect.

### Ultimate — Entropy? (Reverse-Clone)
...
- Mana cost: 100 / 50 / 0
- Description:
  - Natan summons a Reverse-Clone at a target location 6 units away that lasts 10 s.
  - The clone inherits 35% / 37.5% / 40% of his attack attributes (and 35% of Natan's attack effects), and it will copy his moves and attacks in reverse.
  - Use Again: Natan switches places with the Reverse-Clone. (Use Again cooldown: 12 seconds.)
  - Each cast reduces other skills' remaining cooldowns by 50%.
  - The Reverse-Clone will disappear if Natan is too far away.
- Attributes inherit: 35% / 37.5% / 40%
- Notes:
  - Cooldown starts after ending the ultimate.
  - The reverse-clone starts 6 units away, facing the same angle. The link turns red at 10 units and breaks at 13 units.
  - Foreswing time reduced by 50%.
  - Sub-ability of the ultimate is not affected by cooldown reduction.
  - Attack effects inheritance adjusted from 70% → 35%.
  - Some text in descriptions had missing terms in original data (kept as-is).

---

## Trivia
- All of Natan's skills are based on real-life physics concepts.
- His passive, Theory of Everything, references the (unsolved) physics problem of finding a single theory to explain every aspect of physics. (Theory of everything)
- His Skill 1 (Superposition) and Skill 2 (Interference) refer to wave phenomena. (Superposition principle; Wave interference)
- His ultimate, Entropy, references entropy as a measure of "randomness" in a system. (Entropy)
- According to Natan's timeline, the Abyss are about to win the Endless War on the Land of Dawn and are about to conquer the only-standing Eruditio. (Endless War; Eruditio)
