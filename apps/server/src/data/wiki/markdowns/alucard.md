...
- Alucard is a name popularized by the Castlevania video game franchise with the character with the same name.
- When MLBB was released as Mobile Legends: 5v5 MOBA in mid-2016, Alucard was named Dante, whose name is based on the video game character with the same name, and appearance from Nero of the Devil May Cry video game franchise.
- His Legend Skin "Obsidian Blade" skill icons is the same as his old skill icon before the revamp.
- His skin "Child of the Fall" is based on Sephiroth but his sword is based on Buster Sword from Final Fantasy.
- His Lightborn skin has armor and a greatsword similar to Saber from Fate/Stay Night.
