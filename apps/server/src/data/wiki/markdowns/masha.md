# Masha
Leader of the Sami/Sarmi tribe  
...
- Description: Masha gains Power of the Wild which causes her to deal extra Physical Damage equal to % of the target's (up to 60 against Creeps and doesn't take effect on Turrets or Base). Masha spends 24% HP to increase her Movement Speed by 60% for 1.5 seconds. She also increases the extra Physical Damage from Power of the Wild by % of the target's and gains 50% extra Attack Speed for her next two.
- Properties:
  - Bonus Damage: 2 / 2.4 / 2.8 / 3.2 / 3.6 / 4
  - Max Damage to Creeps: 60 / 72 / 84 / 96 / 108 / 120
- Terms: Physical Basic Attack / Attack Effect
- Notes: The extra damage does not critically strike.

Scaling / mechanics details (from templates):
- Passive (Basic Attack): base 1, extra-pa 0.5 (scales with max HP)
- Active: base 2–4, extra-pa 1 (scales with max HP)
- Basic Attack text entries included as well.
...
- Description: Masha spends 24% HP to roar at enemies, dealing damage and reducing their Attack Speed by 50% for 2 seconds.
- Properties: Base Damage: 200 / 220 / 240 / 260 / 280 / 300
- Terms: Physical Damage Skill / Movement Speed
- Notes: HP can only be consumed down to 1 on her final HP bar.

Scaling detail:
- Base damage listed as 200–300 with total-pa 100 (physical damage scaling).

---

### Ultimate — Thunderclap
- Type: Burst / Mobility
- Cooldown: 40.0 / 35.0 / 40.0
- Description: Masha spends 34% HP to lunge at an enemy hero (immune to control effects during the lunge), dealing damage, slowing them by 25% for 2 seconds, and knocking back nearby enemies. The cooldown of this skill will be reset each time Masha loses an HP bar.
- Properties: Base Damage: 200 / 350 / 500
- Terms: Displacement / Blink
- Notes: HP can only be consumed down to 1 on her final HP bar.

Scaling detail:
- Base damage listed as 200–500 with total-pa 200 (physical damage scaling).

---

### Other — Life Recovery
- Related Skill(s): Wild Power
- Life Recovery
  - Type: Heal / Invincible
  - Cooldown: 0.0
  - Energy Cost: 50
  - Description: Masha gains Energy when dealing damage to enemies and extra Energy when dealing damage with Wild Power. After leaving combat for 3 seconds, Masha can activate this skill to spend half a full bar of Energy to recover a full HP bar. Masha is invincible while casting this skill.
  - Notes: Life Recovery is disabled unless Masha has half a full bar of energy.
...
- Additionally, she was released in time for the 10th anniversary of the said show.
