...
- Voice actor: Deguchi Mika (出口 美佳)
...
She never forgot the vow of Sarmi - to
...
Masha gains Power of the Wild which causes her to deal extra Physical Damage based on the target's max HP (up to 60 against Creeps and doesn't take effect on Turrets or Base). Masha spends 24% HP to increase her Movement Speed by 60% for 1.5 seconds. She also increases the extra Physical Damage from Power of the Wild by a scaling percentage of the target's max HP and gains 50% extra Attack Speed for her next two Basic Attacks.

- Properties:
  - Bonus Damage per level: 2 / 2.4 / 2.8 / 3.2 / 3.6 / 4 (scaling factor)
  - Max Damage to Creeps per level: 60 / 72 / 84 / 96 / 108 / 120
...
Masha spends 24% HP to roar at enemies, dealing physical damage (base damage scales per level) and reducing their Attack Speed by 50% for 2 seconds.
...
Masha gains Energy when dealing damage to enemies and extra Energy when dealing damage with Wild Power. After leaving combat for 3 seconds, Masha can activate this skill to spend half a full bar of Energy to recover a full HP bar. Masha is invincible while casting this skill.
