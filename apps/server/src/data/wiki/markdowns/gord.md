...
- After Gord hits an enemy 4 times with Basic Attacks or skills within a short period of time, the next attack on the target will deal additional magic damage based on level and magic power and slow them by 20% for 1 second. The slow effect stacks up to 2 times.
- Slow Effect per Stack: 20% / 40%
- Note: This passive is a true-damage type trigger against certain targets when specified by skills and effects.

## Mystic Projectile

- Gord conjures a Mystic Orb that bounces in the target direction and explodes on the first enemy hit, dealing scaling magic damage to enemies in the area, while stunning them and revealing their locations for 1 second.
- Spell Vamp Ratio: 50%
- Base Damage: 270 / 315 / 360 / 405 / 450 / 495 (damage scales with level and magic power)
- Cooldown: 10.0 / 9.5 / 9.0 / 8.5 / 8.0 / 7.5 seconds
- Mana Cost: 90 / 100 / 110 / 120 / 130 / 140
- Effect Type: Stun, Magic Damage Skill

## Mystic Injunction

- Gord creates an energy field in the target area, dealing magic damage every 0.3 second to enemies within (up to 13 times).
- Damage Per Hit: 55 / 65 / 75 / 85 / 95 / 105 (per tick, scales with magic power)
- Cooldown: 8.0 / 7.6 / 7.2 / 6.8 / 6.4 / 6.0 seconds
- Mana Cost: 55 / 65 / 75 / 85 / 95 / 105
- Effect Type: Area of Effect, Magic Damage Skill

## Mystic Gush

- Gord unleashes an energy beam in the target direction, dealing magic damage to enemies hit every 0.2 seconds (up to 16 times). The direction of the beam can be adjusted using the Joystick. Gord is stationary within the skill's duration.
- Spell Vamp Ratio: 50%
- Damage Per Hit: 110 / 160 / 210 (per tick, scales with magic power)
- Cooldown: 44.0 / 40.0 / 36.0 seconds
...
- Notes:
  ...
  - Gord remains stationary while channeling the beam.

# Trivia

- He has a small resemblance to Silver Surfer, both riding on a floating surfboard-like craft.
...
- Gord is one of the heroes who can deal more than one type of damage with his skills.
- Gord is one of the heroes that can zoom-out in gameplay when using his ultimate. The other heroes with similar effects include several ultimates that change camera view while charging.
...
- Gord's First ConceptSketch art
