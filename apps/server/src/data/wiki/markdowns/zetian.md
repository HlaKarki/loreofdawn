...
If destiny does not favor you, forge your own path through sheer will and effort. Indeed, this maxim proved true. As Zetian opened the doors to officialdom with brilliantly composed political treatises, maintaining an outwardly gregarious yet inwardly aloof demeanor, she gradually approached the epicenter of power. She even led armies to quell rebellions, and not only garnered fame but also built a formidable list of achievements. Gradually, the people stopped speaking of the past, for Zetian, shining like dawn's first light, was all they could see.
...
Zetian unleashes a wave in the target direction. If it hits an enemy, she automatically casts another wave, up to 3 times. While casting, Zetian can move with 10% increased Movement Speed and can use other skills.

- The skill fires up to three waves that deal scaling damage based on level and stats; the three waves deal increasing damage, with the third wave hitting a larger area and applying a small pull effect (not considered a control effect).
...
Zetian summons a phoenix spirit at the target location, dealing area magic damage and applying a 50% Slow effect to enemies in the area. The phoenix spirit hovers at the location for 3s, dealing periodic magic damage every 0.5s and reducing enemies' Magic Defense by 10%.

- While the spirit is active, Zetian can cast this skill again to command it to charge toward a designated location, dealing damage on arrival and applying a strong Slow effect.
- Spell Vamp efficiency: 50%.
- Mana cost: 80 at level 1 (increases with level).
- Level 1 damage numbers: Base Damage 150, Extra Base Damage 20, Magic Defense Reduction 10%.
- Damage and magic defense reduction scale with skill level.

## Fury of the Phoenix

Zetian calls upon her divine mandate and the hearts of her people.

- Grants all allied heroes increased Movement Speed that gradually decays over 3s. Movement Speed bonus scales with ultimate level (40% / 50% / 60% at ultimate levels 1/2/3).
- Brings divine retribution upon all enemy heroes, dealing area magic damage and stunning them for 1s. Base damage scales with ultimate level (400 / 550 / 700 at ultimate levels 1/2/3).
- Zetian gains vision of all enemy heroes during the ultimate's duration.
- Zetian can cast other skills while channeling this ultimate.
- Spell Vamp efficiency: 50% (where applicable).
- Mana cost: 150 at ultimate level 1 (increases with level).
