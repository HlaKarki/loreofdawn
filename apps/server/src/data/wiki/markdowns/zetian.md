...
- Description: When Zetian hits enemy heroes with [abilities or attacks], she gains 0.5% Spell Vamp for 5s, stacking up to 10 times.
- Periodic Effect: The power of the Phoenix periodically protects Zetian, knocking back and stunning any enemy hero who dares approach her while dealing 90 (+10 * Hero Level) damage to them. She also gains a 300 (+20 * Hero Level) Shield that lasts 3s. This effect has a 120s cooldown.

## Phoenix Strike

- Description: Zetian unleashes a phoenix wave in the target direction. If it hits an enemy, she automatically casts another wave, up to 3 times. While casting, Zetian can move with 10% increased Movement Speed and can use other skills. The three waves deal damage based on level and stats for the first, second, and third waves, respectively. The third wave hits a larger area and includes a small pull effect (not considered a control effect). This skill only has 80% Spell Vamp efficiency against Minions.
- Spell Vamp Ratio: 100%
- Cooldown: 7.0 / 6.6 / 6.2 / 5.8 / 5.4 / 5.0 (seconds)
- Mana Cost: 70 / 80 / 90 / 100 / 110 / 120
- Level Scaling:
  - Base Damage: damage based on level and stats
  - Extra Base Damage: damage based on level and stats
  - Extra Base Damage: damage based on level and stats

## Phoenix Descent

- Description: Zetian summons a phoenix spirit at the target location, dealing base damage and applying a 50% Slow Effect to enemies in the area. The phoenix spirit hovers at the location for 3s, dealing periodic damage every 0.5s and reducing enemies' Magic Defense by 10%. While the spirit is active, Zetian can use this skill again to command it to charge toward a designated location, dealing damage and applying a slow effect upon arrival.
- Spell Vamp Ratio: 50%
...
- Description: Zetian calls upon her divine mandate and the hearts of her people, granting all allied heroes a Movement Speed bonus that gradually decays over 3s, while bringing divine retribution upon all enemy heroes, dealing damage and stunning them for 1s. Zetian gains vision of all enemy heroes during this time. Zetian can cast other skills while channeling this skill.
- Spell Vamp Ratio: 50%
