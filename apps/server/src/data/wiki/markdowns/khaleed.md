...
There was an ancient tribe that lived in the endless deserts of Agelta Drylands (Agelta Drylands). They built villages along the Emerald Road (Emerald Road) and were able able to pass down their civilization and legacy, through countless generations.
...
During their adventure, Khaleed met prince of the Wildsand Clan. The two equally brave young men shared the same passion for adventures, and quickly bonded with each other and developed a strong friendship. Together, they explored the entire Agetla Drylands.

However, the adventure of Khaleed and Moskov was a short one. It was not before long that disaster befell their clans. The savage leader of the Thornwolf Clan declared a war and planned to conquer all of Agelta Drylands, just like the Tyrant once did. Faced with merciless enemies, Khaleed and Moskov bravely decided to lead their people and fight against the invaders, till the end.
...
- Scales / damage type:
  - Basic Attack
  - Physical Defense scaling: base 50, total-pa 140 (pd)
- Passive name: Sand Walk
  - Effects: Speed Up; Damage
  - Description: Khaleed accumulates Desert Power while moving. After Desert Power is fully charged, he will glide on sand, increasing Movement Speed by 35%, making his next deal to the target (cannot critically strike), and reducing the target's Movement Speed by 40% for 1.5 seconds.
  - Terms: Movement Speed; Blink
  - Notes:
    - This effect can trigger item effects such as passive - "Ambush".
    - Increase attack range to 5.
    - Maxes out full 100 Desert Power at (approximately) an accumulated moving distance of 20 unit.
...
- Scaling / damage type:
  - Physical Damage scaling: base 200–525, total-pa 140 (pd)
- Cooldown: 6.5 / 6.0 / 5.5 / 5.0 / 4.5 / 4.0
- Effects: AoE
- Description: Khaleed whirls his scimitar, dealing to enemies in the area and pulling them toward him. This skill can be used up to 3 time(s) in a row. This skill deals 50%-75% damage to Minions and Creeps.
- Properties:
  - Base Damage per level: 200 / 265 / 330 / 395 / 460 / 525
  - Minion Damage Ratio per level: 50% / 55% / 60% / 65% / 70% / 75%
- Terms: Physical Damage Skill; Blink; Pull
- Notes:
...
- Effects: Reduce DMG; Heal
- Cooldown: 22.0 / 21.0 / 20.0 / 19.0 / 18.0 / 17.0
- Description: Khaleed protects himself with the power of the quicksand, restoring 60–135 plus 5%–10% of his lost HP and 10 Desert Power every 0.5 seconds, reducing damage taken by 35%–50% for up to 4 seconds. While channeling, quicksand appears under his feet, slowing the enemy by 60%. This skill is a Focused Cast. Any other controls will interrupt this skill.
- Properties:
...
- Terms: Healing Effect; Damage Reduction; Movement Speed
- Notes:
...
- Scaling / damage type:
  - Extra damage scale: base 100–250, total-pa 50 (pd)
  - Additional damage scale: base 450–750, total-pa 160 (pd)
- Cooldown: 46.0 / 42.0 / 38.0
- Effects: CC; Mobility
- Description: Khaleed rides the sandstorm and charges toward a designated location, dealing to enemies along the way and knocking them toward his destination. Khaleed is immune to control effects during this process. Upon reaching the destination, Khaleed will smash the ground, dealing to enemies in the area and stunning them for 1 second, and fully charge his Desert Power.
- Properties:
  - Base Damage: 100 / 175 / 250
  - Extra Damage: 450 / 600 / 750
- Terms: Control Immunity; Stun; Physical Damage Skill

# Trivia

- (Images and gallery omitted.)
- Characters mentioned: Moskov; Khufra

- Quote (formatted in original):  
  _"Khaleed's Vengeance. This is a clash between Khaleed, and . Will they fight side by side, or against each other?"_
