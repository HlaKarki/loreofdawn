...
• Alias: *Wandering Sword; Spacetime Swordmaster (formerly)*
...
• Voice actors: en: Con Eyre (2017–2020), Evan Louie (2020–); id: Kamal Nasuti; ja: Roa Kenji (ロア健治); ar: Moataz El Shazli; pt: Fábio Campos; ru: Hoshabaev Alexander; tk: Yavuz Gürkan; es: Miguel Angel Leal; zh: Bloomberg (彭博)
...
- Stack scaling examples:
  - Physical Defense Reduction (level 1): 3 / 6 / 9 / 12 / 15
...
Saber dashes in the target direction, dealing damage to enemies along the way while enhancing his next Basic Attack. Saber can dash to the target, and his enhanced Basic Attack deals additional damage and slows the target by 60% for 1 second.

- Cooldown: 7 seconds
- Mana cost (by level): 70 / 65 / 60 / 55 / 50 / 45
- Base Damage by level: 75 / 90 / 105 / 120 / 135 / 150
- Enhanced Basic Attack Damage by level: 75 / 90 / 105 / 120 / 135 / 150
- Damage type: Physical Damage Skill; the enhanced attack is a Physical Basic Attack
...
- Base Damage by level: 120 / 150 / 180
- Extra Damage by level: 240 / 300 / 360
- Effects: Burst, Crowd Control (Airborne)
- Damage type: Physical Skill; skill includes a blink component
