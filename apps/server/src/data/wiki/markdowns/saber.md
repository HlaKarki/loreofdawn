...
- Full name: Duan Meng
- Chinese name: 剑锋 (jiànfēng)
- Aliases: Wandering Sword; Spacetime Swordmaster (formerly)
- Born: Duan Meng or Duanmeng — Unnamed village, Cadia Riverlands
- Origin: Laboratory 1718, Baker Island (as Saber)
- Age: 24
- Species: Cyborg
- Gender: Male
- Occupation: Assassin
- Affiliation: Laboratory 1718 (hostile); Tianyin Swordmaster Sect (formerly)
- Fighting style: Kendo
- Weapons: Space and time swords; The blades of the Cosmic Rift
- Relationships: Longma (master); Zhixu (rival); Octavius (enemies); (ally); (former sectmate)
- English voice actors: Con Eyre (2017–2020); Evan Louie (2020–)
- Indonesian voice actor: Kamal Nasuti
- Japanese voice actor: Roa Kenji (ロア健治)
- Arabic voice actor: Moataz El Shazli
- Portuguese voice actor: Fábio Campos
- Russian voice actor: Hoshabaev Alexander
- Turkish voice actor: Yavuz Gürkan
- Spanish voice actor: Miguel Angel Leal
- Chinese voice actor: Bloomberg (彭博)

# Story

> "A swordsman in pursuit of invincibility, used by Laboratory 1718"
...
> "It is not time yet. You have not yet become a truly invincible swordsman."

The young and vivacious Duan Meng refused to go along with his master's point of view. He was confident enough in his own ability and hoped to improve his swordsmanship through constant combat alone.
...
- Physical Defense Reduction by level: 3 / 3 / 3 / 4 / 4 / 4 / 5 / 5 / 5 / 6 / 6 / 7 / 7 / 7 / 8

- Physical Defense Reduction (stack scaling):
  - Level 1: 3 / 6 / 9 / 12 / 15
  - Level 8: 5 / 10 / 15 / 20 / 25
  - Level 15: 8 / 16 / 24 / 32 / 40

Notes:
- "Attacks" that reduces physical defense only refer to Saber's basic attack and skill damage.
...
Saber shoots out 5 swords that orbit around him, dealing damage based on level and stats to enemies on contact. After orbiting around Saber for roughly 5 seconds, the swords will fly back to Saber. Within the duration of this skill, when Saber deals damage with his Basic Attacks or skills, he will send an orbiting sword towards the target, dealing scaling physical damage based on level and stats to the main target and 50% of that damage to other targets it passes through, and reducing the cooldown of Charge by 1 second. It deals only 50% damage to all non-hero enemies such as minions and creeps.

- Base Damage by level: 80 / 85 / 90 / 95 / 100 / 105
- Extra Damage by level: 210 / 220 / 230 / 240 / 250 / 260

Notes:
- When attacking a turret, Saber will still shoot a sword toward it and reduce Charge's cooldown, but will not deal damage to it.
- Saber can cast Orbiting Swords during dashes and in motion using joystick. In order to cast Orbiting Swords during a dash, input must be quickly made during the initial dash. Saber will be rendered unable to cast Orbiting Swords after knocking up an enemy.
- The shooting swords' extra damage will prioritize targets in this order: visible main target → visible enemy heroes → invisible main target. Some situations such as using the skill on a target inside bush while Saber himself is outside of the bush (therefore making the main target concealed) and an enemy appears on the screen, will cause the shooting swords to home in on the latter enemy instead. This interaction will even prioritize targeting visible minions over an invisible main target.

## Charge

Saber dashes in the target direction, dealing scaling physical damage based on level and stats to enemies along the way while enhancing his next Basic Attack. Saber can dash to the target, and his enhanced Basic Attack deals scaling damage based on level and stats and slows the target by 60% for 1 second.

- Base Damage by level: 75 / 90 / 105 / 120 / 135 / 150
- Enhanced Damage by level: 75 / 90 / 105 / 120 / 135 / 150

Notes:
- Despite its name, "Charge" is technically a blink skill, therefore it can go through obstacles.
...
Saber charges at the target enemy hero, knocking them airborne for 1.2 seconds and striking them 3 times over the duration. The first two strikes deal scaling physical damage based on level and stats each, while the third strike deals greater scaling physical damage based on level and stats.

- Base Damage (first component) by level: 120 / 150 / 180
- Extra Damage (second component) by level: 240 / 300 / 360
...
- His "Force Warrior" skin is the first Starlight Membership Skin. Also his "Iron Hound" skin is the first Skin of Revamped Starlight Membership.
- He equips with two swords along with, , , and.
- On early version, he has a helmet with the letter H which represents Professor Henry.
