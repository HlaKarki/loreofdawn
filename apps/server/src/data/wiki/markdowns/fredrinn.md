...
> "Be a darlin' an' pour me a shot of your signature drink."

> "An' I'mma tell y'all the truth 'bout that bastard Fredrinn!"
...
> "Two shots for our good friend."

The tramp began to speak, tossing a handful of pennies onto the counter.

> "Ahh, mighty fine gentleman. I'll make it worth yer while I assure ya. This one's somethin' ya'll 'ave never heard of!"
...
> "The story begins over a dozen years ago."

> "After receivin' his fief, Duke Vance of Castle Grandrock opened up the seaborne trade route to Northern Vale. Merchant ships from the north…all laden with rare produce…and all tradin' exclusively with the Duke. Why, the old weasel was practically bathin' in profits!"
...
> "For once, I'm damn glad I ain't some rich codger's son!"

said the smuggler.

> "Aye, an' you wouldn't be alone."
...
> "Pretty convenient excuse to suck up to the Monastery's Archbishop!"

the barkeep chimed in.

> "Well, you'd be right."

> "As the Duke was in dire need of stronger political allies. The boy, however…had other plans. Havin' overheard his father's arrangement, the little rascal decided to sneak outta the Castle and sail off on a so-called adventure of his own."

> "I reckon the Duke wouldn't have much to worry 'bout, though."

> "Spoiled little brat like 'im, he'd soon be running back to his daddy!"

> "Aye, the Duke figured as much."
...
he grunted with a sigh and a roll of his eyes.

> "The boy was Fredrinn…Fredrinn Vance!"
...
> "Fredrinn…a nobleman!? Why, the punk's a bloody crook!"

A burly man with a horned helmet cut in, his eyes bulging they almost popped off their sockets.

> "No one knows that money-grubber better than me!"
...
The young smuggler raised his hand and asked if the tales about Fredrinn's strict appraisal policies were true.
...
> "Come on, we all know about those!"

cried the tramp, his voice dripping with sarcasm.

> "But what about Fredrinn's secret!? That crystal lodged in his chest—"
...
the tramp and the burly man stuttered in awe.

The tin wine box in Fredrinn's hand creaked as his fist clutched.

> "A wonderful story, my friend."

> "However, if I hear anyone say I killed my partner again…I'll come to his door and give him a thorough appraisal."
...
Fray, who'd always hidden behind Fredrinn, picked up a shard of the crystal and pressed it against Fredrinn's chest, giving up to him the only chance of survival. The power of the crystal integrated with Fredrinn's own and protected him from the collapse.

But when he looked up, he found Fray and the ruins both gone without a trace. The only thing left was Fray's magic compass.
...
- Combo Resource: Fredrinn gains 1 Combo Point that lasts 5 seconds each time his skill hits a non-minion enemy, up to 4 Combo Points. His Ultimate costs different numbers of Combo Points at different skill levels.
- Crystal Energy: Fredrinn stores 100% of the damage he receives as Crystal Energy, which decays after 5 seconds at a rate of 10% per second. Gaining a Combo Point resets the decaying timer.
- Conversion: Fredrinn can convert the stored Crystal Energy into HP equal to 20% of his damage dealt (10% for damage dealt to minions).

Notes:
- The mechanic emphasizes chaining skills to maintain resources and survivability.
...
Notes:
- The enhanced basic attack from this skill and the enhanced basic attack from Brave Assault cannot be stacked. The enhanced basic attack effect from one will be replaced by the other.

## Brave Assault

Fredrinn dashes in the target direction, dealing scaling physical damage to the first non-minion enemy hit. His next Basic Attack knocks the target airborne for 0.3 seconds.

- Base Damage by Level: 200 / 220 / 240 / 260 / 280 / 300
- Scaling: deals additional damage based on Fredrinn's physical attack and level.

Notes:
- The enhanced basic attack from this skill and the enhanced basic attack from Piercing Strike cannot be stacked. The enhanced basic attack effect from one will be replaced by the other.
- Bug: Skill Smart Targeting does not work on this skill.

## Energy Eruption

Fredrinn erupts with energy, dealing scaling physical damage to nearby enemies and taunting them for 1 second. Hitting a non-minion enemy grants Fredrinn increased Physical and Magic Defense for a short duration and reduces the cooldowns of Skill 1 and Skill 2 by 75%.

- Base Damage by Level: 300 / 400 / 500
- Defense Boost by Level: 15 / 25 / 35 (Physical and Magic Defense for 3 seconds)
- Cost: 1 Combo Point

Notes:
- Hitting a non-minion enemy reduces the cooldowns of Skill 1 and Skill 2 by 75%.
- This skill is learned together with Appraiser's Wrath.
- Between Fredrinn's latter two skills, certain heroes that siphon abilities can only copy this skill.

## Appraiser's Wrath

Fredrinn slams his sword in the target direction, dealing a large amount of physical damage to enemies in a fan-shaped area after a short delay. Damage is base plus a percentage of his stored Crystal Energy converted into damage. Enemies in the center of the area take increased critical damage.

- Base Damage by Level: 600 / 800 / 1000
- Additional Damage: plus 35% of his stored Crystal Energy as physical damage
- Center Hit: enemies in the center take 175% of the hit (increased critical damage)
- Cost: 3 Combo Points
- Cooldown by Level (original design): 30.0 / 27.0 / 24.0

Notes:
- This skill is learned together with Energy Eruption.
- The 175% increased critical damage from this skill does not benefit from Critical Damage attribute.
- This skill cannot be interrupted. The hit will still be executed even if Fredrinn is crowd controlled while performing it.
...
- His design and personality resemble rogue adventurers or mercenaries, similar to characters like Indiana Jones, Flynn Rider (Tangled), or Gambit (X-Men).
- One of the few MLBB Heroes with a delayed ultimate activation. His ultimate requires skill combos first, making him different from tanks who can instantly use their ultimates.
- Some early concept sketches had him looking more like a pirate captain rather than a noble adventurer.
