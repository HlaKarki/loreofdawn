...
Tanks are classified into three types: pure, primary, and secondary.

## Pure

Because they have no other role, these heroes are full Tanks.
...
These heroes are mainly Tanks who can also be used for a different purpose.
...
Because they are used in a different way than a Tank's main purpose, these heroes are half-Tanks.
...
- Hylos — Jungle Watcher (Seasonal)
- Grock — Ancient Golem (Seasonal)
- Uranus — Earthen Relic (Seasonal)
- Barats — War Chief (Seasonal)
- Baxia — Black Tortoise
- Minotaur — Taurus (Zodiac skin)
- Franco — King of Hell (Legend Skin)
- Johnson — Sovereign of Realms (Legend Skin)
- Khufra — Volcanic Overlord (Collector Skin)
- Edith
- Alice
- Johnson — Automata (S.A.B.E.R. Squad)
- Grock — Monitor Lizard (V.E.N.O.M. Squad)
- Tigreal — Defender (Lightborn)
- Franco — Blazing Axe (Blazing Bounties)
- Esmeralda
...
- (Volcanic Overlord) and (Red Bastion) have Collector Skins. (Collector Skins)
- has an Exclusive skin (Darknet Temptress) obtained by reaching Exalted Collector V in the Collection system.
- Five of the tanks have Squad skins: (Squad Skins)
  - S.A.B.E.R. - Automata
  - V.E.N.O.M. - Monitor Lizard
  - - Lightborn - Defender
  - Blazing Bounties - Blazing Axe
  - Blazing Bounties - Blazing Shadow and HERO - The Foreseer

(Internal page names referenced above are retained in parentheses where applicable.)
