...
- **Full name:** Lesley of House Vance
- **Chinese name:** 莱斯丽 (láisīlì)
- **Alias:**
  - Deadly Sniper
...
If Lesley doesn't take damage for 5 seconds, her next Basic Attack gains extra range and 50% Critical Chance and deals extra damage against minions. Each point of fixed Physical Penetration Lesley acquires is converted into 0.5% Critical Damage, but her base Critical Damage is reduced to 140%.

Lesley's Basic Attack restores 5 points of energy and her enhanced basic attack doubles the amount of energy restored. The cooldown of the enhanced basic attack resets each time Lesley casts a skill.

Notes:
- Instead of dealing normal damage to turrets, it inflicts physical damage on turrets.
...
Cooldown: 5.0 / 4.4 / 3.8 / 3.2 / 2.6 / 2.0 seconds

Lesley enters the Camouflage state, gaining double Energy Regen, 40% extra Movement Speed, and an Attack Bonus of 85 to 135 Physical ATK depending on skill level. The state lasts 3 seconds or until Lesley takes or deals damage. Enemies can detect Lesley's position through distortions of their surroundings.

Attack Bonus by level: 85 / 95 / 105 / 115 / 125 / 135
...
Note: Energy regeneration bonus starts after Master of Camouflage ends.

## Tactical Grenade

Cooldown: 10.0 / 9.4 / 8.8 / 8.2 / 7.6 / 7.0 seconds

Lesley throws a tactical grenade in the target direction while slightly jumping back, dealing base damage and knocking enemies in a cone back. Damage scales with skill level and stats.
...
Cooldown Reduction by level: 10%, 20%, 30%, 40% (scales with level)

Notes:
- Lesley can aim for up to 8 seconds.
- Firing Lethal Bullets lasts up to 3.6 seconds (or earlier if canceled). Each Lethal Bullet is fired approximately every 0.9 seconds.
...
- If the skill is canceled without shooting any bullets, Lesley is not revealed to the enemy.
- The aim range is 11 unit, and max range is 15 unit.
- The indicator is shown on Lesley's minimap when holding the skill, and the skill does not activate if there are no enemy heroes within range.
