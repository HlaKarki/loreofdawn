...
Harith creates a phantom of himself in a distant location. Harith and his phantom will then release toward each other, dealing scaling magic damage to all enemy units on the path. When the two energy waves collide, an explosion occurs, dealing scaling magic damage to all enemies in the explosion area.

- Mana cost (per level): 50 / 55 / 60 / 65 / 70 / 75
- Base Damage: 236 / 264 / 292 / 320 / 348 / 376 (base damage values listed)
- Explosion Damage: 590 / 660 / 730 / 800 / 870 / 940 (explosion damage values listed)
- Spell Vamp Ratio: 50%

Damage values scale with level and magic power.

## Chrono Dash

Harith dashes towards the target direction. When he arrives, he steals Magic power from enemy heroes, generates a shield that absorbs damage based on level and Harith's magic power and enhances his next basic attack. Harith's enhanced basic attack deals scaling damage and slows enemies by 40%. Hitting an enemy with Harith's enhanced basic attack reduces the cooldown of Chrono Dash by 3 seconds.

- Mana cost (per level): 40 / 43 / 46 / 49 / 52 / 55
- Base Damage examples listed: 185-310 (scaling damage based on level and stats)
- Alternate scaling values listed: 225-350
- Shield: absorbs damage based on level and Harith's magic power

Damage and shield values scale with level and Harith's magic power.

## Zaman Force

Harith uses his Key to summon the multidimensional rift. When the multidimensional rift appears, the cooldown of certain skills is reduced by 4 seconds. The rift initially slows enemy heroes in the area by 70% and will continuously slow enemy heroes by 35% afterwards. If Harith comes into contact with the rift using Chrono Dash, he will absorb the energy within and reduce the cooldown of one skill by 1 second and another skill by 3 seconds. Harith gains 15% Resilience while on the rift.

- Cooldown (levels): 40.0 / 35.0 / 30.0
- Mana cost (levels): 120 / 160 / 200
- Quote: They say geniuses recognize one another!, a quote from.
- Note: The Rift has the length of 12 unit.
