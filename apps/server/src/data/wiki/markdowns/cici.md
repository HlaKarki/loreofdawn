...
Undaunted, she resolved to bring fun and wonderment back to the city. Inspired by her spirit, the long-muted performers of Castle Aberleen emerged from the shadows and took part in the most magnificent show the castle has ever witnessed.
...
> "Why did 16 years old Cici choose Castle Aberleen for her show tour? The place is screaming "No Entertainment Allowed", but why?

> Cici appears to have intricate ties to Aberleen. Tap the link below to delve deeper into Cici's story!"

- MLBB social media post to promote Cici's bio
...
The red-eyed ravens circled in the sky, emitting piercing cries. The soldiers that came to life from building facades were mobilized en masse, their rigid joints rattling with purpose.

Yes, yes! Now they are part of the performance!
...
Dancing in unison with the doves, they wrapped around the leader of the soldiers. Bubbles gently descended from the sky, entrapping soldiers within - it was the boy from the sea, Binny.
...
With a boost from Yoyo, Cici gracefully scaled the mountain of soldiers before reaching the rooftops and making her escape. Wherever she went, the night sky lit up, and the tumbling Yoyo spread her exuberant energy to every window she passed.
...
Cici pressed on towards the horizon. From the highest point of Castle Aberleen, fireworks blossomed, and the entire city was ablaze with a radiant display.
...
- Extra Movement Speed and Spell Vamp per stack: 0.75% (stacks increase these values up to a doubled effect at full stacks).
- Stack scaling: 0.75% / 1.50% / 2.25% / 3.00% / 3.75% / 4.50% / 5.25% / 6.00% / 6.75% / 15.0%.
...
Cici uses Yoyo to continuously attack the nearest enemy within range (prioritizing heroes) for 3.5 seconds, hitting them up to 10 times. Each hit deals damage based on base damage and a percentage of the target's Max HP per hit. Cici can move and use other skills during this attack. If there's no enemy hero within range, Yoyo will attack Turrets or the Base instead. The skill deals 20% extra damage to Minions.
...
- Target's Max HP Percentage per hit: 3% / 3.3% / 3.6% / 3.9% / 4.2% / 4.5%
...
Cici leaps to a target location. If she lands on any unit (not including Turrets and Base), she can leap again in the Joystick's direction. If she lands on an enemy with the first leap, she deals damage to them.

Level Scaling:
- Base Damage: 200 / 220 / 240 / 260 / 280 / 300

Notes:
- Can perform a second leap if landing on a unit (excluding Turrets and Base).

## Curtain Call

Cici throws Yoyo at the target enemy hero and links them with another nearby enemy hero, dealing damage, slowing them by 30%, and pulling them together. During this time, Cici can use Yo-Yo Blitz to attack both linked targets at the same time. If only one is within the range of Yo-Yo Blitz, Cici will attack the target twice, but the damage of the second attack will be reduced according to the decay ratio.

- Slow: 30%
- Decay Ratio (second attack reduced damage): 20% / 25% / 30% (per ultimate level)

Notes:
- Yoyo applied to an enemy counts as a debuff and can be removed by cleansing effects such as Purify.
- During the link, Cici can use Yo-Yo Blitz to attack linked targets simultaneously.
