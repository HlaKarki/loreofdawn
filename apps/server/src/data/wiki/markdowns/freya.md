...
- **Chinese name:** 芙蕾雅 (fúlěiyǎ)
- **Origin:** Martyr Shrine, Northen Vale
- **Species:** Human
- **Gender:** Female
- **Title:** Valkyrie
- **Affiliation:** Frozen Sea warriors (allied); Black Shark Pirates (hostile)
- **Weapons:** Sword and shield which can turn into a battleaxe
- **Abilities:** Bringing fallen warriors to Valhalla; Turns into Valkyrie mode
- **Battles fought:** Fighters on the Stormy Sea
- **Relationships:** Skuld (elder sister, fate unknown); companions (unspecified); enemies (unspecified)
- **English voice actor:** Aimee Smith
...
> "A female warrior, a daughter of Northern Vale, will one day lead this land to a new path."

Everyone believed that the kid in the prophecy was Skuld. So, in order to fulfill her destiny, she kept training day after night, hoping that one day she could take up the mantle and bring a glorious future to her tribe and the entire Northern Vale.
...
Freya jumps to the target location, dealing base physical damage to enemies hit and pulling them towards her.

- Base Damage: 200 / 220 / 240 / 260 / 280 / 300 (damage scales with level and stats)
- Cooldown: 8.0 / 7.6 / 7.2 / 6.8 / 6.4 / 6.0 seconds

Notes:
- This ability pulls enemies toward Freya on impact.
- This can cancel the casting animation of any of the Spirit Combo skills to extend their range, especially the 3rd cast.
...
- Base Damage (per initial strike): 20 / 62 / 104 / 146 / 188 / 230
- Final Damage (third cast area): 26 / 76 / 126 / 176 / 226 / 276
- Cooldown: 10.0 / 9.6 / 9.2 / 8.8 / 8.4 / 8.0 seconds

Notes:
- Each of the Spirit Combo casts cannot be interrupted, not even by death.
- Uses Sacred Orb stacks to allow subsequent casts.

## Valkyrie Descent

Freya gains 6 stacks of Sacred Orb and enters the Valkyrie state for 10 seconds, gaining a shield and an attack bonus. Meanwhile, her Basic Attacks become ranged and deal splash damage.

- Enhanced Basic Attack Range: 3.5
- Shield: 600 / 750 / 900
- Attack Bonus: 30 / 50 / 70 (attack bonus scales by level)
- Duration: 10 seconds
- Cooldown: 54.0 / 50.0 / 46.0 seconds

Notes:
- Lifesteal and attack effects from splash damage apply only on Freya's main target, not on enemies who only received splash damage.
