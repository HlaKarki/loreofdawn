...
- Aliases: Bloody Beast; Berserker (former)  
...
- Weapons: Battleaxe  
- Abilities (notable): Bloodthirst (passive)  
- Battles fought: Invasion of Moonlit Forest  
- Relationships (raw data): *Unnamed father; * (mutually exploit); * (rival); *,, , (enemies); * (conqueror/defeater)  
- Religion: Lord of Abyss  
- Voice actors:
  - English (en): Con Eyre (2017–2021); Patrick Seitz (2021– )
  - Indonesian (id): Edy Rachmat
  - Japanese (ja): Sanpei Yuuki (三瓶 雄樹)
  - Arabic (ar): Khaled El Shershaby
  - Portuguese (pt): Fransisco Junior
  - Russian (ru): Dakhnenko Maksim
  - Turkish (tk): Kadir Özübek
  - Spanish (es): Carlos Segundo
  - Chinese (zh): Sheng Feng (图特哈蒙)
...
Despite all this, it seemed fate had not yet finished toying with this ancient race. As the Abyss encroached, once more powerful demons emerged again from the south presenting a perilous threat to their declining Orc populations. Under the demons' oppression the Orcs were made to split into several small clans scattered throughout the vast expanse of the roaring wilderness, exploited to the utmost.

Balmond was born in a traditional orc tribe within the Roaring Wilderness, and from a young age his father had always taught him all kinds of combat skills. Along with this, he would also regale him tales of the Orcs' former glories; how they once resided in their homeland in the north of Lantis Mountains and their millennia of fierce battles waged against the elves and humans. He hoped that Balmond would, one day, be able to become a true Orc leader and return them to their former glory.

Over twenty years later, Balmond had grown into a mighty Orc under his father's teaching. During this time, the demons' brutality had instilled Balmond with deep, dark memories, only making him yearn even more for the day when the Orcs could return to power, bringing back their once-formidable kingdom. To this end the young Balmond not only trained relentlessly, but also dedicated himself to studying all kinds of ancient Orc tomes, which gifted him with astute strategic knowledge.
...
Under Balmond's command, the fierce Orc warriors successfully fought back the demon armies that came to suppress them, dealing a heavy blow. This gigantic counterattack launched by the Orcs shocked the demons, enraging Lord Lava, Thamuz. He dispatched numerous terrible troops formed of Blood Demons and Fiends to the Roaring Wilderness, as he would never stand for resistance against his demons within the Wretched Expanse.
...
- Term: Max HP  
- Effect: Heal  
- Description: Balmond recovers 5% after killing a Minion or Creep, and 20% after killing a hero.

### Skill 1 — Soul Lock
- Terms: Blink; Physical Damage Skill; Movement Speed  
- Effects: Mobility; Slow  
- Cooldown: 8.0 / 7.4 / 6.8 / 6.2 / 5.6 / 5.0 s  
- Description: Balmond charges in the target direction for a set distance or until he hits an enemy hero, dealing physical damage to enemies along the way. The enemy hero hit will be knocked back slightly and slowed by 60% for 2 seconds.  
- Level scaling / Base Damage: 150 / 175 / 200 / 225 / 250 / 275  
- Additional scaling: Total Physical Attack contribution 60.

### Skill 2 — Cyclone Sweep
- Terms: Physical Damage Skill  
- Effects: AOE; Buff  
- Cooldown: 6.0 s  
- Description: Balmond gains 15% Movement Speed that decays over time and spins his axe for 3 seconds, dealing physical damage to nearby enemies up to 14 times. Each subsequent hit on the same enemy deals 7.5% increased damage (up to 60%). The Physical Attack bonus portion of the damage can crit.  
- Level scaling / Base Damage: 25 / 40 / 55 / 70 / 85 / 100  
- Max Damage by level: 350 / 560 / 770 / 980 / 1190 / 1400  
- Damage increase per subsequent hit (stack scaling): 7.5% / 15% / 22.5% / 30% / 37.5% / 45% / 52.5% / 60.0%  
- Notes:
...
- Terms: True Damage Skill; Lost HP; True Damage  
- Effects: Burst; Slow  
- Cooldown: 34.0 / 29.0 / 24.0 s  
- Description: Balmond unleashes a huge strike in the target direction (cannot be interrupted). This skill deals true damage based on lost HP and other scaling; it also deals up to 1000–2000 damage to non-hero units.  
- Extra Damage scaling: 30% / 37.5% / 45%  
- Non-hero unit damage cap: 1000 / 1500 / 2000  
- Notes: Does not show an area of effect pre-animation with Savage Pointguard skin.

## Artwork
(Images listed by filename — no links included)
- File:Balmond_(Bloody_Beast).jpg
- File:Balmond_(Power_Source).jpg
- File:Balmond_(Ghoul's_Fury).jpg
- File:Balmond_(Savage_Hunter).jpg
- File:Balmond_(God_of_Mountains).jpg
- File:Balmond_(Savage_Pointguard).jpg
- File:Balmond_(Bioroid).jpg
- File:Balmond_(Infernal_Warlord).jpg
- File:Balmond_(Razor_Edge).jpg
...
- In his old lore, he went from being a slave to being a mutually exploited ally in the new lore.
- Balmond's "Celestial General" (now "God of Mountains") skin had the longest release postponement; it was supposed to be released in 2018 but was released in August 2021 for the Grand Collection event.
- Balmond is notorious within the community as he can be seen in almost every MLBB Google ad.

Trivia image:
- File:Bloodthirst.png — "Bloodthirst" skill icon.

## Related / Mentioned Characters
- Alice
- Thamuz
- Alucard
- Harith
