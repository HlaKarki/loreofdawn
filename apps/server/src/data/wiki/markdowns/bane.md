...
- Abilities summary: Infuses his blade with Tidal Energy; Drinks ale and spits venom afterwards; Summons school of sharks
...
Bane infuses his weapon, gaining one stack each time he uses a skill (up to 2 stacks). Each of his subsequent Basic Attacks consumes a stack to deal bonus physical damage and to deal damage based on the target's Max HP to nearby enemies. Damage scales with level and offensive stats. Percent damage dealt is based on the enemy's Max HP; against Creeps there is a Max HP Damage Cap (see level-scaling).
...
- Stacks last for 8 seconds. The timer resets if not consumed before the next enhanced Basic Attack.
- Only the bonus portion of his enhanced basic attack can critically strike.
...
Notes:
- The cooldown reduction from the stat mentioned is linear and not stepwise at every 100 points.
...
- Mana cost (per level): 60 / 70 / 80 / 90 / 100 / 110
- Cooldown (per level): 7.5 / 6.9 / 6.3 / 5.7 / 5.1 / 4.5 seconds
- Level scaling:
  - HP Regen (percentage of Max HP recovered): 5% / 6% / 7% / 8% / 9% / 10%
...
Bane summons a school of sharks to charge in a target direction, dealing base damage to enemies hit, knocking them airborne for 0.8 seconds, and slowing them by 65% (decays over 3 seconds). This skill deals 40% of its damage to turrets.

- Mana cost (per level): 120 / 140 / 160
