...
- Full name: Princess Pharsa of Crow Clan
- Chinese name: 法莎 (Fǎshā)
...
- Height: 197cm
- Weapons: Magic staff
- Abilities: Disintegrates into a mist and wraps around Verri for quick travel
- Relationships:
  - Osana (ancestor)
  - Verri (spouse)
  - (enemy)
...
> "Crow Princess of Askati Forest"
...
- If Pharsa uses Wings by Wings immediately when Verri is flying towards the target, neither damage nor effect is applied to the target while the passive still goes on cooldown.
- Verri is unsighted if Pharsa is concealed.

## Curse of Crow

Pharsa unleashes a blast of magic at the target location, dealing magic damage to enemies hit and marking them for 4 seconds. Pharsa's subsequent attack against marked enemies will consume the mark and stun them for 1 second.

- Type: Stun / Magic Damage
- Cooldown: 8.0 seconds (scales down per level)
- Mana cost: 60 / 66 / 72 / 78 / 84 / 90 (per level)
- Base damage: 300 / 325 / 350 / 375 / 400 / 425 (per level)

Additional effects:

- Affected enemies are revealed while marked.
- The subsequent attack refers to Pharsa's basic attack which consumes the mark and stuns for 1 second.
...
Pharsa releases magic energy in the target direction, dealing magic damage to enemies hit.

- Type: Magic Damage / AOE
- Cooldown: 5.0 seconds
- Mana cost: 50 / 56 / 62 / 68 / 74 / 80 (per level)
- Base damage: 525 / 560 / 595 / 630 / 665 / 700 (per level)
...
Pharsa takes flight for 8 seconds and bombards the target location, dealing magic damage to enemies within the area. This skill can be cast up to 4 times within the duration.

- Type: Magic Damage / Burst
- Duration: 8 seconds
- Cooldown: 36.0 / 33.0 / 30.0 (per level)
- Mana cost: 120 / 150 / 180 (per level)
- Base damage: 570 / 720 / 870 (per level)

Notes:

- The ability has an estimated range of 9.5 and a hitbox of 1.9.
- Pharsa can cast other abilities, battle spells, and equipment actives while flying, except for Wings by Wings and Recall without canceling this ability.
- The casting of the ability counts as the first cast when activated.

- Spellvamp ratio: 50%.

## Wings by Wings

Pharsa turns into mist and wraps herself around Verri, gaining 150% extra Movement Speed (decaying over time) and the ability to fly over terrain. This state lasts up to 5 seconds or until she uses a skill, or is controlled.

- Type: Ignore Obstacles / Movement Speed
- Cooldown: 23.0 seconds
- Duration: 5 seconds

Notes:

- The camera height raises within the skill channeling.
- This ability grants temporary flight and increased movement speed but ends if Pharsa casts other skills or is crowd controlled.
...
- Prior to her revamp, she was temporarily banned in Brawl games as her ultimate skill gave a huge disadvantage to her enemies due to its short cooldown, range, and damage.
