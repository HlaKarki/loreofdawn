...
> "A brave girl who stands up and doesn't fear power"
...
- Description: Mathilda gains ancestral energy while moving. When the passive is fully charged, her next Basic Attack will be enhanced, dealing scaling magic damage based on level and stats to the target and granting her 80 Movement Speed that decays over 2.5 seconds.
- Effect Type: Magic Basic Attack, Movement Speed buff
- Scaling: damage based on level and Magic Power and the passive's charge
- Notes: Enhanced basic attack consumes the passive charge.

## Soul Bloom

- Mana Cost by Level: 60 / 70 / 80 / 90 / 100 / 110
- Base Damage by Level: 275 / 320 / 365 / 410 / 455 / 500 (magic)
- Description: Mathilda resonates with the power of her ancestors for 4 seconds, attracting up to 6 wisps as her movement distance increases. At the end of the skill's duration, or when Mathilda casts the skill again, the wisps seek out nearby enemy units and each wisp deals magic damage and briefly reveals enemies' positions. Subsequent damage dealt by wisps to the same target decays to 40%.
- Properties: Base damage values listed above. Has a radius of 5.3 units.
- Additional Notes:
...
- Notes:
  ...
  - The ability lasts 5 seconds in total.
  - The option to be guided is disabled if the ally is rooted.

## Circling Eagle

- Mana Cost by Rank: 150 / 180 / 210
- Cooldown: 40 seconds
...
- Additional Notes:
  ...
  - The circling stops and Mathilda dashes toward the target if the target moves too far away or dies.
  - In certain states, she will circle around a center point instead, but damage and effects still apply to the marked target.
  - Mathilda is not CC immune during the dash animation.
