...
- Relationships:
  ...
  - Dr. Rooney (companions)
  - (teacher)
  - (ally)
  - (enemy)
- Voice Actors:
  - English: Sarah Miller-Crews
  - Japanese: Nene Hieda (稗田 寧々)
...
- Applies to Physical Basic Attacks and skills that are part of her normal damage output.
- Damage increase only includes damage from basic attacks and skills.
- Damage scales with distance traveled by the projectile; scaling damage based on distance and stats.
...
- Upon hitting an enemy with this skill, Layla gains 1.6 - (0.2 × level) Basic Attack Range (values per level: 1.6 / 1.4 / 1.2 / 1).

This is a Physical Damage Skill. Scaling damage based on level and stats.

## Void Projectile

- Cooldown: 7.5 / 7.3 / 7.1 / 6.9 / 6.7 / 6.5 seconds (skill ranks 1–6)
- Mana Cost: 65 / 70 / 75 / 80 / 85 / 90

Layla fires an orb of Malefic Energy that explodes on hit, dealing base damage to targets in the area and applying Magic Mark on them for 3 seconds. When Layla hits an enemy with a Magic Mark, she deals extra damage to nearby enemies and stuns them for 0.25 seconds.

- Base Damage: 170 / 200 / 230 / 260 / 290 / 320
- Extra Damage: 100 / 120 / 140 / 160 / 180 / 200

This skill deals Physical Damage. It has an area of effect and applies a slow effect via the Magic Mark; damage scales with level and stats.

## Destruction Rush

- Cooldown: 37.0 / 32.0 / 27.0 seconds (ultimate ranks 1–3)
- Mana Cost: 130 / 150 / 170

Layla fires a blast of Malefic Energy in the target direction, dealing base damage to enemies in a line. The range of Layla's Void Projectile and Basic Attacks is increased by 0.6–1.8 units depending on ultimate level. Her sight range is also slightly increased each time this skill is upgraded.

- Range Increase by Ultimate Level: 0.6 / 1.2 / 1.8
- Basic Attack Range Per Destruction Rush Level: 4.9 / 5.5 / 6.1
- Base Damage: 500 / 650 / 800

Notes:
- This skill's actual range is slightly wider than the skill range indicates; verification needed.
- Physical Damage Skill. Damage scales with level and stats.
...
- Layla was one of the heroes revamped in Project NEXT’s first batch in September 2020, along with several other legacy heroes. The goal was to balance the power gap between older and newer heroes, as the latter had better mechanics and animations.
