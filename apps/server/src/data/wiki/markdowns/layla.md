...
She was revamped for the third time on 26 June 2023 as part of Project NEXT 2023 and is one of the faces of Season 29: Outlaw, alongside Ixia.

She is also the face of the Main Interface during the Rookie Season and serves as the guide throughout the in-game tutorial.
...
- Weapons:
  - Malefic Gun
  - Malefic Energy Bomb, energy ball and energy blast
- Abilities: Increased sight range
- Relationships: Thomas (grandfather); Lillian Osborne (mother, deceased); Dr. Rooney (companion); other confidantes, allies, and enemies in Eruditio lore
- English voice actor: Sarah Miller-Crews
- Japanese voice actor: Nene Hieda (稗田 寧々)
- Indonesian voice actor: Dewi Arifiani
- Chinese voice actor: Shan Xin (山新)
- Name: Layla
...
In Eruditio—the City of Scholars, there's hardly anyone who doesn't know of Layla. She's the "daughter of Eruditio", just like a bright star that shines over the streets of Eruditio in the darkness of night.
...
However, as secrets cannot be hidden forever, the truth of her birth eventually surfaced, and it turns out that her parents have always been watching her from the skies—well, in the literal sense.
...
Layla understood that her grandfather wanted to erase all traces of her parents from her life so that she'd never have to grieve. Though Layla understood, she still wanted to leave a little door in her heart for the woman named Lillian, so that if Lillian ever missed her, she could still visit her in dreams. As for the mysterious man's tombstone, since she didn't have a single clue at all as to who he was, she hoped that he'd one day walk through that little door with her mother and finally reveal his true identity.
...
With the malefic gun in Layla's hands, no evil stands a chance in front of her. As if the stars would always guide her, whenever Layla is holding her gun, she feels that Lillian is just beside her. Even that nameless man, too, is there for her.
...
- Applies to Physical Basic Attack and skills that are counted as basic attack damage.
- Damage increase only includes damage from basic attacks and skills.
- Note: damage scales with distance, starting at 100% and reaching 130% at 6 units away.

## Malefic Bomb

Layla fires a Malefic Bomb in the target direction, dealing damage to the first enemy hit (damage based on skill level and stats; can critically strike). Upon hitting an enemy, Layla's Basic Attacks and Void Projectile gain extra range for 3 seconds, and she gains 60% Movement Speed that decays over 1.2 seconds. The duration of the Movement Speed boost is doubled if an enemy hero is hit.

- Base Damage by level: 200 / 240 / 280 / 320 / 360 / 400
- Total Physical Attack scaling: 80 (scales with Layla's physical attack)
- Range bonus on hit: 1.6 - (0.2 × level) Basic Attack Range (1.6 / 1.4 / 1.2 / 1 at respective levels mentioned)
- Cooldown: 6.0 / 5.6 / 5.2 / 4.8 / 4.4 / 4.0 seconds (first value shown above)
- Mana Cost: 40 / 45 / 50 / 55 / 60 / 65 (first value listed above)

Notes:
- Upon hitting an enemy with this skill, Layla gains additional Basic Attack Range as listed above.
- Skill grants movement speed burst that decays over 1.2 seconds; duration doubles if an enemy hero is hit.

## Void Projectile

Layla fires an orb of Malefic Energy that explodes on hit, dealing physical damage to targets in the area and applying Magic Mark on them for 3 seconds. When Layla hits an enemy with a Magic Mark, she deals extra damage to nearby enemies and stuns them for 0.25 seconds.

- Base Damage by level: 170 / 200 / 230 / 260 / 290 / 320
- Extra Damage on Magic Mark by level: 100 / 120 / 140 / 160 / 180 / 200
- Total Physical Attack scaling: 65 for the main explosion, 35 for the extra damage (scales with Layla's physical attack)
- Cooldown: 7.5 / 7.3 / 7.1 / 6.9 / 6.7 / 6.5 seconds (first value shown above)
- Mana Cost: 65 / 70 / 75 / 80 / 85 / 90 (first value shown above)

Notes:
- Applies Magic Mark to enemies hit for 3 seconds.
- Hitting a Magic Mark triggers extra area damage and a short stun (0.25s).

## Destruction Rush

Layla fires a blast of Malefic Energy in the target direction, dealing physical damage to enemies in a line (damage based on level and stats).

- Base Damage by level: 500 / 650 / 800
- Total Physical Attack scaling: 150 (scales with Layla's physical attack)
- Range increase per Destruction Rush level: 0.6 / 1.2 / 1.8 units
- Basic Attack Range per Destruction Rush level: 4.9 / 5.5 / 6.1 (listed as Basic Attack Range per level)
- Cooldown: 37.0 / 32.0 / 27.0 seconds (first value shown above)
- Mana Cost: 130 / 150 / 170 (first value shown above)

Notes:
- The range of Layla's Void Projectile and Basic Attacks is increased by 0.6–1.8 units depending on ultimate level.
- Her sight range is also slightly increased each time this skill is upgraded.
- This skill's actual range may be slightly wider than the skill range indicates.
...
- From 2016 to 2020, she is the first hero that new players can obtain for free after completing the Tutorial, but was replaced by another hero in a later update.
...
- Layla was one of the heroes revamped in Project NEXT’s first batch in September 2020. The goal was to balance the power gap between older and newer heroes, as the latter had better mechanics and animations.
