...
- Relationships: (father); Lillian Osborne (mother, deceased); Thomas (grandfather); (confidante, best friend); Dr. Rooney (companions); (teacher); (ally); (enemy)
- Voice actors: EN: Sarah Miller-Crews; JA: Nene Hieda (稗田 寧々); ID: Dewi Arifiani; ZH: Shan Xin (山新)
...
{\rm total\ DMG} = initial\ DMG \times \bigl[ 100% + (5% \times distance\ projectile\ traveled)\bigr]
...
Cooldown: 6.0 / 5.6 / 5.2 / 4.8 / 4.4 / 4.0 seconds (per level)

Mana cost: 40 / 45 / 50 / 55 / 60 / 65 (per level)

Layla fires a Malefic Bomb in the target direction, dealing damage to the first enemy hit (can critically strike). Upon hitting an enemy, Layla's Basic Attacks and Void Projectile gain extra range for 3 seconds, and she gains 60% Movement Speed that decays over 1.2 seconds. The duration of the Movement Speed boost is doubled if an enemy hero is hit.

- Base Damage: 200 / 240 / 280 / 320 / 360 / 400
- Total Basic Attack and Void Projectile Range: 5.9 / 6.3 / 6.7 / 7.1
- Total Basic Attack and Void Projectile Range (with Malefic Gun equipped): 6.785 / 7.245 / 7.705 / 8.165
- Upon hitting an enemy with this skill, Layla gains 1.6 - (0.2 × level) Basic Attack Range (1.6 / 1.4 / 1.2 / 1).

Term: Physical Damage Skill; Crit Damage

## Void Projectile

Cooldown: 7.5 / 7.3 / 7.1 / 6.9 / 6.7 / 6.5 seconds (per level)

Mana cost: 65 / 70 / 75 / 80 / 85 / 90 (per level)

Layla fires an orb of Malefic Energy that explodes on hit, dealing damage to targets in the area and applying Magic Mark on them for 3 seconds. When Layla hits an enemy with a Magic Mark, she deals additional damage to nearby enemies and stuns them for 0.25 seconds.

- Base Damage: 170 / 200 / 230 / 260 / 290 / 320
- Extra Damage (when triggering from Magic Mark): 100 / 120 / 140 / 160 / 180 / 200

Term: Physical Damage Skill; Movement Speed

## Destruction Rush

Cooldown: 37.0 / 32.0 / 27.0 seconds (per level)

Mana cost: 130 / 150 / 170 (per level)

Layla fires a blast of Malefic Energy in the target direction, dealing damage to enemies in a line. The range of Layla's Void Projectile and Basic Attacks is increased by 0.6–1.8 units. Her sight range is also slightly increased each time this skill is upgraded.

- Range Increase: 0.6 / 1.2 / 1.8
- Basic Attack Range Per Destruction Rush Level: 4.9 / 5.5 / 6.1
- Base Damage: 500 / 650 / 800

Notes: This skill's actual range is slightly wider than the skill range indicates.
...
- She has the longest attack range in the game (possibly tied only with, if considering his 's attack range), unlocking this at level 12, she is able to attack enemy turrets outside their own attack range, making her one of the best heroes at destroying enemy turrets.
- From 2016 to 2020, she is the first hero that new players can obtain for free after completing the Tutorial, but was replaced by.
- The sound of her projectile hit corresponds to her ; the further away the target, the higher the intensity of the sound effect.
- She is the third hero to have two Starlight skins ("Bunny Babe" and "Twilight Waltz"), following ("Snake Eye Commander" and "Violet Spear"),  ("Force Warrior" and "Iron Hound"), and  ("Rock and Roll" and "Operator CL").
...
- Layla was one of the heroes revamped in Project NEXT’s first batch in September 2020, along with, , and . The goal was to balance the power gap between older and newer heroes, as the latter had better mechanics and animations.
