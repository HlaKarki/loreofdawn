...
- Voice actors:
  - EN: Aria Nice
  - JA: Shishido Chie (宍戸 智恵)
  - ID: Inen Rahmasuci Bismarck
  - AR: Bouthina Hani
  - PT: Leticia Celini
  - RU: Martirosova Eliza
  - TK: Ceren Menekşedağ
  - ES: Jessica Angeles
  - ZH: Yan Yeqiao (闫夜桥)
- Gallery image: File:Profile_CN_Nana.jpg
...
After the Endless War, the Land of Dawn was covered scars, but the Moonlit Forest of Azrya was still bathed in the light of the Moon Goddess. In addition to the elves, there were various other strange creatures living in this dense forest with a most unrestrained bearing. There were very few disputes.
...
Molina understood Nana’s guilt and how she must be feeling. She told Nana that in the southern part of Azrya — the Shadow Swamp near the Land of Despair — there is a kind of mystical fruit that grows in dangerous places that can help the user to control their own energy.
...
It turned out that learning control was only the beginning of her growth. Nana continued on the road with Molina’s blessing and entrustment.
...
- Tags: Max HP; Nana; Immortality; Molina's Gift; Yin; My Turn
- Molina's Gift
  - Cooldown: 150.0s
  - Effect: Death Immune / Damage Immunity (Transformed)
  - Description: Upon taking fatal damage, Nana removes all debuffs on her and transforms, becoming untargetable and invincible, and gains 70% Movement Speed for 2 seconds. She also recovers 10% HP over the duration. Nana can only transform once every 150 seconds and cannot cast skills in the transformed form.
  - Notes:
    - A visual indicator is shown around Nana when Molina's Gift is ready.
    - If [another effect] is available, it will trigger first; ending does not cancel Molina's Gift.

## Skill 1 — Magic Boomerang

- Cooldown: 5.5 / 5.2 / 4.9 / 4.6 / 4.3 / 4.0 s
- Mana cost: 50 / 55 / 60 / 65 / 70 / 75
- Base Damage: 320 / 344 / 368 / 392 / 416 / 440
- Description: Nana hurls her Magical Boomerang in the target direction, dealing magic damage to enemies hit on its way out and back. The boomerang deals full damage to the first enemy. For every additional enemy hit, the damage is reduced by 20% (max reduction 60%).
- Properties:
  - Spell Vamp Ratio: 50%
- Notes:
  - Damage reduction stacks by number of enemies hit.

## Skill 2 — Molina Smooch

- Cooldown: 14.5 / 14.0 / 13.5 / 13.0 / 12.5 / 12.0 s
- Mana cost: 80 / 85 / 90 / 95 / 100 / 105
- Morph Damage: 250 / 275 / 300 / 325 / 350 / 375
- Slowing Effect: 50% / 54% / 58% / 62% / 66% / 70%
- Effects: Crowd Control (CC), Debuff (Transform, slow, reduce Magic Defense)
- Description: Nana summons Molina at the target location. After a short delay, Molina chases the nearest enemy hero in range for 2.5 seconds. Molina deals morph damage to the first enemy hero it collides with and transforms them for 1.5 seconds, also slowing them by the stated percent and reducing their Magic Defense by 25% for the duration. If there are no enemy heroes in range, Molina will disappear after 12 seconds.
- Notes:
  - Affected enemies are revealed.
  - Molina will chase the enemy hero with an accelerating rate before disappearing.

## Ultimate — Molina Blitz

- Cooldown: 36.0 / 32.0 / 28.0 s
- Mana cost: 135 / 150 / 165
- Base Damage: 440 / 550 / 660
- Effects: Burst, Crowd Control
- Description: Nana summons Molina to strike the target area 3 times, each strike dealing magic damage to enemies within the area and slowing them by 50% for 1 second. Enemies hit consecutively are stunned for 1 second.
- Properties:
  - Spell Vamp Ratio: 50%

# Trivia

- Her name (なな; na na) means seven in Japanese and is a common feminine Japanese name.
- Nana is the only hero in the game capable of transforming enemies.
- Nana uses illeism (referring to herself in the third person).
- Her old voice lines were mostly based on the character Ruby from Magic Rush (not to be confused with the MLBB character).
- Nana's old passive allowed her to give gold to nearby allies every 10 seconds.