...
She is the face of MLBB Season 33: Butterfly Shadow.

- Name: Zhuxin
- Alias: Beacon of Spirits
- Chinese name: 烛心 (Zhú xīn)
- Origin: Zhu'an, Cadia Riverlands
- Age: about 3000 years
- Gender: Female
- Weapon: Wishing Lantern
- Traits: Mysterious, Cunningly Bewitching or Sly Spirit
- Likes: Flower-shaped sweets
- Dislikes: Bugs
- Relationships: (companion)
- Voice actors: English: Sam Slade; Japanese: Wakana Ōkuma (和奏 大熊)

# Bio

Zhuxin is a mysterious wanderer from Zhu'an who carries a Wishing Lantern and guides ember butterflies to seek and fulfill mortal wishes. She values pure wishes above wealth or power and sets trials to test the worth of people's desires. Her Yin nature and long existence make her an enigmatic figure who walks between life and death.

She is noted as having exceptionally high base Max Mana and strong mana regeneration characteristics. She enjoys flower-shaped sweets and dislikes bugs.

# Story

> "A mysterious young woman who guides the amber butterflies using her Lantern of Spirits."
...
> "Who is she, truly? What are her pursuits? Whither does she wander? Some label her unpredictable, others, a seeker in the night's embrace, and some, a riddle. Her entire existence is wrapped in secrecy."

> - MLBB socials

> "What do I wish for? What dost thou crave? What is it that all dream of?"

The city of Zhu'an, a dreamlike place where the supernatural can be found in every nook and cranny. Divination rituals, dancing paper dolls, dream-inducing incense... there's no shortage of strange wonders, and no end to the tall tales that originate from this enchanted city. Among them, the most enigmatic is perhaps "her" story.
...
But Zhuxin did not always like the night. A thousand years ago, Zhuxin was just an orphan wandering the streets of Zhu'an. For her, the night only represented danger. In the darkness, the wickedness of human nature emerged to dance with the devil.
...
And on those nights, under the glowing embers, Zhuxin held her pastry tightly in her little soot-covered hands and felt warmth in her heart. But even these small comforts would not last.

When the balance between Yin and Yang was shattered, war broke out across the Cadia Riverlands. Monsters emerged from the shadows and terrorized the continent. The entire city was engulfed by fear. People hid in their homes and no one dared go out to light the braziers. Little Zhuxin endured many freezing nights until she finally exhausted the last bit of her warmth. Surrounded by darkness, she breathed her last breath.
...
Although Zhuxin has yet to find her own wish, she understood now that it must be something bright enough to bring warmth to the long night; enough to make this journey worthwhile. Her existence was undoubtedly worthy of such a wish.

# Abilities

## Crimson Butterflies

Every time Zhuxin channels, she converts the mana spent into up to 20 Crimson Butterflies that follow her. After Zhuxin stops channeling, the Crimson Butterflies will gradually disappear, each restoring 4% of her Max Mana. Zhuxin has a naturally high base Max Mana, but it does not scale with her level.

- Effect type: Buff
- Max stacks: up to 20 Crimson Butterflies
- Mana restoration: each disappearing butterfly restores 4% of Zhuxin's Max Mana

Notes:
- Crimson Butterflies can only stack on heroes and summoned units that are simultaneously applied with Soul Snare stacks from the Lantern Flare skill.
- Crimson Butterflies stacks start to decay in approximately less than a second once Lantern Flare is released and gradually decay roughly every 0.25 seconds.

## Fluttering Grace

Zhuxin deals base damage to all enemies in a fan-shaped area and applies 1 stack of Soul Snare. Zhuxin also slows all enemy heroes hit by 20%–40% and gains 20%–40% extra Movement Speed herself for 1.5 seconds.

- Effect types: AOE, Buff
- Base damage (by level): 150 / 162 / 174 / 186 / 198 / 210
- Movement Speed Boost (by level): 20% / 24% / 28% / 32% / 36% / 40% for 1.5 seconds
- Movement Speed Reduction on enemies (by level): 20% / 24% / 28% / 32% / 36% / 40% for 1.5 seconds
- Mana cost: 30
- Cooldown: 12.0 seconds (scales down with level to 10.0 seconds as listed in internal data)
- Spell vamp ratio: 50%

Notes:
- Applies 1 stack of Soul Snare on hit.
...
- Extra damage on release (by level): 270 / 345 / 420 / 495 / 570 / 645
- Mana cost per cast (by level): 90 / 96 / 102 / 108 / 114 / 120
- Cooldown: 0.5 seconds
- Spell vamp ratio: 50%

Notes:
- Soul Snare stacks last for 4 seconds.
...
- If an enemy takes damage multiple times from the same ability, subsequent damage taken will be reduced by 80% as noted in internal data.
- Damage to minions is increased by 28%.

## Crimson Beacon

Zhuxin blinks to the target location while gaining a shield. While flying, she creates a field around her for 6 seconds. The field deals base damage and applies 1 stack of Soul Snare to enemies every 1 second.

- Effect types: Shield, Mobility
- Shield (by level): 400 / 550 / 700
- Base damage per second while field active (by level): 60 / 75 / 90
- Field duration: 6 seconds
- Mana cost: 100
- Cooldown: 60.0 / 55.0 / 50.0 seconds depending on ultimate rank
- Spell vamp ratio: 50%

Notes:
- The ultimate provides both protection through a shield and area pressure via the damaging field that applies Soul Snare stacks each second.
