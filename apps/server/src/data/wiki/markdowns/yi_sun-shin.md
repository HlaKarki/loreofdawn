...
- Abilities:
  - Summons naval fleet
- Japanese / VA: Hirose Ryuichi (広瀬 竜一)
...
Yi Sun-shin is the leader of the City of the Dragon fleet and he is dedicated to his duties. But the ruler of the City of the Dragon believes the false accusations and demoted Yi Sun-shin to a commoner. The fleet, without a leader, was hit hard by pirates.

At this moment of crisis, Yi Sun-shin stepped forward and lead the reformed fleet to defend this area of the sea and successfully defeated the strong pirates with remaining naval force.

# Abilities

## Heavenly Vow

Yi Sun-shin attacks with his glaive (melee) and longbow (ranged) according to his distance from the target. After each weapon switch, the next two basic attacks will gain extra Attack Speed, dealing 70% and 55% Crit Damage respectively, and gain 15% Movement Speed for 1 second.

Notes:
- The attack range of the ranged attack is 1.9 unit.
- The differentiation range is indicated by a red ring around Yi Sun-shin. His current weapon is displayed below the health bar, with glaive on the left and longbow on the right.
- The animation is visible to enemies only.
- The ranged attack range is unaffected by other modifiers.
- Whether the last attack is considered ranged or melee is determined upon attacking, not upon hitting or landing.
- Similarly, the alternate weapon gains Enhanced basic attack right after attacking.
...
- The next attack type to trigger Heavenly Vow persists through death.
...
Cooldowns by level: 12.0 / 11.0 / 10.0 / 9.0 / 8.0 / 7.0 seconds
Mana cost by level: 50 / 55 / 60 / 65 / 70 / 75

Terms: Blink, Control Immunity

Description: Yi Sun-shin dashes forward and slashes with his glaive, dealing damage and becoming immune to control effects for 1 second. Each use of this skill reduces the cooldown of his Ultimate by 1 second.

Level scaling:
- Base Damage: 150 / 180 / 210 / 240 / 270 / 300

Notes:
- The dash and slash function as a blink.
- Each trigger reduces the Ultimate's cooldown by 1 second.
...
Cast type: Charging (tap/hold)

Description: Tap: Yi Sun-shin slashes swiftly with his glaive, dealing base damage. Hold: Yi Sun-shin shoots a powerful arrow, dealing damage to the target. The arrow's damage scales with the hold time, up to 200%. Yi Sun-shin gains an immediate effect when this skill is used.
...
Mana cost by level: 150 / 180 / 210

Terms: Stun

Description: Yi Sun-shin summons a turtle ship and gains sight of the whole map for 5 seconds. The turtle ship lasts for up to 15 seconds, during which Yi Sun-shin gains 70% burst Movement Speed (decays to 20% over 2 seconds). When cast again, Yi Sun-shin commands the turtle ship to ram towards the target area, dealing damage and stunning enemy units in the central area for 0.8 seconds. Then Yi Sun-shin commands the naval fleet to launch 3 waves of cannon shots on a larger area, each dealing damage and slowing the enemies by 30%. Yi Sun-shin gains an immediate effect when this skill is used.
...
Notes:
- Global Reveal: cooldown begins as soon as the ability is first cast.
- Ignores untargetable enemies.
- Despite the description, only the second cast grants the movement speed effect.
- Fully reveals units inside and outside of the turtle ship's vision.
- The ability is still credited with an assist if an enemy is revealed but not damaged by this ability.
- The speed bonus decays by 12.5% each 0.5 seconds; Yi Sun-shin gains 70%/57.5%/45%/32.5%/20% bonus Movement Speed within 0.5/1/1.5/2/2.5 seconds after cast.

Turtle Ship:
- The turtle ship has a cast range of 5.7 unit.
- Damage is dealt three times over 2 seconds, with an interval of 0.75 seconds.
...
- He is the first hero to be based from a historical figure, along with other heroes.
...
- The Turtle Ship Geobukseon (거북선) was an iron-plated warship he used to dominate naval battles. The Turtle Ship (Geobukseon) was a revolutionary warship designed by the real Admiral Yi Sun-sin during the late 16th century, and it plays a key role in his MLBB design.
- Yi Sun-shin is the first and, so far, the only Assassin/Marksman hero in the game, whereas some other heroes are Marksman/Assassin.
