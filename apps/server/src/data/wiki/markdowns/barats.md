...
- English voice actor: Finnigan Morris
- Japanese voice actor: Yano Masaaki (矢野 正明)
- Indonesian voice actor: Jumali Jindra
...
Detona spits contaminated oil in the target direction, dealing scaling physical damage to enemies in a fan-shaped area. Barats then ignites the oil with a firecracker, dealing scaling physical damage to enemies in the area. The area of effect of So-Called Teamwork increases with the number of Big Guy stacks.

Type: Physical Damage Skill
Spellvamp ratio: 50%

Cooldown by level: 7.0 / 6.6 / 6.2 / 5.8 / 5.4 / 5.0 seconds
Mana cost by level: 25 / 30 / 35 / 40 / 45 / 50
...
Barats fires two missiles at the target location, dealing scaling physical damage and slowing enemies by 40% for 1 second. The missiles expel fumes from their exhausts upon landing, dealing scaling physical damage to enemies in a rectangular area and pushing them toward Barats.

Type: Physical Damage Skill
Additional effect: Displacement

Cooldown by level: 11.0 / 10.4 / 9.8 / 9.2 / 8.6 / 8.0 seconds
Mana cost by level: 70 / 76 / 82 / 88 / 94 / 100

Level scaling:
- Base Damage, Extra Damage: 100 / 115 / 130 / 145 / 160 / 175
...
Notes:
- The charge distance scales with the channel time; Detona can fully charge this skill for 1 second, and can overcharge for approximately another 2 and 1/3 seconds.
