...
Each skill cast adds a rune to Gusion's dagger (stacks up to 4 times). Each stack enhances Gusion's next basic attack to deal additional damage equal to a percentage of the target's max HP and restores HP to himself (amount based on level and magic scaling).

- Stacks: up to 4 runes
- Extra damage based on target's lost HP: 3% / 6% / 9% / 12% (per stack at respective ranks)
- Base HP Regen on trigger: 50 / 100 / 150 / 200
- Magic scaling: 25% / 50% / 75% / 100%

Notes:
- When Gusion gains a rune, his basic attack will be converted into a magic basic attack, dealing scaling magic damage. This converted basic attack cannot critically strike.

## Sword Spike

Gusion throws a dagger in the target direction, dealing base damage to the first enemy hit and marking them. Use Again: Gusion moves behind the marked enemy, dealing extra damage to them. This skill cannot be interrupted while Gusion is moving behind the marked enemy.

- Base Damage by level: 200 / 220 / 240 / 260 / 280 / 300
- Extra Damage on second cast by level: 200 / 220 / 240 / 260 / 280 / 300
- Cooldown: 9.0 / 8.4 / 7.8 / 7.2 / 6.6 / 6.0 seconds
- Mana cost: 70

Notes:
- This skill can be used again within 4 seconds. The second cast does not cost mana.
- The second cast has a limited range at a certain distance; the player cannot use the second cast if Gusion is too far away from the marked target.
...
- Base Damage by level: 110 / 130 / 150 / 170 / 190 / 210
- Recall Extra Damage by level: 65 / 75 / 85 / 95 / 105 / 115
- Slow effect per dagger: 6% (can stack, up to 30%)
...
Gusion dashes to the target location, resetting the cooldown of Sword Spike and Shadowblade Slaughter. If Shadowblade Slaughter was cast once before the reset, Gusion can throw another five daggers on his next Shadowblade Slaughter, and recall a total of ten daggers afterward. Gusion dashes a short distance to the target location.

- Cooldown: 28.0 / 24.0 / 20.0 seconds
- Mana cost: 100 / 50 / 0

Notes:
- This skill resets the cooldowns of Skill 1 and Skill 2 after the initial cast.
- Skills can be used again within a short window after the initial cast (window duration: 8 seconds).
