...
Additional notes:
- For each 1 lost HP, Gatotkaca gains 0.02 extra physical defense (maximum 100 Physical Defense if he has at least 5000 lost HP).
- Rage begins to deplete after approximately 3 seconds of Gatotkaca leaving combat (not taking or dealing damage), with 10 Rage depleted every 0.5 seconds.
- Rage is used in multiples of 5 and is rounded to the nearest multiple of 5. For example, having 38 Rage will output damage as if having 40 Rage, while having 7 Rage will output damage as if having 5 Rage.
- The heal is static and follows the rounding rule of Rage before it's calculated.
- Gatotkaca will perform a short dash to the target when dealing the enhanced basic attack.

## Blast Iron Fist

Gatotkaca slams the ground, creating a shattered zone in the target direction while dealing magic damage to enemies within the zone. Enemies in the shattered zone will take sustained magic damage per second (scaling with level and stats) and be slowed by 30%.

Cooldown: 8.0 / 7.6 / 7.2 / 6.8 / 6.4 / 6.0 seconds
Mana / Cost: varies with level (scaling cost)
...
Notes:
- Sustained Damage applies every 0.5 seconds and can occur up to 7 times.

## Unbreakable

> "Impregnable!"

Gatotkaca begins channeling, then sprints in the target direction with a battle cry, forcing enemies on the path to attack him and dealing magic damage over 1.5 seconds. The sprint distance scales with the channel time. Canceling the skill reduces 50% of the remaining cooldown.

Cooldown: 12.0 / 11.6 / 11.2 / 10.8 / 10.4 / 10.0 seconds
Mana / Cost: varies with level (scaling cost)

Properties:
- Taunt effect on enemies along the path
- Magic Damage
- Spell Vamp Ratio: 50%
- Base Damage: 200 / 220 / 240 / 260 / 280 / 300

Notes:
- Gatotkaca can fully charge the skill in approximately 1 and 1/6 seconds, and can overcharge for approximately another 3.75 seconds.

## Avatar of the Guardian

> "A leap holds the world in awe."

Gatotkaca jumps to the target location, dealing area magic damage to nearby enemies and knocking them airborne for 1 second. Enemies near the center of the area are knocked airborne for a longer duration, while enemies on the fringes are pulled toward the center. The camera will move with the skill indicator but does not grant extra sight.
...
Notes:
- This skill has control immunity during cast and the descending animation makes Gatotkaca untargetable.
