...
As she relaxed and put down her bow, Miya noticed that she had bruised her hand while dealing with the intruders. She began to recall the times when she practiced archery while her brother studied nearby. As a somewhat stubborn child, Miya would often shoot her bow incessantly trying to hit a leaf or branch, until her fingers bled. Her brother would look up from his scroll and, with a wave of his hand, heal her wounds with the forest' magic. Perhaps Miya was too attached to the past. She often found herself longing for a time when she could still hide under her brother's protection.
...
## Chapter Five: The Eclipse Ends

undefined

# Abilities

## Moon Blessing (Moonlight Shadow)

- Each time Miya hits a target with her Basic Attack, she gains 5% Attack Speed for 4 seconds. Stacks up to 5 times.
- After reaching full stacks, Miya summons a spirit with each Basic Attack that deals scaling damage based on level and stats and inherits a portion of Attack Effects (20%).
- Lifesteal ratio: 0%.
- Stack scaling: Extra Attack Speed: 5% / 10% / 15% / 20% / 25%.

Note: The summoned spirit and its exact damage scale with Miya's level and attack; described values above are a summary of the passive's effects.

## Moon Arrow

- Mana cost: 50 / 55 / 60 / 65 / 70 / 75 (per level).
- Effect: Miya shoots two extra arrows with each Basic Attack, dealing physical damage to the target and 30% damage to nearby targets. This effect lasts 4 seconds.
- Each extra arrow inherits a portion of Attack Effects (20%).
- Level scaling (base damage): 10 / 15 / 20 / 25 / 30 / 35. Duration scaling: 4 / 5 / 6 / 7 / 8 / 9 seconds.

Notes:
- Cooldown starts upon casting.
- This skill cannot be cast again until its duration ends.
- Damage type: physical basic attack and additional physical arrow damage.

## Arrow of Eclipse

- Mana cost: 80 / 90 / 100 / 110 / 120 / 130 (per level).
- Primary damage (base): 270 / 300 / 330 / 360 / 390 / 420 (per level).
- Arrow split damage: 40 / 53 / 66 / 79 / 92 / 105 (per level).
- Effect: Miya launches an empowered arrow at a target area, dealing physical damage to enemies within and immobilizing them for 1.2 seconds. The arrow then splits into 6 scattering minor arrows, each dealing arrow damage to the first enemy hit and slowing them by 30% for 2 seconds.
- Status effects: immobilize on initial hit; slow on secondary arrows.

Damage type: physical skill damage. The listed numbers are base damages and scale with skill level and Miya's physical attack.

## Hidden Moonlight

- Cooldown by level: 46.0 / 36.0 / 26.0 seconds.
- Mana cost by level: 120 / 145 / 170.
- Effect: Miya removes all debuffs on her and conceals herself, gaining extra Movement Speed. Movement Speed bonus by level: 35% / 50% / 65%.
- Conceal state lasts 2 seconds or until she launches an attack. Miya gains full stacks of her passive upon leaving the state.
- Additional effects: removes crowd control and conceals Miya until she attacks or the duration ends.

Note: "Attacks" that end the duration and trigger passive stacks refer to Miya's basic attacks and her non-ultimate skill casts.
