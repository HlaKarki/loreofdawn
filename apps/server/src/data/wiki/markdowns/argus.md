...
- Abilities: Charging his blade with Malice Energy; Curses enemies; Death immunity
- Relationships:
  ...
  - (enemy - old lore)
- Voice actors:
  - English: Con Eyre (2017–2021), Marc Elmer (2021–)
  - Japanese: Hoshi Yuuki (星祐樹)
...
Argus' passive revolves around Malice Energy (rage) and the Warmonger mechanic.

- When Argus' blade reaches 100 Malice Energy, he will launch a Demonic Slash with his next Basic Attack, dealing scaling physical damage and recovering health based on damage dealt. This attack ignores 40% of the target's Physical Defense.
...
Notes:
- Exact amounts of some values are based on ability rank and Argus' stats.
- The Demonic Slash costs 100 Malice Energy to trigger.
...
- Base Damage (first hit): 125 / 150 / 175 / 200 / 225 / 250
- Extra Damage (Use Again): 175 / 200 / 225 / 250 / 275 / 300
- Effects: Stun for 0.7 seconds; Blink/pull mechanics

This skill functions as both a gap closer and a crowd control tool, allowing Argus to initiate fights or reposition.

## Meteoric Sword

After a short delay, Argus thrusts his Demonic Blade in the target direction, dealing physical damage to enemies hit and slowing them by 80% for 0.8 seconds. The delay time decreases as Argus' Attack Speed increases. Enemy heroes hit are cursed for 4 seconds, during which they leave a Cursed Trail behind. Argus gains 20% Movement Speed while on a Cursed Trail.
...
Notes:
- Delay before impact shortens with increased Attack Speed.
- Hitting heroes restores Malice Energy.

## Eternal Evil

Argus draws his Meteoric Sword and removes all debuffs on himself (excluding Suppression), dealing physical damage and becoming the Fallen Angel for 4 seconds. Hitting heroes while Fallen Angel enhances Warmonger.

Fallen Angel effects:
- Gain 40% Movement Speed that decays over 1 second.
- When the transformation ends, Argus converts all damage he dealt while in the Fallen Angel state into HP.
- If Argus takes fatal damage while Fallen Angel is active, the duration of the Movement Speed boost will be reset and he will gain Death Immunity for 4 seconds.

Enhanced Warmonger:
- Grants Malice Energy on hit (values described in original data as 50-60 Malice Energy with an additional modifier shown as 50-40; critical hits grant extra Malice Energy).

Additional mechanics:
- If Death Immunity isn't triggered during the transformation, the cooldown will be reduced by 50% when the skill ends.
- Health regeneration from this skill is based on damage dealt during the Fallen Angel state and is subject to the limitations noted in the original description.

- Base Damage (ultimate ranks): 150 / 225 / 300 (physical damage scaled with attack)
- Cooldowns by rank referenced in source: 60.0 / 55.0 / 50.0 seconds
