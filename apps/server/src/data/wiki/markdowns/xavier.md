...
- Abilities: *Mystic magic* (Fires mystic bullets; Summons mystic barriers; Unleashes powerful beam)
- Traits: World-Weary Desolate, Scornfully at ease
- Likes: Playing with cats, making exquisite dishes
- Relationships: Unnamed father; Unnamed mother; Archbishop; Forsaken Light Squad companions; Rod Sidon (enemy)
...
The young Xavier back then had no other choice, but now?
...
- Cooldown (per level): 6.5 / 6.4 / 6.3 / 6.2 / 6.1 / 6.0 seconds
- Mana cost (per level): 50 / 55 / 60 / 65 / 70 / 75
- Base Damage (per level): 480 / 514 / 548 / 582 / 616 / 650

Description: Xavier fires a Mystic Bullet that deals scaling damage to enemies it passes through. The Bullet's flying distance increases each time it hits an enemy or the environment (up to 5 times). Damage scales with skill level and magic power.

## Mystic Field

- Skill type: Magic Skill
- Cooldown: 13.0 seconds
- Mana cost (per level): 80 / 88 / 96 / 104 / 112 / 120
- Base Damage (per level): 220 / 244 / 268 / 292 / 316 / 340
- Extra Damage (when Barrier expands): 220 / 244 / 268 / 292 / 316 / 340

Description: Xavier conjures a barrier that lasts 5 seconds. Enemies that come into contact with the Barrier will take base damage and be slowed by 50%, while allies will gain extra Movement Speed that decays over 1.2 seconds. When hit by Xavier's other skills, the Barrier expands into a forbidden field for 3 seconds, dealing extra damage to enemies within and immobilizing them for 1.2 seconds.

## Dawning Light

- Skill type: Magic Skill
- Cooldown: 56.0 seconds
- Mana cost (levels): 120 / 160 / 200
- Base Damage (per level): 600 / 850 / 1100

Description: Xavier unleashes a beam of Mystic magic that deals scaling damage to all enemies along its path. Once cast, he also directly enters the Transcendence state and resets the state's duration.

## Forsaken Light (Team Buff)

Since there are other Forsaken Light members on the team, Xavier's Max HP, Max Mana, Movement Speed and Critical Damage are increased. Original text: Forsaken Light: Since all the Forsaken Light members are present, your Max HP, Max Mana, Movement Speed, and Crit Damage are increased.
