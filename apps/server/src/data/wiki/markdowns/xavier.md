...
- Name: Xavier
- Aliases: *Defier of Light, *Arbiter of Light
- Chinese name: 泽文 (zéwén)

Xavier was born in Lumina City, Moniyan Empire.

- Species: Human
- Gender: Male

Occupation:
- Former member of the Knights of Light
...
Abilities summary:
- Mystic magic
  - Fires mystic bullets
  - Summons mystic barriers
  - Unleashes powerful beam
...
- Each hit increases the enhancement stack. When subsequent skills hit, Xavier gains increased Movement Speed (50%) that decays over 1.2 seconds.
- Subsequent skills have greatly increased width.
- Skill cooldowns are reduced by 4 seconds while enhanced. (Example illustrative cooldown reduction: this can apply up to a set maximum duration and is subject to skill specifics.)
- When fully charged, Xavier enters the Transcendence state: all of Xavier's skills are enhanced for 5 seconds. This duration is extended by 1 second each time Xavier's skill hits an enemy. The Transcendence state enhances skill effects and interacts with his Ultimate and other skills as described in their details.

## Infinite Extension (Mystic Bullet)

Mystic Bullet

- Type: Magic Skill
- Cooldown: 6.5 / 6.4 / 6.3 / 6.2 / 6.1 / 6.0 seconds depending on level.
- Mana cost: 50 / 55 / 60 / 65 / 70 / 75 depending on level.
- Behavior: Xavier fires a Mystic Bullet that deals magic damage to enemies it passes through. The Bullet's flying distance increases each time it hits an enemy or collides with terrain, up to 5 times.

Base Damage by level:
- 480 / 514 / 548 / 582 / 616 / 650 (magic damage based on skill level and his magic power scaling)

Notes:
- The bullet's travel distance extension on hit makes it capable of striking multiple targets or continuing further when successfully connecting with enemies.

## Mystic Field (Mystic Barrier)

Mystic Barrier / Mystic Field

- Type: Magic Skill
- Cooldown: 13.0 seconds
- Mana cost: 80 / 88 / 96 / 104 / 112 / 120 depending on level.
- Base Damage: 220 / 244 / 268 / 292 / 316 / 340 (magic damage) at each level.
- Extra Damage when expanded: 220 / 244 / 268 / 292 / 316 / 340 (magic damage) at each level.

Description:
- Xavier conjures a barrier that lasts 5 seconds. Enemies that come into contact with the Barrier take base damage and are slowed by 50%, while allies will gain extra Movement Speed that decays over 1.2 seconds.
- When hit by Xavier's other skills, the Barrier expands into a forbidden field for 3 seconds, dealing extra damage to enemies within and immobilizing them for 1.2 seconds.

Notes:
- The Barrier provides both defensive utility for allies and crowd control for enemies when triggered by additional skill hits.
...
- Mana cost: 120 / 160 / 200 depending on ultimate level internally (total MP reference varies by level).
- Base Damage: 600 / 850 / 1100 (magic damage) depending on ultimate level.

Description:
- Xavier unleashes a beam of Mystic magic that deals damage to all enemies along its path.
- Upon casting, Xavier directly enters the Transcendence state and resets the state's duration, activating the enhanced versions of his skills for the Transcendence duration.

Notes:
- The Ultimate is a long-range piercing beam that synergizes with skill-triggered Barrier expansions and Transcendence enhancements.

## Forsaken Light (Team Buff)

Forsaken Light (Team Buff)

- Description: Since there are other Forsaken Light members on his team, his Max HP, Max Mana, Movement Speed and Critical Damage are increased by small percentages based on team composition and presence of Forsaken Light allies.

Notes:
- This is a team synergy buff that improves core statistics while multiple Forsaken Light members are present on the same team.
