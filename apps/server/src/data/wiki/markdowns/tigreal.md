...
Full name: Tigreal Wertz

Chinese name: 泰格 (Tài gé)
...
Traits: Courageous & Justice, Chivalry Spirit

Relationships: (as listed in source)

Voice Actors:
- English VA: Zach Lazar Hoffman
- Japanese VA: Yano Masaaki (矢野 正明)

Base Defenses:
- Physical Defense: 20 (level 1) / 132 (level 15)
...
> "Leader of the Light's Order, guardian of the Moniyan Empire"
...
During this period of time, Tigreal finally resolved the problems in his mind. Eventually, he returned to the Empire and became the leader of the Light's Order.
...
Tigreal gains a stack of each time he casts a skills or is hit by Basic Attack. After getting 4 stacks, Tigreal will consume all Fearless stacks to block the next incoming Basic Attack (including attacks from turrets). Attacks from Minions do not grant Fearless atacks nor trigger this effect.
...
- Notes
- Fearless stacks will completely deplete 6 seconds after is unable to maintain it.
- Fully gain stacks from Lord and Turtle damage but not Altar.
- Only gain stack from  after the pull step.

## Attack Wave

- Skill name: Sacred Hammer — Attack Wave

- Effects: AOE, Slow

- Mana cost: 45

- Cooldown: 7.0 / 6.4 / 5.8 / 5.2 / 4.6 / 4.0 seconds depending on level

- Description:
Tigreal smashes the ground with his hammer and sends a shockwave forward that erupts 3 times, each time dealing scaling physical damage to enemies along the fan-shaped area and slowing them by 20%/40%/60% for 1.5 seconds.

- Level scaling:
Base Damage: 270 / 300 / 330 / 360 / 390 / 420
Total physical attack scaling: 70 (scaling damage)
...
- Notes
- The wave travel at the same speed with his .
- It is possible for a unit to be hit by multiple waves.

## Sacred Hammer

- Skill name: Sacred Hammer

- Effects: Charge, Crowd Control, Displacement

- Mana cost: 70

- Cooldown: 12.5 / 12.0 / 11.5 / 11.0 / 10.5 / 10.0 seconds depending on level (cooldown starts when the skill is first cast)

- Description:
Tigreal charges in a target direction, dealing scaling physical damage to enemies along the way and pushing them to the end of the charge. Tigreal can cast this skill again within 4 seconds, dealing scaling physical damage to enemies in front of him and knocking them airborne for 1 second.

- Level scaling:
Charge damage base: 280-380 depending on level
Second-phase (Airborne) Damage: 280 / 300 / 320 / 340 / 360 / 380
Total physical attack scaling: primary 100, secondary 60 (scaling damage)
...
- Notes
- Tigreal can blink by using the battle spell during this skill.
- The knockback will control enemies for the full duration if they do not use CC immune.
- If an enemy is hit by the end of this ability, they will be briefly knockbacked and stunned in position instead.
- Which means the total duration can be reduced by resilience if stunned.
- Death removes the second phase.

## Implosion

- Skill name: Implosion

- Effects: Pull, Stun, AOE

- Mana cost: 120 / 140 / 160 depending on level

- Cooldown: 45.0 / 41.0 / 37.0 seconds depending on level

- Description:
Tigreal unleashes the power of his hammer, stunning and pulling nearby enemies to him for 2 seconds while dealing scaling physical damage. The first half of the channeling can be interrupted by control effects. The second part of the channeling cannot be interrupted except by Suppression.

- Level scaling:
Base Damage 270 / 350 / 430
Total physical attack scaling: 130 (scaling damage)
...
- He is based from Bedivere from Magic Rush.
