...
In the far distant past when the world was just created, Ancient Ones built the Celestial Palace above the Sanctum Island in the Sea of Hope. The island was a part of a submarine volcano. Submerged rocks and atolls were strewn all over the vicinity of the island, and the waters nearby are often shrouded in dense sea fog, which caused the wreckage of many ships that ventured to pass by.
...
Ten years passed, and the old man became frailer. The other kids all grew up, except for Edith who remained as young as when she was first found. Eventually, her foster father was too old for physical labor. In order to survive, he had to break the rule that he set up himself—he brought Edith with him to pick up metal scraps in the ruins of the valley.
...
Amidst the fire and dust, an Elemental Giant in gold armor appeared in front of Edith,

> "You left your post, Edith!"
...
Uranus waves his giant arm at the old man, a string of flying blades shooting at the ground! Quick as a flash, "Phylax" came as summoned and reached out its strong metal arm to catch the blades.

Edith spoke from "Phylax" the Mecha,

> "Let my father go."

Uranus shouted at the Mecha in front,

> "Traitor!"

And Edith calmly replied,

> "Or let's fight to the death."
...
While the two were still in a deadlock, a birdlike Guardian of the Celestial Palace—Kaja—closed his wings and descended upon the ruins,

> "Stop the foolish fight! The Celestial Palace is in peril!"
...
Uranus commanded in a thunder-like voice,

> "Kaja, we shall stay and fix the seals! Edith, arrest the Evil Gods!"

To that Edith answered,

> "I understand my duty. Let me send my father back first!"
...
After each skill cast, Edith and Phylax become Overloaded for 3 seconds, during which all Basic Attacks will trigger chain lightning, dealing extra Magic Damage based on level and stats to up to 4 enemies. Chain lightning damage against Minions is increased to 150%.

- Chain lightning counts as Skill Damage.
- When the first target of its/her chain lightning is not a nearby Turret, the Turret will not be included in the chain.

(Additional numerical scaling: damage scales with level and magic power; exact values are damage based on level and stats.)

## Earth Shatter / Divine Retribution

Earth Shatter

- After a 0.75 seconds delay, Edith controls Phylax to launch an earth-shattering blow in a designated direction, dealing physical damage based on level and stats to enemies hit, and knocking Minions airborne for 1 second. This skill won't be interrupted by regular control effects (excluding Suppression).
- Base Damage (per level): 225 / 270 / 315 / 360 / 405 / 450.
- Cooldown: 8.5 / 8.1 / 7.7 / 7.3 / 6.9 / 6.5 seconds.
- Term: Airborne. Physical Damage Skill.

Divine Retribution

- Edith exacts Divine Retribution on a target area, dealing magic damage based on level and stats to enemies hit and slowing them by 30%. She then continues to deal continuous magic damage every 0.5 second over the next 1.5 seconds.
- Base Damage (initial): 170 / 200 / 230 / 260 / 290 / 320.
- Continuous Damage (per tick): 68 / 80 / 92 / 104 / 116 / 128.
- Cooldown: 5.0 / 4.7 / 4.4 / 4.1 / 3.8 / 3.5 seconds.
- Term: Magic Damage Skill. AoE. Burst.
- Notes: Spell Vamp Ratio: 25%.

(Displayed damage values are base damage per skill level; final damage is affected by Edith's stats and magic power.)

## Onward / Lightning Bolt
...
- When inside Phylax, Edith can accumulate Wrath based on the damage she receives (calculated before damage reduction).

- Active / Morph: Edith ejects herself forward from Phylax, knocking back nearby enemies. After that, she takes flight and can perform ranged Basic Attacks, each dealing magic basic attack damage based on level and stats. Edith also gains new skills while in this state.

- While in flight, Edith gains a Shield, increased Attack Speed, and Hybrid Lifesteal based on the Wrath she accumulated. She also converts each point of Extra Physical Defense and Extra Magic Defense into extra Shield value. The Flight state lasts up to 8–12 seconds.

- Key numbers:
  - Duration: 8 / 10 / 12 seconds.
  - Basic Attack Damage while flying: 35 / 50 / 65 (base values per ultimate level).
  - Base Shield: 350 / 500 / 650.
  - Wrath accumulation and conversion: Edith gains 350–650 extra Shield, 50%–150% extra Attack Speed and 5%–20% Hybrid Lifesteal based on Wrath accumulated. Each point of Extra Physical Defense and Extra Magic Defense is converted into 3.5 shield value.
  - Cooldown: 40.0 / 37.0 / 34.0 seconds.

- Terms: Magic Basic Attack. Attack Speed. Hybrid Lifesteal.

- Notes:
  - Wrath begins to deplete after 5 seconds of Phylax not being in battle (i.e., not taking or dealing damage), with 10% of Wrath depleted every 0.5 seconds.
  - Wrath persists after death and depletes nonetheless.
  - Edith can end Primal Wrath prematurely by canceling it.

(All percentage ranges and conversions are based on Wrath accumulated and Edith's stats; exact values scale with level and equipment.)
