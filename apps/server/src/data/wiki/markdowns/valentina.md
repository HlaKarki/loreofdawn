...
In a battle against the Abyss' invasion, Valentina and her lover, Irlan, were betrayed by some members of House Paxley, which eventually caused Irlan to lose his soul.

To revive her lover, Valentina made a deal with an Evil God and gained immortality in the power of shadow.

Since then, she'd been hiding among the shadows, silently waiting for the appearance of the Heart of Anima–a broken piece from the Twilight Orb that was said to be the key to retrieving her lover's soul.
...
- EXP Increase: 8 / 11 / 14 / 17 / 20 / 23 / 26 / 29 / 32 / 35 / 38 / 41 / 44 / 47 / 50

Notes:

- The healing benefit applies to damage dealt by Valentina's own skills only for 30% conversion to HP.
- Fully gain EXP when the damage is from emblem, battle spells, or basic attacks, but not on non-minion enemies such as summons.
- Damage from battle spells and equipment cannot be converted to HP.

## Shadow Strike

Valentina casts Shadow Strike in the target direction, dealing damage to enemies hit and slowing them.

- Effects: Damage, Crowd Control

Description:

- Valentina casts Shadow Strike in the target direction, dealing damage to enemies hit and slowing them by 40% for 1 second.
- Enemy heroes hit by Shadow Strike are marked with a Shadow Sigil for 4 seconds and will be terrified for 1 second when hit by Shadow Strike again within the duration (a unit can only be terrified once within 4 seconds).

Base Damage:

- 340 / 405 / 470 / 535 / 600 / 665

Other:

- Cooldown scales per level (values vary by rank).
- Mana cost scales per level.

## Arcane Shade

Valentina dashes in the target direction and fires Shadow Bolts at nearby enemies. She can recast the skill within a short window.

- Effects: Blink, Buff

Description:

- Valentina dashes in the target direction, firing 3 Shadow Bolts at nearby enemies that each deal damage.
- Valentina can cast this skill again within 6 seconds (costs Mana).
- The cooldown of this skill is reduced by 1 second each time a Shadow Bolt hits an enemy.
...
- 45 / 50 / 55 / 60 / 65 / 70 (scales by skill level)
...
- Cooldown Rate: 120% / 110% / 100%
- Skill Level of stolen Ultimate: 1 / 2 / 3
- Steal Range: 7
- Duration of inherited form: up to 12 seconds

Notes and Special Interactions:
...
- Any emote used just before the manual cancellation of the ability may be replayed.
